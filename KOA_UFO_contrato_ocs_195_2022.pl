% ===== KOA Combined Output | contract_id: contrato_ocs_0195_2022 =====
...
% UFO-only grounding generated from: KOA_Contrato_OCS_195_2022_-_Brasoftware_(SQL_Server).pl
% contract_id: contrato_ocs_0195_2022

instance_of(contrato_ocs_0195_2022, legal_service_agreement).

instance_of(banco_nacional_de_desenvolvimento_economico_e_social_bndes, agent).
instance_of(brasoftware_informatica_ltda, agent).

plays_role(banco_nacional_de_desenvolvimento_economico_e_social_bndes, service_customer_role, contrato_ocs_0195_2022).
plays_role(brasoftware_informatica_ltda, hired_service_provider_role, contrato_ocs_0195_2022).

clause_of(clausula_primeira_objeto, contrato_ocs_0195_2022).
clause_of(clausula_segunda_vigencia, contrato_ocs_0195_2022).
clause_of(clausula_terceira_local_prazo_condicoes_execucao_objeto, contrato_ocs_0195_2022).
clause_of(clausula_quarta_niveis_servico, contrato_ocs_0195_2022).
clause_of(clausula_quinta_recebimento_objeto, contrato_ocs_0195_2022).
clause_of(clausula_sexta_preco, contrato_ocs_0195_2022).
clause_of(clausula_setima_pagamento, contrato_ocs_0195_2022).
clause_of(clausula_oitava_equilibrio_economico_financeiro_contrato, contrato_ocs_0195_2022).
clause_of(clausula_decima_garantia_contratual, contrato_ocs_0195_2022).
clause_of(clausula_decima_primeira_obrigações_contratado, contrato_ocs_0195_2022).
clause_of(clausula_decima_segunda_conduta_ética_contratado_bndes, contrato_ocs_0195_2022).
clause_of(clausula_decima_terceira_sigilo_informações, contrato_ocs_0195_2022).
clause_of(clausula_decima_quarta_acesso_protecao_dados_pessoais, contrato_ocs_0195_2022).
clause_of(clausula_decima_quinta_obrigações_bndes, contrato_ocs_0195_2022).
clause_of(clausula_decima_sexta_equidade_genero_valorizacao_diversidade, contrato_ocs_0195_2022).
clause_of(clausula_decima_setima_cessao_contrato_credito_sucessao_subcontratacao, contrato_ocs_0195_2022).
clause_of(clausula_decima_oitava_penalidades, contrato_ocs_0195_2022).
clause_of(clausula_decima_nona_alterações_contratuais, contrato_ocs_0195_2022).
clause_of(clausula_vigésima_extinção_contrato, contrato_ocs_0195_2022).
clause_of(clausula_vigésima_primeira_disposições_finais, contrato_ocs_0195_2022).
clause_of(clausula_vigésima_segunda_foro, contrato_ocs_0195_2022).
clause_of(clausula_nona_matriz_riscos, contrato_ocs_0195_2022).

legal_relation_instance(clausula_primeira_objeto, duty_to_act, brasoftware_informatica_ltda, provide_update_support).
legal_relation_instance(clausula_primeira_objeto, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, receive_update_support).
legal_relation_instance(clausula_segunda_vigencia, duty_to_act, brasoftware_informatica_ltda, presentar_manifestacao_sobre_prorrogacao).
legal_relation_instance(clausula_segunda_vigencia, duty_to_act, brasoftware_informatica_ltda, comunicar_interesse_prorrogacao).
legal_relation_instance(clausula_segunda_vigencia, subjection, brasoftware_informatica_ltda, sujeitar_as_penalidades).
legal_relation_instance(clausula_segunda_vigencia, duty_to_omit, brasoftware_informatica_ltda, omitir_nao_prorrogar).
legal_relation_instance(clausula_segunda_vigencia, right_to_action, unknown, prorrogar_contrato).
legal_relation_instance(clausula_terceira_local_prazo_condicoes_execucao_objeto, duty_to_act, brasoftware_informatica_ltda, execute_object_according_to_specifications).
...
legal_relation_instance(clausula_quarta_niveis_servico, duty_to_act, brasoftware_informatica_ltda, execute_services_according_to_standards).
legal_relation_instance(clausula_quarta_niveis_servico, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, apply_reduction_price_index).
legal_relation_instance(clausula_quarta_niveis_servico, subjection, brasoftware_informatica_ltda, be_subject_to_price_reduction).
...
legal_relation_instance(clausula_sexta_preco, duty_to_act, brasoftware_informatica_ltda, dimension_quantities_correctly).
legal_relation_instance(clausula_sexta_preco, subjection, brasoftware_informatica_ltda, bear_costs_of_errors).
...
legal_relation_instance(clausula_sexta_preco, no_right_to_action, brasoftware_informatica_ltda, receive_indemnification_for_not_demanded_object).
...
legal_relation_instance(clausula_setima_pagamento, right_to_action, brasoftware_informatica_ltda, receive_payment).
legal_relation_instance(clausula_setima_pagamento, duty_to_act, brasoftware_informatica_ltda, present_fiscal_document).
legal_relation_instance(clausula_setima_pagamento, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, reject_document).
...
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, right_to_action, brasoftware_informatica_ltda, request_price_adjustment).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, right_to_action, brasoftware_informatica_ltda, request_price_revision).
...
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, brasoftware_informatica_ltda, present_requested_information).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, brasoftware_informatica_ltda, request_price_adjustment_revision_before_end).
...
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_omit, brasoftware_informatica_ltda, not_claim_indemnification_for_rescission).
...
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, brasoftware_informatica_ltda, provide_contractual_guarantee).
legal_relation_instance(clausula_decima_garantia_contratual, subjection, brasoftware_informatica_ltda, penalty_for_failure_to_provide_guarantee).
...
legal_relation_instance(clausula_decima_garantia_contratual, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, approve_guarantee_extension).
legal_relation_instance(clausula_decima_garantia_contratual, permission_to_act, brasoftware_informatica_ltda, request_guarantee_extension).
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_omit, brasoftware_informatica_ltda, omit_fiscal_irregularity).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, brasoftware_informatica_ltda, maintain_conditions_of_qualification).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, brasoftware_informatica_ltda, communicate_imposition_of_penalty).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, brasoftware_informatica_ltda, repair_correct_remove_reconstruct_or_substitute).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, brasoftware_informatica_ltda, repair_damages_and_losses).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, brasoftware_informatica_ltda, pay_all_fees_and_taxes).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, brasoftware_informatica_ltda, assume_full_responsibility_for_any_burdens).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, brasoftware_informatica_ltda, provide_exclusion_from_simples_nacional).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, brasoftware_informatica_ltda, allow_inspections_and_monitoring).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, brasoftware_informatica_ltda, obey_instructions_and_procedures).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, brasoftware_informatica_ltda, designate_representative).
legal_relation_instance(clausula_decima_segunda_conduta_ética_contratado_bndes, duty_to_omit, brasoftware_informatica_ltda, not_offer_undue_advantage).
legal_relation_instance(clausula_decima_segunda_conduta_ética_contratado_bndes, duty_to_omit, brasoftware_informatica_ltda, prevent_employee_favoritism).
legal_relation_instance(clausula_decima_segunda_conduta_ética_contratado_bndes, duty_to_omit, brasoftware_informatica_ltda, not_allocate_relatives).
legal_relation_instance(clausula_decima_segunda_conduta_ética_contratado_bndes, duty_to_act, brasoftware_informatica_ltda, observe_ethics_policy).
legal_relation_instance(clausula_decima_segunda_conduta_ética_contratado_bndes, duty_to_act, brasoftware_informatica_ltda, adopt_sustainability_practices).
legal_relation_instance(clausula_decima_segunda_conduta_ética_contratado_bndes, duty_to_act, brasoftware_informatica_ltda, remove_agents_from_contract).
legal_relation_instance(clausula_decima_segunda_conduta_ética_contratado_bndes, duty_to_act, brasoftware_informatica_ltda, report_issues_to_bndes).
legal_relation_instance(clausula_decima_terceira_sigilo_informações, duty_to_act, brasoftware_informatica_ltda, comply_with_bndes_security_policy).
legal_relation_instance(clausula_decima_terceira_sigilo_informações, duty_to_omit, brasoftware_informatica_ltda, not_access_confidential_info_without_authorization).
legal_relation_instance(clausula_decima_terceira_sigilo_informações, duty_to_omit, brasoftware_informatica_ltda, maintain_info_secrecy).
legal_relation_instance(clausula_decima_terceira_sigilo_informações, duty_to_act, brasoftware_informatica_ltda, inform_bndes_of_secrecy_violations).
legal_relation_instance(clausula_decima_terceira_sigilo_informações, duty_to_act, brasoftware_informatica_ltda, return_bndes_property).
legal_relation_instance(clausula_decima_terceira_sigilo_informações, duty_to_omit, brasoftware_informatica_ltda, not_use_confidential_info_after_termination).
legal_relation_instance(clausula_decima_terceira_sigilo_informações, duty_to_act, brasoftware_informatica_ltda, present_confidentiality_terms).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, protect_data_privacy).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, brasoftware_informatica_ltda, follow_bndes_instructions).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, exercise_regress_right).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, brasoftware_informatica_ltda, provide_data_access).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, brasoftware_informatica_ltda, inform_bndes_of_requests).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, brasoftware_informatica_ltda, keep_data_processing_records).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, brasoftware_informatica_ltda, communicate_data_breach).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, brasoftware_informatica_ltda, eliminate_personal_data).
...
legal_relation_instance(clausula_decima_quinta_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, designate_manager_substitute).
legal_relation_instance(clausula_decima_quinta_obrigações_bndes, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, alter_contract_manager).
legal_relation_instance(clausula_decima_quinta_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, communicate_manager_changes).
...
legal_relation_instance(clausula_decima_sexta_equidade_genero_valorizacao_diversidade, duty_to_act, brasoftware_informatica_ltda, comprovar_inexistencia_sancao).
...
legal_relation_instance(clausula_decima_sexta_equidade_genero_valorizacao_diversidade, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, solicitar_comprovacao_sancao).
legal_relation_instance(clausula_decima_sexta_equidade_genero_valorizacao_diversidade, disability, brasoftware_informatica_ltda, impedimento_receber_servico).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_subcontratacao, duty_to_omit, brasoftware_informatica_ltda, omit_contract_assignment).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_subcontratacao, no_right_to_action, brasoftware_informatica_ltda, no_right_to_assign_contract).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_subcontratacao, duty_to_omit, brasoftware_informatica_ltda, omit_issue_credit_title).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_subcontratacao, no_right_to_action, brasoftware_informatica_ltda, no_right_to_issue_credit_title).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_subcontratacao, duty_to_omit, brasoftware_informatica_ltda, omit_subcontracting).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_subcontratacao, no_right_to_action, brasoftware_informatica_ltda, no_right_to_subcontract).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_subcontratacao, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, analyze_risks_prejudices).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_subcontratacao, permission_to_act, brasoftware_informatica_ltda, perform_corporate_operations).
legal_relation_instance(clausula_decima_oitava_penalidades, subjection, brasoftware_informatica_ltda, be_subject_to_warning).
legal_relation_instance(clausula_decima_oitava_penalidades, subjection, brasoftware_informatica_ltda, be_subject_to_fine).
legal_relation_instance(clausula_decima_oitava_penalidades, subjection, brasoftware_informatica_ltda, be_subject_to_suspension).
legal_relation_instance(clausula_decima_oitava_penalidades, right_to_action, brasoftware_informatica_ltda, request_reconsideration_or_appeal).
...
legal_relation_instance(clausula_decima_oitava_penalidades, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, deduct_fines_from_credits).
legal_relation_instance(clausula_decima_oitava_penalidades, subjection, brasoftware_informatica_ltda, credits_being_deducted).
...
legal_relation_instance(clausula_decima_oitava_penalidades, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, apply_fine_with_other_penalties).
legal_relation_instance(clausula_decima_nona_alterações_contratuais, duty_to_omit, banco_nacional_de_desenvolvimento_economico_e_social_bndes, not_denature_contract).
legal_relation_instance(clausula_decima_nona_alterações_contratuais, no_right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, denature_contract).
legal_relation_instance(clausula_decima_nona_alterações_contratuais, permission_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, alterar_contrato).
...
legal_relation_instance(clausula_decima_nona_alterações_contratuais, no_right_to_omission, banco_nacional_de_desenvolvimento_economico_e_social_bndes, not_refuse_to_formalize_amendment).
legal_relation_instance(clausula_decima_nona_alterações_contratuais, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, compensate_damages).
...
legal_relation_instance(clausula_vigésima_extinção_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_contract_with_written_justification).
legal_relation_instance(clausula_vigésima_extinção_contrato, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, provide_written_notification_before_termination).
legal_relation_instance(clausula_vigésima_extinção_contrato, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, provide_written_notice_before_termination).
legal_relation_instance(clausula_vigésima_extinção_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_contract_due_breach).
...
legal_relation_instance(clausula_vigésima_extinção_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_contract_due_suspension).
legal_relation_instance(clausula_vigésima_extinção_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_contract_due_dissolution).
legal_relation_instance(clausula_vigésima_extinção_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_contract_due_force_majeure).
legal_relation_instance(clausula_vigésima_primeira_disposições_finais, permission_to_omit, banco_nacional_de_desenvolvimento_economico_e_social_bndes, omit_strict_enforcement).
legal_relation_instance(clausula_vigésima_primeira_disposições_finais, no_right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, sue_for_past_omissions).
legal_relation_instance(clausula_vigésima_segunda_foro, power, unknown, resolve_disputes_in_rio_de_janeiro).
legal_relation_instance(clausula_vigésima_segunda_foro, no_right_to_action, unknown, resolve_disputes_elsewhere).
legal_relation_instance(clausula_nona_matriz_riscos, disability, brasoftware_informatica_ltda, cant_celebrate_additives).
...
action_label(analyze_price_adjustment_revision_request, 'Analyze price adjustment request').
...
action_label(apply_fine_with_other_penalties, 'Apply fine with others').
action_type(apply_penalties).
action_label(apply_penalties, 'Apply penalties').
action_type(apply_reduction_price_index).
action_label(apply_reduction_price_index, 'Apply price reduction index').
action_type(approve_guarantee_extension).
action_label(approve_guarantee_extension, 'Approve guarantee extension').
action_type(assume_full_responsibility_for_any_burdens).
action_label(assume_full_responsibility_for_any_burdens, 'Assume full responsibility').
...
action_label(be_responsible_for_compliance_with_security_standards, 'Comply with security standards').
action_type(be_subject_to_fine).
action_label(be_subject_to_fine, 'Subject to fine').
...
action_label(be_subject_to_suspension, 'Subject to suspension').
action_type(be_subject_to_warning).
action_label(be_subject_to_warning, 'Subject to warning').
action_type(bear_costs_of_errors).
action_label(bear_costs_of_errors, 'Bear costs of errors').
action_type(cant_celebrate_additives).
action_label(cant_celebrate_additives, 'Cant celebrate additives due to allocated risks').
...
action_type(communicate_manager_changes).
action_label(communicate_manager_changes, 'Communicate manager changes').
...
action_type(credits_being_deducted).
action_label(credits_being_deducted, 'Subject to credit deduction').
...
action_label(demand_execution_according_to_specifications, 'Demand execution per specifications').
...
action_type(denature_contract).
action_label(denature_contract, 'No denaturing contract').
...
action_type(dimension_quantities_correctly).
action_label(dimension_quantities_correctly, 'Dimension quantities correctly').
...
action_type(exercise_regress_right).
action_label(exercise_regress_right, 'Exercise regress right').
...
action_type(grant_right_of_defense).
action_label(grant_right_of_defense, 'Grant right of defense').
...
action_type(impedimento_receber_servico).
action_label(impedimento_receber_servico, 'Cannot provide service').
action_type(indicate_address_phone_fax_email).
action_label(indicate_address_phone_fax_email, 'Indicate contact information').
...
action_type(keep_data_processing_records).
action_label(keep_data_processing_records, 'Keep data processing records').
...
action_label(maintain_info_secrecy, 'Maintain information secrecy').
...
action_type(not_claim_indemnification_for_rescission).
action_label(not_claim_indemnification_for_rescission, 'Not claim indemnification for rescission').
action_type(not_denature_contract).
action_label(not_denature_contract, 'Do not denature contract').
action_type(not_offer_undue_advantage).
action_label(not_offer_undue_advantage, 'Not offer undue advantage').
action_type(not_refuse_to_formalize_amendment).
action_label(not_refuse_to_formalize_amendment, 'Must formalize amendment').
...
action_type(observe_all_conditions_established_in_proposal).
action_label(observe_all_conditions_established_in_proposal, 'Observe conditions in proposal').
...
action_type(omit_demanding_full_object).
action_label(omit_demanding_full_object, 'Omit demanding full object').
action_type(omit_fiscal_irregularity).
action_label(omit_fiscal_irregularity, 'Avoid fiscal issues').
...
action_type(omitir_nao_prorrogar).
action_label(omitir_nao_prorrogar, 'Omit not extending').
action_type(pay_all_fees_and_taxes).
action_label(pay_all_fees_and_taxes, 'Pay all fees and taxes').
...
action_type(present_declaration_of_information).
action_label(present_declaration_of_information, 'Present information declaration').
...
action_type(presentar_manifestacao_sobre_prorrogacao).
action_label(presentar_manifestacao_sobre_prorrogacao, 'Present manifestation about extension').
...
action_label(prorrogar_contrato, 'Extend contract').
action_type(protect_data_privacy).
action_label(protect_data_privacy, 'Protect data privacy').
...
action_label(provide_ethics_documents, 'Provide ethics documents').
...
action_type(provide_update_support).
action_label(provide_update_support, 'Provide update and support services').
action_type(provide_written_notice_before_termination).
action_label(provide_written_notice_before_termination, 'Provide written notice').
action_type(provide_written_notification_before_termination).
action_label(provide_written_notification_before_termination, 'Provide written notification').
action_type(receive_contractual_guarantee).
action_label(receive_contractual_guarantee, 'Receive guarantee').
action_type(receive_indemnification_for_not_demanded_object).
action_label(receive_indemnification_for_not_demanded_object, 'Receive indemnification if not demanded').
...
action_type(receive_update_support).
action_label(receive_update_support, 'Receive update and support services').
action_type(reject_document).
action_label(reject_document, 'Reject document').
...
action_label(repair_correct_remove_reconstruct_or_substitute, 'Repair or substitute object').
action_type(repair_damages_and_losses).
action_label(repair_damages_and_losses, 'Repair damages and losses').
action_type(report_issues_to_bndes).
action_label(report_issues_to_bndes, 'Report issues to BNDES').
action_type(request_additional_data).
action_label(request_additional_data, 'Request additional data').
action_type(request_ethics_documents).
action_label(request_ethics_documents, 'Request ethics documents').
...
action_label(request_price_adjustment_revision_before_end, 'Request price adj before end').
...
action_label(resolve_disputes_elsewhere, 'Not resolve disputes elsewhere').
action_type(resolve_disputes_in_rio_de_janeiro).
action_label(resolve_disputes_in_rio_de_janeiro, 'Resolve disputes in Rio de Janeiro').
action_type(return_bndes_property).
action_label(return_bndes_property, 'Return BNDES property').
action_type(return_resources_disposed_by_bndes).
action_label(return_resources_disposed_by_bndes, 'Return resources disposed by BNDES').
action_type(solicitar_comprovacao_sancao).
action_label(solicitar_comprovacao_sancao, 'Request proof of no sanction').
action_type(sue_for_past_omissions).
action_label(sue_for_past_omissions, 'Sue for past omissions').
action_type(sujeitar_as_penalidades).
action_label(sujeitar_as_penalidades, 'Subject to penalties').
...
action_label(terminate_contract_due_breach, 'Terminate contract (breach)').
action_type(terminate_contract_due_dissolution).
action_label(terminate_contract_due_dissolution, 'Terminate contract (dissolution)').
action_type(terminate_contract_due_force_majeure).
action_label(terminate_contract_due_force_majeure, 'Terminate contract (force majeure)').
action_type(terminate_contract_due_suspension).
action_label(terminate_contract_due_suspension, 'Terminate contract (suspension)').
action_type(terminate_contract_with_written_justification).
action_label(terminate_contract_with_written_justification, 'Terminate contract').

% ===== 3) Original Contract ABox =====
contract(contrato_ocs_0195_2022).
contract_metadata(contrato_ocs_0195_2022, numero_ocs, '0195/2022').
contract_metadata(contrato_ocs_0195_2022, numero_sap, '4400005122').
contract_metadata(contrato_ocs_0195_2022, tipo_contrato, 'CONTRATO DE PRESTAÇÃO DE SERVIÇOS').
contract_metadata(contrato_ocs_0195_2022, partes, ['BANCO NACIONAL DE DESENVOLVIMENTO ECONÔMICO E SOCIAL – BNDES', 'BRASOFTWARE INFORMÁTICA LTDA']).
contract_metadata(contrato_ocs_0195_2022, contratante, 'BANCO NACIONAL DE DESENVOLVIMENTO ECONÔMICO E SOCIAL – BNDES').
contract_metadata(contrato_ocs_0195_2022, contratado, 'BRASOFTWARE INFORMÁTICA LTDA').
contract_metadata(contrato_ocs_0195_2022, cnpj_contratante, '33.657.248/0001-89').
contract_metadata(contrato_ocs_0195_2022, cnpj_contratado, '57.142.978/0001-05').
contract_metadata(contrato_ocs_0195_2022, procedimento_licitatorio, 'Pregão Eletrônico nº 025/2022 - BNDES').
contract_metadata(contrato_ocs_0195_2022, data_autorizacao, '24/06/2022').
contract_metadata(contrato_ocs_0195_2022, ip_ati_degat, '008/2022').
contract_metadata(contrato_ocs_0195_2022, data_ip_ati_degat, '15/06/2022').
contract_metadata(contrato_ocs_0195_2022, rubrica_orcamentaria, '3101700021').
contract_metadata(contrato_ocs_0195_2022, centro_custo, 'BN00004000 - CC TI1').
contract_metadata(contrato_ocs_0195_2022, lei_aplicavel, 'Lei nº 13.303/2016').
contract_metadata(contrato_ocs_0195_2022, regulamento, 'Regulamento Licitações e Contratos do Sistema BNDES').
contract_clause(contrato_ocs_0195_2022, clausula_primeira_objeto, 'CLÁUSULA PRIMEIRA – OBJETO', 'O presente Contrato tem por objeto a prestação continuada de serviços de atualização e suporte técnico, na modalidade Software Assurance, do Sistema Gerenciador de Banco de Dados (SGBD) Microsoft SQL Server, conforme especificações constantes do Termo de Referência (Anexo I do Edital do Pregão Eletrônico nº 025/2022 - BNDES) e da proposta apresentada pelo CONTRATADO, respectivamente, Anexos I e II deste Contrato.').

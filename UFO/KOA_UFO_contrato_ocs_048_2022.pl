% ===== KOA Combined Output | contract_id: contrato_ocs_0048_2022 =====
...
% UFO-only grounding generated from: KOA_Contrato_OCS_048_2022_-_TGV_(ETL).pl
% contract_id: contrato_ocs_0048_2022

instance_of(contrato_ocs_0048_2022, legal_service_agreement).

instance_of(banco_nacional_de_desenvolvimento_economico_e_social_bndes, agent).
instance_of(tgv_tecnologia_ltda, agent).

plays_role(banco_nacional_de_desenvolvimento_economico_e_social_bndes, service_customer_role, contrato_ocs_0048_2022).
plays_role(tgv_tecnologia_ltda, hired_service_provider_role, contrato_ocs_0048_2022).

clause_of(clausula_primeira_objeto, contrato_ocs_0048_2022).
clause_of(clausula_segunda_vigencia, contrato_ocs_0048_2022).
clause_of(clausula_terceira_local_prazo_condicoes_execucao_objeto, contrato_ocs_0048_2022).
clause_of(clausula_quarta_niveis_servico, contrato_ocs_0048_2022).
clause_of(clausula_quinta_recebimento_objeto, contrato_ocs_0048_2022).
clause_of(clausula_sexta_preco, contrato_ocs_0048_2022).
clause_of(clausula_setima_pagamento, contrato_ocs_0048_2022).
clause_of(clausula_oitava_equilibrio_economico_financeiro_contrato, contrato_ocs_0048_2022).
clause_of(clausula_decima_garantia_contratual, contrato_ocs_0048_2022).
clause_of(clausula_decima_primeira_obrigacoes_contratado, contrato_ocs_0048_2022).
clause_of(clausula_decima_segunda_conduta_etica_contratado_bndes, contrato_ocs_0048_2022).
clause_of(clausula_decima_terceira_sigilo_informacoes, contrato_ocs_0048_2022).
clause_of(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, contrato_ocs_0048_2022).
clause_of(clausula_decima_quinta_obrigações_do_bndes, contrato_ocs_0048_2022).
clause_of(clausula_decima_sexta_equidade_de_genero_e_valorização_da_diversidade, contrato_ocs_0048_2022).
clause_of(clausula_decima_setima_cessão_de_contrato_ou_de_crédito_sucessão_contratual_e_subcontratação, contrato_ocs_0048_2022).
clause_of(clausula_decima_oitava_penalidades, contrato_ocs_0048_2022).
clause_of(clausula_decima_nona_alterações_contratuais, contrato_ocs_0048_2022).
clause_of(clausula_vigesima_extincao_contrato, contrato_ocs_0048_2022).
clause_of(clausula_vigesima_primeira_disposições_finais, contrato_ocs_0048_2022).
clause_of(clausula_vigesima_segunda_foro, contrato_ocs_0048_2022).
clause_of(clausula_nona_matriz_riscos, contrato_ocs_0048_2022).

legal_relation_instance(clausula_primeira_objeto, duty_to_act, tgv_tecnologia_ltda, provide_etl_services).
legal_relation_instance(clausula_primeira_objeto, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, receive_etl_services).
legal_relation_instance(clausula_segunda_vigencia, duty_to_act, tgv_tecnologia_ltda, present_manifestation_on_extension).
legal_relation_instance(clausula_segunda_vigencia, duty_to_act, tgv_tecnologia_ltda, communicate_interest_in_contract_extension).
legal_relation_instance(clausula_segunda_vigencia, subjection, tgv_tecnologia_ltda, subject_to_penalties_for_refusal).
legal_relation_instance(clausula_segunda_vigencia, right_to_omission, tgv_tecnologia_ltda, refuse_to_celebrate_contract_extension).
legal_relation_instance(clausula_terceira_local_prazo_condicoes_execucao_objeto, duty_to_act, tgv_tecnologia_ltda, execute_object_per_specs).
...
legal_relation_instance(clausula_quarta_niveis_servico, duty_to_act, tgv_tecnologia_ltda, execute_services_according_to_standards).
...
legal_relation_instance(clausula_quarta_niveis_servico, subjection, tgv_tecnologia_ltda, be_subject_to_price_reduction).
...
legal_relation_instance(clausula_quarta_niveis_servico, subjection, tgv_tecnologia_ltda, be_subject_to_penalties).
...
legal_relation_instance(clausula_quinta_recebimento_objeto, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, recebimento_objeto).
...
legal_relation_instance(clausula_sexta_preco, duty_to_act, tgv_tecnologia_ltda, bear_cost_of_quantity_errors).
legal_relation_instance(clausula_sexta_preco, no_right_to_action, tgv_tecnologia_ltda, demand_indemnification).
legal_relation_instance(clausula_sexta_preco, right_to_action, tgv_tecnologia_ltda, receive_payment).
legal_relation_instance(clausula_sexta_preco, subjection, tgv_tecnologia_ltda, accept_reduced_payment_for_partial_execution).
...
legal_relation_instance(clausula_setima_pagamento, right_to_action, tgv_tecnologia_ltda, receive_payment).
legal_relation_instance(clausula_setima_pagamento, duty_to_act, tgv_tecnologia_ltda, present_fiscal_document).
...
legal_relation_instance(clausula_setima_pagamento, duty_to_act, tgv_tecnologia_ltda, provide_supporting_document).
legal_relation_instance(clausula_setima_pagamento, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, deduct_overpayment).
legal_relation_instance(clausula_setima_pagamento, permission_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, deduct_tax_penalty).
...
legal_relation_instance(clausula_setima_pagamento, duty_to_omit, banco_nacional_de_desenvolvimento_economico_e_social_bndes, omit_unjustified_delay).
legal_relation_instance(clausula_setima_pagamento, duty_to_act, tgv_tecnologia_ltda, comply_with_iss_rule).
...
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, right_to_action, tgv_tecnologia_ltda, request_price_adjustment).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, right_to_action, tgv_tecnologia_ltda, request_price_revision).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, call_contractor_to_negotiate).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, tgv_tecnologia_ltda, present_cost_spreadsheets).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, tgv_tecnologia_ltda, present_requested_info).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, tgv_tecnologia_ltda, request_price_adjustment_revision_before_end).
...
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, no_right_to_action, tgv_tecnologia_ltda, retroactive_effects_if_late).
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, tgv_tecnologia_ltda, provide_contractual_guarantee).
legal_relation_instance(clausula_decima_garantia_contratual, right_to_action, tgv_tecnologia_ltda, receive_return_of_guarantee).
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, tgv_tecnologia_ltda, obtain_guarantor_agreement).
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, tgv_tecnologia_ltda, provide_supplementary_guarantee).
legal_relation_instance(clausula_decima_garantia_contratual, subjection, tgv_tecnologia_ltda, potential_penalty_for_failure_to_provide_guarantee).
legal_relation_instance(clausula_decima_garantia_contratual, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, extend_guarantee_submission_period).
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, tgv_tecnologia_ltda, obtain_new_guarantee).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, tgv_tecnologia_ltda, maintain_qualification_conditions).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, tgv_tecnologia_ltda, communicate_penalty).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, tgv_tecnologia_ltda, repair_correct_remove_rebuild).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, tgv_tecnologia_ltda, repair_damages).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, tgv_tecnologia_ltda, pay_taxes).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, tgv_tecnologia_ltda, assume_responsibility_for_burdens).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, tgv_tecnologia_ltda, provide_exclusion_from_simples_nacional).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, subjection, tgv_tecnologia_ltda, allow_inspections).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, tgv_tecnologia_ltda, obey_instructions).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, tgv_tecnologia_ltda, designate_representative).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, tgv_tecnologia_ltda, maintain_integrity).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_omit, tgv_tecnologia_ltda, not_offer_undue_advantage).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_omit, tgv_tecnologia_ltda, prevent_favoritism).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_omit, tgv_tecnologia_ltda, prevent_allocation_family).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, tgv_tecnologia_ltda, observe_ethics_policy).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, tgv_tecnologia_ltda, adopt_good_practices).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, tgv_tecnologia_ltda, remove_agents_implied).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, tgv_tecnologia_ltda, communicate_fact_bndes).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, tgv_tecnologia_ltda, prevent_corruption).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, tgv_tecnologia_ltda, comply_bndes_information_security_policy).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_omit, tgv_tecnologia_ltda, not_access_confidential_bndes_information).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, tgv_tecnologia_ltda, maintain_confidentiality_of_information).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_omit, tgv_tecnologia_ltda, not_copy_reproduce_retain_confidential_information).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, tgv_tecnologia_ltda, limit_access_to_information).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, tgv_tecnologia_ltda, inform_bndes_of_breaches).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, tgv_tecnologia_ltda, return_materials_to_bndes).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_omit, tgv_tecnologia_ltda, not_use_confidential_information).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, tgv_tecnologia_ltda, present_confidentiality_terms).
legal_relation_instance(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, adopt_security_measures).
legal_relation_instance(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, duty_to_act, tgv_tecnologia_ltda, follow_bndes_instructions).
legal_relation_instance(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, duty_to_act, tgv_tecnologia_ltda, maintain_data_confidentiality).
legal_relation_instance(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, duty_to_act, tgv_tecnologia_ltda, inform_bndes_of_requests).
legal_relation_instance(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, duty_to_act, tgv_tecnologia_ltda, maintain_data_processing_records).
legal_relation_instance(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, duty_to_act, tgv_tecnologia_ltda, inform_bndes_of_incidents).
legal_relation_instance(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, duty_to_act, tgv_tecnologia_ltda, delete_personal_data).
legal_relation_instance(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, right_to_regress).
legal_relation_instance(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, duty_to_omit, banco_nacional_de_desenvolvimento_economico_e_social_bndes, omit_sharing_data_without_authorization).
legal_relation_instance(clausula_decima_quinta_obrigações_do_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, make_payments_to_contracted_party).
legal_relation_instance(clausula_decima_quinta_obrigações_do_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, designate_contract_manager).
legal_relation_instance(clausula_decima_quinta_obrigações_do_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, designate_substitute_contract_manager).
legal_relation_instance(clausula_decima_quinta_obrigações_do_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, provide_information).
legal_relation_instance(clausula_decima_quinta_obrigações_do_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, communicate_instructions).
legal_relation_instance(clausula_decima_quinta_obrigações_do_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, communicate_administrative_procedure).
legal_relation_instance(clausula_decima_quinta_obrigações_do_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, communicate_application_of_penalty).
legal_relation_instance(clausula_decima_quinta_obrigações_do_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, provide_documents_on_request).
legal_relation_instance(clausula_decima_quinta_obrigações_do_bndes, right_to_action, tgv_tecnologia_ltda, receive_payments).
legal_relation_instance(clausula_decima_sexta_equidade_de_genero_e_valorização_da_diversidade, duty_to_act, tgv_tecnologia_ltda, prove_absence_of_discrimination).
legal_relation_instance(clausula_decima_sexta_equidade_de_genero_e_valorização_da_diversidade, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, suspend_contract_execution).
legal_relation_instance(clausula_decima_sexta_equidade_de_genero_e_valorização_da_diversidade, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, request_proof_of_no_discrimination).
legal_relation_instance(clausula_decima_sexta_equidade_de_genero_e_valorização_da_diversidade, subjection, tgv_tecnologia_ltda, contract_execution_suspension).
legal_relation_instance(clausula_decima_setima_cessão_de_contrato_ou_de_crédito_sucessão_contratual_e_subcontratação, duty_to_omit, tgv_tecnologia_ltda, omit_contract_assignment).
legal_relation_instance(clausula_decima_setima_cessão_de_contrato_ou_de_crédito_sucessão_contratual_e_subcontratação, no_right_to_action, tgv_tecnologia_ltda, no_right_to_assign_contract).
legal_relation_instance(clausula_decima_setima_cessão_de_contrato_ou_de_crédito_sucessão_contratual_e_subcontratação, duty_to_omit, tgv_tecnologia_ltda, omit_credit_assignment).
legal_relation_instance(clausula_decima_setima_cessão_de_contrato_ou_de_crédito_sucessão_contratual_e_subcontratação, no_right_to_action, tgv_tecnologia_ltda, no_right_to_assign_credit).
legal_relation_instance(clausula_decima_setima_cessão_de_contrato_ou_de_crédito_sucessão_contratual_e_subcontratação, duty_to_omit, tgv_tecnologia_ltda, omit_issuing_credit_titles).
legal_relation_instance(clausula_decima_setima_cessão_de_contrato_ou_de_crédito_sucessão_contratual_e_subcontratação, no_right_to_action, tgv_tecnologia_ltda, no_right_to_issue_credit_titles).
legal_relation_instance(clausula_decima_setima_cessão_de_contrato_ou_de_crédito_sucessão_contratual_e_subcontratação, duty_to_omit, tgv_tecnologia_ltda, omit_subcontracting).
legal_relation_instance(clausula_decima_setima_cessão_de_contrato_ou_de_crédito_sucessão_contratual_e_subcontratação, no_right_to_action, tgv_tecnologia_ltda, no_right_to_subcontract).
legal_relation_instance(clausula_decima_setima_cessão_de_contrato_ou_de_crédito_sucessão_contratual_e_subcontratação, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, analyze_contractual_risks).
legal_relation_instance(clausula_decima_oitava_penalidades, subjection, tgv_tecnologia_ltda, subject_to_penalties).
legal_relation_instance(clausula_decima_oitava_penalidades, right_to_action, tgv_tecnologia_ltda, request_reconsideration_or_appeal).
...
legal_relation_instance(clausula_decima_oitava_penalidades, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, apply_multa_jointly).
legal_relation_instance(clausula_decima_oitava_penalidades, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, deduct_multa_and_prejuizo).
...
legal_relation_instance(clausula_vigesima_extincao_contrato, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_contract_in_case_of_breach).
...
legal_relation_instance(clausula_vigesima_extincao_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_contract_for_force_majeure).
legal_relation_instance(clausula_vigesima_primeira_disposições_finais, no_right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, demand_strict_compliance).
legal_relation_instance(clausula_vigesima_primeira_disposições_finais, permission_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, exercise_rights).
legal_relation_instance(clausula_vigesima_primeira_disposições_finais, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, exercise_rights).
...
legal_relation_instance(clausula_vigesima_segunda_foro, no_right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, choose_other_court).
legal_relation_instance(clausula_nona_matriz_riscos, duty_to_omit, tgv_tecnologia_ltda, not_add_for_allocated_risks).
legal_relation_instance(clausula_nona_matriz_riscos, no_right_to_action, tgv_tecnologia_ltda, request_addendum_for_allocated_risks).
legal_relation_instance(clausula_nona_matriz_riscos, duty_to_act, tgv_tecnologia_ltda, respect_economic_equilibrium_clause).
legal_relation_instance(clausula_nona_matriz_riscos, right_to_action, tgv_tecnologia_ltda, request_economic_rebalancing).
...
action_label(alter_contract, 'Alter contract by agreement').
...
action_label(analyze_price_adjustment_revision_request, 'Analyze price adjustment').
action_type(apply_multa_jointly).
action_label(apply_multa_jointly, 'Apply multa jointly').
...
action_type(call_contractor_to_negotiate).
action_label(call_contractor_to_negotiate, 'Call to negotiate price reduction').
...
action_type(communicate_fact_bndes).
action_label(communicate_fact_bndes, 'Communicate fact BNDES').
...
action_type(comply_bndes_information_security_policy).
action_label(comply_bndes_information_security_policy, 'Comply with BNDES security policy').
action_type(comply_with_iss_rule).
action_label(comply_with_iss_rule, 'Comply with ISS rule').
action_type(contract_execution_suspension).
action_label(contract_execution_suspension, 'Be subject to contract suspension').
action_type(deduct_amounts).
action_label(deduct_amounts, 'Deduct amounts').
action_type(deduct_multa_and_prejuizo).
action_label(deduct_multa_and_prejuizo, 'Deduct multa and prejuízo').
action_type(deduct_overpayment).
action_label(deduct_overpayment, 'Deduct overpayment').
action_type(deduct_tax_penalty).
action_label(deduct_tax_penalty, 'Deduct tax penalty').
...
action_label(demand_strict_compliance, 'No right to demand waived compliance').
...
action_type(execute_object_per_specs).
action_label(execute_object_per_specs, 'Execute object as specified').
...
action_label(exercise_rights, 'Permission to exercise rights').
action_type(expect_execution_per_specs).
action_label(expect_execution_per_specs, 'Expect execution as specified').
action_type(extend_guarantee_submission_period).
action_label(extend_guarantee_submission_period, 'Extend guarantee submission period').
...
action_type(indicate_contact_details).
action_label(indicate_contact_details, 'Indicate contact details').
action_type(inform_bndes_of_breaches).
action_label(inform_bndes_of_breaches, 'Inform BNDES of breaches').
action_type(inform_bndes_of_incidents).
action_label(inform_bndes_of_incidents, 'Inform BNDES of incidents').
action_type(inform_bndes_of_requests).
action_label(inform_bndes_of_requests, 'Inform BNDES of requests').
action_type(inform_technical_support_details).
action_label(inform_technical_support_details, 'Inform tech support details').
action_type(inspect).
action_label(inspect, 'Inspect execution').
...
action_label(not_access_confidential_bndes_information, 'Do not access confidential information').
action_type(not_add_for_allocated_risks).
action_label(not_add_for_allocated_risks, 'Not add for allocated risks').
action_type(not_copy_reproduce_retain_confidential_information).
action_label(not_copy_reproduce_retain_confidential_information, 'Not copy, reproduce, or retain info').
...
action_label(omit_sharing_data_without_authorization, 'Omit sharing data').
...
action_type(potential_penalty_for_failure_to_provide_guarantee).
action_label(potential_penalty_for_failure_to_provide_guarantee, 'Subject to penalty for not providing guarantee').
...
action_type(prevent_allocation_family).
action_label(prevent_allocation_family, 'Prevent allocation family').
...
action_type(provide_etl_services).
action_label(provide_etl_services, 'Provide ETL services').
...
action_type(provide_supplementary_guarantee).
action_label(provide_supplementary_guarantee, 'Provide supplementary guarantee').
action_type(provide_supporting_document).
action_label(provide_supporting_document, 'Provide supporting document').
action_type(provide_written_notification_of_termination).
action_label(provide_written_notification_of_termination, 'Provide written notification of termination').
action_type(recebimento_objeto).
action_label(recebimento_objeto, 'Receive the object').
action_type(receive_etl_services).
action_label(receive_etl_services, 'Receive ETL services').
...
action_type(receive_return_of_guarantee).
action_label(receive_return_of_guarantee, 'Receive guarantee back').
action_type(refuse_to_celebrate_contract_extension).
action_label(refuse_to_celebrate_contract_extension, 'Refuse to celebrate contract extension').
action_type(reject_late_document).
action_label(reject_late_document, 'Reject late document').
action_type(remove_agents_implied).
action_label(remove_agents_implied, 'Remove Agents Implied').
action_type(repair_correct_remove_rebuild).
action_label(repair_correct_remove_rebuild, 'Repair defects').
action_type(repair_damages).
action_label(repair_damages, 'Repair damages').
action_type(request_addendum_for_allocated_risks).
action_label(request_addendum_for_allocated_risks, 'No right to addendum for allocated risks').
...
action_type(request_economic_rebalancing).
action_label(request_economic_rebalancing, 'Request economic rebalancing').
...
action_label(request_price_adjustment_revision_before_end, 'Request before contract end').
...
action_label(require_service_execution_according_to_standards, 'Require service execution as agreed').
action_type(respect_economic_equilibrium_clause).
action_label(respect_economic_equilibrium_clause, 'Respect economic equilibrium clause.').
action_type(responsible_for_security_standards).
action_label(responsible_for_security_standards, 'Responsible for security standards').
action_type(retroactive_effects_if_late).
action_label(retroactive_effects_if_late, 'No retroactive effects if late').
action_type(return_materials_to_bndes).
action_label(return_materials_to_bndes, 'Return materials to BNDES').
action_type(return_resources_revoke_profiles).
action_label(return_resources_revoke_profiles, 'Return resources revoke profiles').
action_type(right_to_regress).
action_label(right_to_regress, 'Right to regress').

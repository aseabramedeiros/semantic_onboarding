% ===== KOA Combined Output | contract_id: contrato_ocs_099_2021 =====
...
% UFO-only grounding generated from: KOA_Contrato_OCS_099_2021_-_Heiliger_Open_Banking.pl
% contract_id: contrato_ocs_099_2021

instance_of(contrato_ocs_099_2021, legal_service_agreement).

instance_of(banco_nacional_de_desenvolvimento_economico_e_social_bndes, agent).
instance_of(heiliger_tecnologia_e_software_ltda, agent).

plays_role(banco_nacional_de_desenvolvimento_economico_e_social_bndes, service_customer_role, contrato_ocs_099_2021).
plays_role(heiliger_tecnologia_e_software_ltda, hired_service_provider_role, contrato_ocs_099_2021).

clause_of(clausula_primeira_objeto, contrato_ocs_099_2021).
clause_of(clausula_segunda_vigencia, contrato_ocs_099_2021).
clause_of(clausula_terceira_local_prazo_condicoes_execucao_objeto, contrato_ocs_099_2021).
clause_of(clausula_quarta_niveis_servico, contrato_ocs_099_2021).
clause_of(clausula_quinta_recebimento_objeto, contrato_ocs_099_2021).
clause_of(clausula_sexta_preco, contrato_ocs_099_2021).
clause_of(clausula_setima_pagamento, contrato_ocs_099_2021).
clause_of(clausula_oitava_equilibrio_economico_financeiro_contrato, contrato_ocs_099_2021).
clause_of(clausula_decima_garantia_contratual, contrato_ocs_099_2021).
clause_of(clausula_decima_primeira_obrigações_contratado, contrato_ocs_099_2021).
clause_of(clausula_decima_segunda_conduta_ética_do_contratado_e_do_bndes, contrato_ocs_099_2021).
clause_of(clausula_decima_terceira_sigilo_das_informações, contrato_ocs_099_2021).
clause_of(clausula_decima_quarta_acesso_protecao_dados_pessoais, contrato_ocs_099_2021).
clause_of(clausula_decima_quinta_obrigações_bndes, contrato_ocs_099_2021).
clause_of(clausula_decima_sexta_cessao_contrato_credito_sucessao_contratual_subcontratacao, contrato_ocs_099_2021).
clause_of(clausula_decima_setima_penalidades, contrato_ocs_099_2021).
clause_of(clausula_decima_oitava_alteracoes_contratuais, contrato_ocs_099_2021).
clause_of(clausula_decima_nona_extincao_contrato, contrato_ocs_099_2021).
clause_of(clausula_vigesima_disposicoes_finais, contrato_ocs_099_2021).
clause_of(clausula_vigesima_primeira_foro, contrato_ocs_099_2021).
clause_of(clausula_nona_matriz_riscos, contrato_ocs_099_2021).

legal_relation_instance(clausula_primeira_objeto, duty_to_act, heiliger_tecnologia_e_software_ltda, provide_subscription_services).
...
legal_relation_instance(clausula_segunda_vigencia, duty_to_act, heiliger_tecnologia_e_software_ltda, communicate_interest_to_extend_contract).
legal_relation_instance(clausula_segunda_vigencia, duty_to_act, heiliger_tecnologia_e_software_ltda, present_manifestation_about_contract_extension).
legal_relation_instance(clausula_segunda_vigencia, subjection, heiliger_tecnologia_e_software_ltda, subject_to_penalties_for_refusal_to_extend).
legal_relation_instance(clausula_terceira_local_prazo_condicoes_execucao_objeto, duty_to_act, heiliger_tecnologia_e_software_ltda, execute_contract_object_according_to_specs).
legal_relation_instance(clausula_terceira_local_prazo_condicoes_execucao_objeto, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, expect_contract_execution_according_to_specs).
legal_relation_instance(clausula_quarta_niveis_servico, duty_to_act, heiliger_tecnologia_e_software_ltda, execute_services_according_to_bndes_standards).
legal_relation_instance(clausula_quarta_niveis_servico, subjection, heiliger_tecnologia_e_software_ltda, suffer_price_reduction_for_noncompliance).
legal_relation_instance(clausula_quarta_niveis_servico, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, apply_price_reduction_for_noncompliance).
...
legal_relation_instance(clausula_sexta_preco, duty_to_act, heiliger_tecnologia_e_software_ltda, execute_contract_object).
legal_relation_instance(clausula_sexta_preco, right_to_action, heiliger_tecnologia_e_software_ltda, receive_payment).
...
legal_relation_instance(clausula_sexta_preco, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, demand_partial_execution).
legal_relation_instance(clausula_sexta_preco, duty_to_act, heiliger_tecnologia_e_software_ltda, bear_burden_of_mistake).
legal_relation_instance(clausula_sexta_preco, duty_to_act, heiliger_tecnologia_e_software_ltda, complement_quantities).
legal_relation_instance(clausula_sexta_preco, no_right_to_action, heiliger_tecnologia_e_software_ltda, demand_indemnization).
...
legal_relation_instance(clausula_setima_pagamento, duty_to_act, heiliger_tecnologia_e_software_ltda, present_fiscal_document).
legal_relation_instance(clausula_setima_pagamento, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, deduct_payment).
legal_relation_instance(clausula_setima_pagamento, right_to_action, heiliger_tecnologia_e_software_ltda, receive_payment).
...
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, right_to_action, heiliger_tecnologia_e_software_ltda, request_price_revision).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, heiliger_tecnologia_e_software_ltda, request_price_adjustment_revision).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, heiliger_tecnologia_e_software_ltda, present_requested_info).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, heiliger_tecnologia_e_software_ltda, formulate_request_price_revision).
...
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, permission_to_act, heiliger_tecnologia_e_software_ltda, request_price_readjustment).
...
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, heiliger_tecnologia_e_software_ltda, provide_contractual_guarantee).
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, heiliger_tecnologia_e_software_ltda, provide_complementary_guarantee).
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, heiliger_tecnologia_e_software_ltda, obtain_guarantor_agreement).
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, heiliger_tecnologia_e_software_ltda, obtain_new_guarantee).
...
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, heiliger_tecnologia_e_software_ltda, maintain_habilitation_conditions).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, heiliger_tecnologia_e_software_ltda, communicate_penalty_impediment).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, heiliger_tecnologia_e_software_ltda, repair_correct_remove_reconstruct).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, heiliger_tecnologia_e_software_ltda, repair_damages_bndes_third_parties).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, heiliger_tecnologia_e_software_ltda, pay_charges_and_taxes).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, heiliger_tecnologia_e_software_ltda, assume_responsibility_tax_documents).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, heiliger_tecnologia_e_software_ltda, providenciar_exclusao_simples_nacional).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, heiliger_tecnologia_e_software_ltda, designate_representative).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, heiliger_tecnologia_e_software_ltda, present_dif).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, heiliger_tecnologia_e_software_ltda, inform_contact_details).
legal_relation_instance(clausula_decima_segunda_conduta_ética_do_contratado_e_do_bndes, duty_to_act, heiliger_tecnologia_e_software_ltda, maintain_integrity_public_private).
legal_relation_instance(clausula_decima_segunda_conduta_ética_do_contratado_e_do_bndes, duty_to_act, heiliger_tecnologia_e_software_ltda, not_offer_undue_advantage).
legal_relation_instance(clausula_decima_segunda_conduta_ética_do_contratado_e_do_bndes, duty_to_omit, heiliger_tecnologia_e_software_ltda, omit_offering_undue_advantage).
legal_relation_instance(clausula_decima_segunda_conduta_ética_do_contratado_e_do_bndes, duty_to_act, heiliger_tecnologia_e_software_ltda, prevent_favoritism).
legal_relation_instance(clausula_decima_segunda_conduta_ética_do_contratado_e_do_bndes, duty_to_act, heiliger_tecnologia_e_software_ltda, prevent_allocation_of_family_members).
legal_relation_instance(clausula_decima_segunda_conduta_ética_do_contratado_e_do_bndes, duty_to_act, heiliger_tecnologia_e_software_ltda, comply_with_bndes_policies).
legal_relation_instance(clausula_decima_segunda_conduta_ética_do_contratado_e_do_bndes, duty_to_act, heiliger_tecnologia_e_software_ltda, adopt_good_environmental_practices).
legal_relation_instance(clausula_decima_segunda_conduta_ética_do_contratado_e_do_bndes, duty_to_act, heiliger_tecnologia_e_software_ltda, remove_agents_from_contract).
legal_relation_instance(clausula_decima_segunda_conduta_ética_do_contratado_e_do_bndes, duty_to_act, heiliger_tecnologia_e_software_ltda, notify_bndes_of_issues).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, heiliger_tecnologia_e_software_ltda, comply_with_bndes_security_policy).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_omit, heiliger_tecnologia_e_software_ltda, not_access_confidential_information).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, heiliger_tecnologia_e_software_ltda, maintain_information_secrecy).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, heiliger_tecnologia_e_software_ltda, limit_information_access).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, heiliger_tecnologia_e_software_ltda, inform_bndes_of_violation).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, heiliger_tecnologia_e_software_ltda, deliver_materials_to_bndes).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, heiliger_tecnologia_e_software_ltda, present_confidentiality_terms).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, heiliger_tecnologia_e_software_ltda, observe_legal_representative_term).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, heiliger_tecnologia_e_software_ltda, adopt_security_measures).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, regress_for_damages).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, heiliger_tecnologia_e_software_ltda, provide_data_access_channel).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, heiliger_tecnologia_e_software_ltda, inform_bndes_of_requests).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, heiliger_tecnologia_e_software_ltda, maintain_data_operations_record).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, heiliger_tecnologia_e_software_ltda, communicate_data_breaches).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, heiliger_tecnologia_e_software_ltda, eliminate_personal_data).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, heiliger_tecnologia_e_software_ltda, follow_instructions_data_treatment).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_omit, banco_nacional_de_desenvolvimento_economico_e_social_bndes, share_or_use_without_authorization).
...
legal_relation_instance(clausula_decima_quinta_obrigações_bndes, right_to_action, heiliger_tecnologia_e_software_ltda, receive_payments_from_bndes).
...
legal_relation_instance(clausula_decima_quinta_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, provide_documents_to_contracted_party).
legal_relation_instance(clausula_decima_quinta_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, provide_information_to_contracted_party).
legal_relation_instance(clausula_decima_quinta_obrigações_bndes, right_to_action, heiliger_tecnologia_e_software_ltda, receive_information_from_bndes).
legal_relation_instance(clausula_decima_quinta_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, communicate_instructions_to_contracted_party).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_contratual_subcontratacao, duty_to_omit, heiliger_tecnologia_e_software_ltda, omit_contract_assignment).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_contratual_subcontratacao, no_right_to_action, heiliger_tecnologia_e_software_ltda, assign_contract).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_contratual_subcontratacao, duty_to_omit, heiliger_tecnologia_e_software_ltda, omit_credit_assignment).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_contratual_subcontratacao, no_right_to_action, heiliger_tecnologia_e_software_ltda, assign_credit).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_contratual_subcontratacao, duty_to_omit, heiliger_tecnologia_e_software_ltda, omit_issuing_credit_title).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_contratual_subcontratacao, no_right_to_action, heiliger_tecnologia_e_software_ltda, issue_credit_title).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_contratual_subcontratacao, duty_to_omit, heiliger_tecnologia_e_software_ltda, omit_subcontracting).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_contratual_subcontratacao, no_right_to_action, heiliger_tecnologia_e_software_ltda, subcontract).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_contratual_subcontratacao, permission_to_act, heiliger_tecnologia_e_software_ltda, corporate_restructuring).
...
legal_relation_instance(clausula_decima_setima_penalidades, subjection, heiliger_tecnologia_e_software_ltda, be_subject_to_penalties).
...
legal_relation_instance(clausula_decima_setima_penalidades, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, deduct_fine).
legal_relation_instance(clausula_decima_setima_penalidades, duty_to_omit, heiliger_tecnologia_e_software_ltda, omit_total_or_partial_non_execution).
...
legal_relation_instance(clausula_decima_setima_penalidades, right_to_action, heiliger_tecnologia_e_software_ltda, request_reconsideration).
legal_relation_instance(clausula_decima_setima_penalidades, right_to_action, heiliger_tecnologia_e_software_ltda, interpose_resource).
legal_relation_instance(clausula_decima_setima_penalidades, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, apply_fine_with_other_penalties).
...
legal_relation_instance(clausula_decima_oitava_alteracoes_contratuais, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, formalize_contractual_changes).
legal_relation_instance(clausula_decima_nona_extincao_contrato, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, notify_breaching_party).
...
legal_relation_instance(clausula_decima_nona_extincao_contrato, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_contract_upon_other_party_breach).
legal_relation_instance(clausula_decima_nona_extincao_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, suspend_execution_and_terminate).
legal_relation_instance(clausula_decima_nona_extincao_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_contract_upon_fortuitous_event).
...
legal_relation_instance(clausula_vigesima_disposicoes_finais, no_right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, claim_waiver_novation).
legal_relation_instance(clausula_vigesima_primeira_foro, power, unknown, resolve_disputes_rio).
legal_relation_instance(clausula_vigesima_primeira_foro, no_right_to_action, unknown, resolve_disputes_elsewhere).
legal_relation_instance(clausula_nona_matriz_riscos, duty_to_omit, heiliger_tecnologia_e_software_ltda, not_request_additives_for_allocated_events).
legal_relation_instance(clausula_nona_matriz_riscos, no_right_to_action, heiliger_tecnologia_e_software_ltda, request_additives_for_allocated_events).
legal_relation_instance(clausula_nona_matriz_riscos, duty_to_act, heiliger_tecnologia_e_software_ltda, respect_economic_financial_balance_clause).
legal_relation_instance(clausula_nona_matriz_riscos, right_to_action, heiliger_tecnologia_e_software_ltda, demand_economic_financial_balance_clause_adjustment).
...
action_label(apply_fine_with_other_penalties, 'Apply fine together').
action_type(apply_penalties).
action_label(apply_penalties, 'Apply penalties').
action_type(apply_price_reduction_for_noncompliance).
action_label(apply_price_reduction_for_noncompliance, 'Apply price reduction for non-compliance').
...
action_type(assume_responsibility_tax_documents).
action_label(assume_responsibility_tax_documents, 'Assume responsibility for tax documents').
action_type(be_subject_to_penalties).
action_label(be_subject_to_penalties, 'Subject to penalties').
action_type(bear_burden_of_mistake).
action_label(bear_burden_of_mistake, 'Bear burden of mistake').
action_type(claim_waiver_novation).
action_label(claim_waiver_novation, 'Claim waiver').
action_type(communicate_data_breaches).
action_label(communicate_data_breaches, 'Communicate data breaches').
action_type(communicate_instructions_to_contracted_party).
action_label(communicate_instructions_to_contracted_party, 'Communicate instructions').
action_type(communicate_interest_to_extend_contract).
action_label(communicate_interest_to_extend_contract, 'Communicate interest to extend contract').
action_type(communicate_investigation_to_contracted_party).
action_label(communicate_investigation_to_contracted_party, 'Communicate investigation').
action_type(communicate_penalties_to_contracted_party).
action_label(communicate_penalties_to_contracted_party, 'Communicate penalties').
...
action_type(deduct_fine).
action_label(deduct_fine, 'Deduct fine').
action_type(deduct_payment).
action_label(deduct_payment, 'Deduct from payment').
action_type(deliver_materials_to_bndes).
action_label(deliver_materials_to_bndes, 'Deliver materials to BNDES').
action_type(demand_economic_financial_balance_clause_adjustment).
action_label(demand_economic_financial_balance_clause_adjustment, 'Demand economic balance adjustment').
action_type(demand_indemnization).
action_label(demand_indemnization, 'Demand indemnization').
action_type(demand_partial_execution).
action_label(demand_partial_execution, 'Demand partial execution').
...
action_type(ensure_compliance_security_standards).
action_label(ensure_compliance_security_standards, 'Ensure compliance with security standards').
action_type(execute_contract_object).
action_label(execute_contract_object, 'Execute contract object').
action_type(execute_contract_object_according_to_specs).
action_label(execute_contract_object_according_to_specs, 'Execute contract according to specs').
action_type(execute_services_according_to_bndes_standards).
action_label(execute_services_according_to_bndes_standards, 'Execute services according to BNDES standards').
action_type(exercise_rights).
action_label(exercise_rights, 'Exercise rights').
action_type(expect_contract_execution_according_to_specs).
action_label(expect_contract_execution_according_to_specs, 'Expect contract execution').
...
action_label(extinguish_contract, 'Terminate contract').
action_type(follow_instructions_data_treatment).
action_label(follow_instructions_data_treatment, 'Follow data treatment instructions').
action_type(formalize_alteration).
action_label(formalize_alteration, 'Formalize alteration').
action_type(formalize_contractual_changes).
action_label(formalize_contractual_changes, 'Formalize contractual changes').
...
action_type(inform_contact_details).
action_label(inform_contact_details, 'Inform contact details').
action_type(infringe_copyrights_patents).
action_label(infringe_copyrights_patents, 'Not infringe copyrights/patents').
action_type(interpose_resource).
action_label(interpose_resource, 'Appeal penalty').
...
action_label(maintain_integrity_public_private, 'Maintain integrity.').
...
action_type(not_request_additives_for_allocated_events).
action_label(not_request_additives_for_allocated_events, 'Do not request addenda').
action_type(notify_bndes_of_issues).
action_label(notify_bndes_of_issues, 'Notify BNDES of issues').
...
action_type(observe_legal_representative_term).
action_label(observe_legal_representative_term, 'Observe legal rep. term').
...
action_type(omit_total_or_partial_non_execution).
action_label(omit_total_or_partial_non_execution, 'Omit non-execution').
...
action_type(perform_inspections).
action_label(perform_inspections, 'Perform inspections').
action_type(perform_inspections_contract_execution).
action_label(perform_inspections_contract_execution, 'Perform inspections').
...
action_type(present_manifestation_about_contract_extension).
action_label(present_manifestation_about_contract_extension, 'Present manifestation about extension').
action_type(present_requested_info).
action_label(present_requested_info, 'Present requested info').
...
action_type(provide_complementary_guarantee).
action_label(provide_complementary_guarantee, 'Provide complementary guarantee').
...
action_type(provide_documents_to_contracted_party).
action_label(provide_documents_to_contracted_party, 'Provide documents').
action_type(provide_information_to_contracted_party).
action_label(provide_information_to_contracted_party, 'Provide information').
action_type(provide_subscription_services).
action_label(provide_subscription_services, 'Provide subscription services').
action_type(providenciar_exclusao_simples_nacional).
action_label(providenciar_exclusao_simples_nacional, 'Provide exclusion from Simples Nacional').
action_type(receive_information_from_bndes).
action_label(receive_information_from_bndes, 'Receive information').
...
action_type(regress_for_damages).
action_label(regress_for_damages, 'Regress for damages').
...
action_label(repair_correct_remove_reconstruct, 'Repair, correct, remove').
...
action_label(request_additives_for_allocated_events, 'No right to request addenda').
...
action_type(require_contract_maintenance).
action_label(require_contract_maintenance, 'Require contract maintenance').
action_type(resolve_disputes_elsewhere).
action_label(resolve_disputes_elsewhere, 'Cannot resolve disputes elsewhere').
action_type(resolve_disputes_rio).
action_label(resolve_disputes_rio, 'Resolve disputes in Rio').
...
action_type(return_resources_revoke_access).
action_label(return_resources_revoke_access, 'Return resources and revoke access').
action_type(review_contract_execution).
action_label(review_contract_execution, 'Review contract execution').
action_type(share_or_use_without_authorization).
action_label(share_or_use_without_authorization, 'Don\'t share data without authorization').
action_type(subcontract).
action_label(subcontract, 'No right to subcontract').
action_type(subject_to_bndes_instructions_procedures).
action_label(subject_to_bndes_instructions_procedures, 'Subject to BNDES instructions').
...
action_type(suffer_price_reduction_for_noncompliance).
action_label(suffer_price_reduction_for_noncompliance, 'Suffer price reduction for non-compliance').
action_type(suspend_execution_and_terminate).
action_label(suspend_execution_and_terminate, 'Suspend and terminate').
action_type(terminate_contract_upon_fortuitous_event).
action_label(terminate_contract_upon_fortuitous_event, 'Terminate upon fortuitous event').
action_type(terminate_contract_upon_other_party_breach).
action_label(terminate_contract_upon_other_party_breach, 'Terminate contract due to breach').

% ===== KOA Combined Output | contract_id: contrato_ocs_0044_2022 =====
...
% UFO-only grounding generated from: KOA_Contrato_OCS_044_2022_-_SAP_IDM_Conectores.pl
% contract_id: contrato_ocs_0044_2022

instance_of(contrato_ocs_0044_2022, legal_service_agreement).

instance_of(banco_nacional_de_desenvolvimento_economico_e_social_bndes, agent).
instance_of(sap_brasil_ltda, agent).

plays_role(banco_nacional_de_desenvolvimento_economico_e_social_bndes, service_customer_role, contrato_ocs_0044_2022).
plays_role(sap_brasil_ltda, hired_service_provider_role, contrato_ocs_0044_2022).

clause_of(clausula_primeira_objeto, contrato_ocs_0044_2022).
clause_of(clausula_segunda_vigencia, contrato_ocs_0044_2022).
clause_of(clausula_terceira_local_prazo_condicoes_execucao_objeto, contrato_ocs_0044_2022).
clause_of(clausula_quarta_niveis_servico, contrato_ocs_0044_2022).
clause_of(clausula_quinta_recebimento_objeto, contrato_ocs_0044_2022).
clause_of(clausula_sexta_preco, contrato_ocs_0044_2022).
clause_of(clausula_setima_pagamento, contrato_ocs_0044_2022).
clause_of(clausula_oitava_equilibrio_economico_financeiro_contrato, contrato_ocs_0044_2022).
clause_of(clausula_decima_obrigações_contratada, contrato_ocs_0044_2022).
clause_of(clausula_decima_primeira_conduta_etica, contrato_ocs_0044_2022).
clause_of(clausula_decima_segunda_sigilo_informacoes, contrato_ocs_0044_2022).
clause_of(clausula_decima_terceira_obrigações_bndes, contrato_ocs_0044_2022).
clause_of(clausula_decima_quarta_cessao_contrato, contrato_ocs_0044_2022).
clause_of(clausula_decima_quinta_penalidades, contrato_ocs_0044_2022).
clause_of(clausula_decima_sexta_alteracoes_contratuais, contrato_ocs_0044_2022).
clause_of(clausula_decima_setima_extincao_contrato, contrato_ocs_0044_2022).
clause_of(clausula_decima_oitava_disposicoes_finais, contrato_ocs_0044_2022).
clause_of(clausula_decima_nona_foro, contrato_ocs_0044_2022).
clause_of(clausula_nona_matriz_riscos, contrato_ocs_0044_2022).

legal_relation_instance(clausula_primeira_objeto, duty_to_act, sap_brasil_ltda, provide_sap_idm_licenses).
legal_relation_instance(clausula_primeira_objeto, duty_to_act, sap_brasil_ltda, provide_technical_support).
legal_relation_instance(clausula_primeira_objeto, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, receive_sap_idm_licenses).
...
legal_relation_instance(clausula_segunda_vigencia, duty_to_act, sap_brasil_ltda, communicate_intent_not_to_renew).
legal_relation_instance(clausula_segunda_vigencia, subjection, sap_brasil_ltda, be_subject_to_penalties_for_refusal).
legal_relation_instance(clausula_segunda_vigencia, right_to_omission, sap_brasil_ltda, omit_communicate_intent_not_to_renew).
legal_relation_instance(clausula_terceira_local_prazo_condicoes_execucao_objeto, duty_to_act, sap_brasil_ltda, execute_service_per_specifications).
legal_relation_instance(clausula_terceira_local_prazo_condicoes_execucao_objeto, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, expect_service_per_specifications).
...
legal_relation_instance(clausula_quarta_niveis_servico, subjection, sap_brasil_ltda, suffer_consequences_of_noncompliance).
...
legal_relation_instance(clausula_sexta_preco, right_to_action, sap_brasil_ltda, receive_payment).
legal_relation_instance(clausula_sexta_preco, duty_to_act, sap_brasil_ltda, bear_quantification_errors).
legal_relation_instance(clausula_sexta_preco, subjection, sap_brasil_ltda, price_reduction_for_partial_execution).
...
legal_relation_instance(clausula_setima_pagamento, duty_to_act, sap_brasil_ltda, encaminhar_documento_fiscal).
legal_relation_instance(clausula_setima_pagamento, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, apply_interest).
legal_relation_instance(clausula_setima_pagamento, right_to_action, sap_brasil_ltda, receive_payment).
legal_relation_instance(clausula_setima_pagamento, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, receive_document_fiscal).
legal_relation_instance(clausula_setima_pagamento, duty_to_omit, banco_nacional_de_desenvolvimento_economico_e_social_bndes, omit_payment_with_divergencies).
legal_relation_instance(clausula_setima_pagamento, right_to_action, sap_brasil_ltda, receive_interest).
legal_relation_instance(clausula_setima_pagamento, duty_to_omit, banco_nacional_de_desenvolvimento_economico_e_social_bndes, omit_payment_before_invoice).
legal_relation_instance(clausula_setima_pagamento, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, devolver_documento_fiscal).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, sap_brasil_ltda, present_revision_request_with_evidence).
...
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, convocar_a_contratada_para_negociar_reducao_de_precos).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, sap_brasil_ltda, request_reajuste_revisao_ate_prorrogacao_encerramento).
...
legal_relation_instance(clausula_decima_obrigações_contratada, duty_to_act, sap_brasil_ltda, maintain_qualification).
legal_relation_instance(clausula_decima_obrigações_contratada, duty_to_act, sap_brasil_ltda, report_penalties).
legal_relation_instance(clausula_decima_obrigações_contratada, duty_to_act, sap_brasil_ltda, repair_defects).
legal_relation_instance(clausula_decima_obrigações_contratada, duty_to_act, sap_brasil_ltda, repair_damages).
legal_relation_instance(clausula_decima_obrigações_contratada, duty_to_act, sap_brasil_ltda, pay_taxes).
legal_relation_instance(clausula_decima_obrigações_contratada, duty_to_act, sap_brasil_ltda, prove_exclusion_simples).
legal_relation_instance(clausula_decima_obrigações_contratada, duty_to_act, sap_brasil_ltda, allow_inspections).
legal_relation_instance(clausula_decima_obrigações_contratada, duty_to_act, sap_brasil_ltda, obey_instructions).
legal_relation_instance(clausula_decima_obrigações_contratada, duty_to_act, sap_brasil_ltda, designate_representative).
legal_relation_instance(clausula_decima_obrigações_contratada, duty_to_act, sap_brasil_ltda, allow_access_to_bc).
legal_relation_instance(clausula_decima_primeira_conduta_etica, duty_to_act, sap_brasil_ltda, maintain_integrity).
legal_relation_instance(clausula_decima_primeira_conduta_etica, duty_to_omit, sap_brasil_ltda, not_offer_undue_advantage).
legal_relation_instance(clausula_decima_primeira_conduta_etica, duty_to_omit, sap_brasil_ltda, prevent_favorecimento).
legal_relation_instance(clausula_decima_primeira_conduta_etica, duty_to_act, sap_brasil_ltda, ensure_no_family_allocation).
legal_relation_instance(clausula_decima_primeira_conduta_etica, duty_to_act, sap_brasil_ltda, observe_code_of_ethics).
legal_relation_instance(clausula_decima_primeira_conduta_etica, duty_to_act, sap_brasil_ltda, remove_agents).
legal_relation_instance(clausula_decima_primeira_conduta_etica, duty_to_act, sap_brasil_ltda, communicate_to_bndes).
legal_relation_instance(clausula_decima_primeira_conduta_etica, duty_to_act, sap_brasil_ltda, take_measures_to_prevent).
legal_relation_instance(clausula_decima_primeira_conduta_etica, duty_to_act, sap_brasil_ltda, adopt_good_environmental_practices).
legal_relation_instance(clausula_decima_segunda_sigilo_informacoes, duty_to_act, sap_brasil_ltda, adopt_security_measures).
legal_relation_instance(clausula_decima_segunda_sigilo_informacoes, duty_to_omit, sap_brasil_ltda, not_access_confidential_info).
legal_relation_instance(clausula_decima_segunda_sigilo_informacoes, duty_to_act, sap_brasil_ltda, maintain_information_secrecy).
legal_relation_instance(clausula_decima_segunda_sigilo_informacoes, duty_to_act, sap_brasil_ltda, limit_access_to_info).
legal_relation_instance(clausula_decima_segunda_sigilo_informacoes, duty_to_act, sap_brasil_ltda, inform_bndes_violation).
legal_relation_instance(clausula_decima_segunda_sigilo_informacoes, duty_to_act, sap_brasil_ltda, deliver_property_to_bndes).
legal_relation_instance(clausula_decima_segunda_sigilo_informacoes, duty_to_act, sap_brasil_ltda, observe_confidentiality_term).
legal_relation_instance(clausula_decima_segunda_sigilo_informacoes, duty_to_omit, sap_brasil_ltda, not_use_confidential_information).
legal_relation_instance(clausula_decima_terceira_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, make_payments_to_contracted_party).
legal_relation_instance(clausula_decima_terceira_obrigações_bndes, right_to_action, sap_brasil_ltda, receive_payments_from_bndes).
...
legal_relation_instance(clausula_decima_terceira_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, provide_info_on_ethics_policy).
legal_relation_instance(clausula_decima_terceira_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, provide_necessary_info).
legal_relation_instance(clausula_decima_terceira_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, communicate_instructions_procedures).
legal_relation_instance(clausula_decima_terceira_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, communicate_administrative_proceeding).
legal_relation_instance(clausula_decima_terceira_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, communicate_penalty).
legal_relation_instance(clausula_decima_quarta_cessao_contrato, duty_to_omit, sap_brasil_ltda, omit_contract_assignment).
legal_relation_instance(clausula_decima_quarta_cessao_contrato, no_right_to_action, sap_brasil_ltda, contract_assignment).
legal_relation_instance(clausula_decima_quarta_cessao_contrato, duty_to_omit, sap_brasil_ltda, omit_credit_issuance).
legal_relation_instance(clausula_decima_quarta_cessao_contrato, no_right_to_action, sap_brasil_ltda, issuance_of_credit_title).
legal_relation_instance(clausula_decima_quarta_cessao_contrato, duty_to_omit, sap_brasil_ltda, omit_subcontracting).
legal_relation_instance(clausula_decima_quarta_cessao_contrato, no_right_to_action, sap_brasil_ltda, subcontracting).
legal_relation_instance(clausula_decima_quarta_cessao_contrato, duty_to_omit, sap_brasil_ltda, omit_contractual_succession).
legal_relation_instance(clausula_decima_quarta_cessao_contrato, no_right_to_action, sap_brasil_ltda, contractual_succession).
legal_relation_instance(clausula_decima_quarta_cessao_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, analyze_risks).
legal_relation_instance(clausula_decima_quarta_cessao_contrato, subjection, sap_brasil_ltda, undergo_risk_analysis).
legal_relation_instance(clausula_decima_quinta_penalidades, subjection, sap_brasil_ltda, be_subject_to_penalties).
legal_relation_instance(clausula_decima_quinta_penalidades, right_to_action, sap_brasil_ltda, right_to_defense).
legal_relation_instance(clausula_decima_quinta_penalidades, right_to_action, sap_brasil_ltda, right_to_appeal).
legal_relation_instance(clausula_decima_quinta_penalidades, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, conduct_administrative_procedure).
legal_relation_instance(clausula_decima_quinta_penalidades, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, extinguish_contract).
...
legal_relation_instance(clausula_decima_sexta_alteracoes_contratuais, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, formalize_essential_alteration).
legal_relation_instance(clausula_decima_sexta_alteracoes_contratuais, subjection, banco_nacional_de_desenvolvimento_economico_e_social_bndes, compensate_damages_for_unjustified_refusal).
legal_relation_instance(clausula_decima_sexta_alteracoes_contratuais, permission_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, alter_contract).
legal_relation_instance(clausula_decima_sexta_alteracoes_contratuais, no_right_to_omission, banco_nacional_de_desenvolvimento_economico_e_social_bndes, refuse_essential_alteration).
legal_relation_instance(clausula_decima_sexta_alteracoes_contratuais, duty_to_omit, banco_nacional_de_desenvolvimento_economico_e_social_bndes, refuse_essential_alteration_without_just_cause).
legal_relation_instance(clausula_decima_sexta_alteracoes_contratuais, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, demand_contract_alteration).
legal_relation_instance(clausula_decima_setima_extincao_contrato, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_contract).
legal_relation_instance(clausula_decima_setima_extincao_contrato, subjection, sap_brasil_ltda, be_subject_to_contract_termination).
legal_relation_instance(clausula_decima_setima_extincao_contrato, right_to_action, sap_brasil_ltda, right_to_defend).
legal_relation_instance(clausula_decima_setima_extincao_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_contract_breach).
...
legal_relation_instance(clausula_decima_setima_extincao_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, dissolve_contract).
legal_relation_instance(clausula_decima_oitava_disposicoes_finais, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, exercise_rights).
legal_relation_instance(clausula_decima_oitava_disposicoes_finais, no_right_to_omission, banco_nacional_de_desenvolvimento_economico_e_social_bndes, waive_contractual_compliance).
legal_relation_instance(clausula_decima_oitava_disposicoes_finais, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, comply_with_contract).
legal_relation_instance(clausula_decima_oitava_disposicoes_finais, power, unknown, interpret_contract).
legal_relation_instance(clausula_decima_nona_foro, power, unknown, establish_jurisdiction).
legal_relation_instance(clausula_decima_nona_foro, no_right_to_action, unknown, litigate_outside_rio).
legal_relation_instance(clausula_nona_matriz_riscos, no_right_to_action, sap_brasil_ltda, request_additives_for_allocated_risks).
legal_relation_instance(clausula_nona_matriz_riscos, no_right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, request_additives_for_allocated_risks_bndes).
legal_relation_instance(clausula_nona_matriz_riscos, duty_to_act, sap_brasil_ltda, respect_economic_financial_balance).
legal_relation_instance(clausula_nona_matriz_riscos, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, respect_economic_financial_balance_bndes).
...
action_type(allow_access_to_bc).
action_label(allow_access_to_bc, 'Allow access to BC').
...
action_type(apply_interest).
action_label(apply_interest, 'Apply interest').
action_type(apply_penalties).
action_label(apply_penalties, 'Apply penalties').
action_type(be_subject_to_contract_termination).
action_label(be_subject_to_contract_termination, 'Subject to contract termination').
action_type(be_subject_to_penalties).
action_label(be_subject_to_penalties, 'Be subject to penalties').
action_type(be_subject_to_penalties_for_refusal).
action_label(be_subject_to_penalties_for_refusal, 'Subject to penalties for refusal').
...
action_label(communicate_administrative_proceeding, 'Communicate proceeding').
...
action_type(compensate_damages_for_unjustified_refusal).
action_label(compensate_damages_for_unjustified_refusal, 'Subject to compensate damages').
...
action_type(convocar_a_contratada_para_negociar_reducao_de_precos).
action_label(convocar_a_contratada_para_negociar_reducao_de_precos, 'Call for price reduction negotiation').
action_type(deduct_from_credits).
action_label(deduct_from_credits, 'Deduct from credits').
action_type(deliver_property_to_bndes).
action_label(deliver_property_to_bndes, 'Deliver property to BNDES').
action_type(demand_contract_alteration).
action_label(demand_contract_alteration, 'Demand alteration if essential').
...
action_type(devolver_documento_fiscal).
action_label(devolver_documento_fiscal, 'Return invoice').
action_type(dissolve_contract).
action_label(dissolve_contract, 'Dissolve the contract').
action_type(efetuar_pagamento).
action_label(efetuar_pagamento, 'Make payment').
action_type(encaminhar_documento_fiscal).
action_label(encaminhar_documento_fiscal, 'Send invoice').
action_type(ensure_lgpd_compliance).
action_label(ensure_lgpd_compliance, 'Ensure LGPD compliance').
action_type(ensure_no_family_allocation).
action_label(ensure_no_family_allocation, 'Ensure no family allocation').
action_type(ensure_security_standards).
action_label(ensure_security_standards, 'Ensure security standards').
...
action_type(execute_service_per_specifications).
action_label(execute_service_per_specifications, 'Execute service as specified').
action_type(exercise_rights).
action_label(exercise_rights, 'Exercise rights').
action_type(expect_service_per_specifications).
action_label(expect_service_per_specifications, 'Expect service as specified').
action_type(extinguish_contract).
action_label(extinguish_contract, 'Extinguish contract').
action_type(formalize_essential_alteration).
action_label(formalize_essential_alteration, 'Formalize essential alteration').
action_type(guarantee_ip_rights).
action_label(guarantee_ip_rights, 'Guarantee IP rights').
action_type(inform_bndes_violation).
action_label(inform_bndes_violation, 'Inform BNDES of violation').
action_type(interpret_contract).
action_label(interpret_contract, 'Interpret contract').
action_type(issuance_of_credit_title).
action_label(issuance_of_credit_title, 'No right to issue credit title').
...
action_label(maintain_qualification, 'Maintain qualifications').
...
action_label(not_use_confidential_information, 'Do not use confidential info').
...
action_type(omit_communicate_intent_not_to_renew).
action_label(omit_communicate_intent_not_to_renew, 'Omit communicating intent not to renew.').
...
action_type(omit_payment_before_invoice).
action_label(omit_payment_before_invoice, 'Omit payment before invoice').
action_type(omit_payment_with_divergencies).
action_label(omit_payment_with_divergencies, 'Omit payment with invoice errors').
...
action_type(present_revision_request_with_evidence).
action_label(present_revision_request_with_evidence, 'Present revision request with evidence').
action_type(prevent_favorecimento).
action_label(prevent_favorecimento, 'Prevent favorecimento').
...
action_type(prove_exclusion_simples).
action_label(prove_exclusion_simples, 'Prove Simples exclusion').
action_type(provide_info_on_ethics_policy).
action_label(provide_info_on_ethics_policy, 'Provide ethics policy').
action_type(provide_necessary_info).
action_label(provide_necessary_info, 'Provide necessary info').
action_type(provide_sap_idm_licenses).
action_label(provide_sap_idm_licenses, 'Provide SAP IdM licenses').
action_type(provide_technical_support).
action_label(provide_technical_support, 'Provide technical support').
action_type(receive_document_fiscal).
action_label(receive_document_fiscal, 'Receive invoice').
...
action_type(receive_sap_idm_licenses).
action_label(receive_sap_idm_licenses, 'Receive SAP IdM licenses').
action_type(receive_technical_support).
action_label(receive_technical_support, 'Receive technical support').
action_type(refuse_essential_alteration).
action_label(refuse_essential_alteration, 'No right to refuse alteration').
action_type(refuse_essential_alteration_without_just_cause).
action_label(refuse_essential_alteration_without_just_cause, 'Do not refuse alteration without cause').
...
action_type(request_additives_for_allocated_risks_bndes).
action_label(request_additives_for_allocated_risks_bndes, 'No right to request additives for allocated risks').
...
action_type(request_reajuste_revisao_ate_prorrogacao_encerramento).
action_label(request_reajuste_revisao_ate_prorrogacao_encerramento, 'Request price adjustment/revision before termination').
...
action_type(respect_economic_financial_balance_bndes).
action_label(respect_economic_financial_balance_bndes, 'Respect economic-financial balance clause').
...
action_label(right_to_defend, 'Right to defend oneself').
...
action_type(suffer_consequences_of_noncompliance).
action_label(suffer_consequences_of_noncompliance, 'Suffer consequences of non-compliance').
...
action_type(take_measures_to_prevent).
action_label(take_measures_to_prevent, 'Take measures to prevent').
action_type(terminate_contract).
action_label(terminate_contract, 'Terminate contract').
action_type(terminate_contract_breach).
action_label(terminate_contract_breach, 'Terminate contract for breach').
action_type(undergo_risk_analysis).
action_label(undergo_risk_analysis, 'Undergo risk analysis').
...
action_type(waive_contractual_compliance).
action_label(waive_contractual_compliance, 'Waive contract compliance').

% ===== 3) Original Contract ABox =====
contract(contrato_ocs_0044_2022).
contract_metadata(contrato_ocs_0044_2022, numero_ocs, '0044/2022').
contract_metadata(contrato_ocs_0044_2022, numero_sap, '4400004971').
contract_metadata(contrato_ocs_0044_2022, tipo_contrato, 'CONTRATO DE AQUISIÇÃO DE LICENÇA DE USO DE SOFTWARE E PRESTAÇÃO DE SERVIÇOS').
contract_metadata(contrato_ocs_0044_2022, contratante, 'BANCO NACIONAL DE DESENVOLVIMENTO ECONÔMICO E SOCIAL – BNDES').
contract_metadata(contrato_ocs_0044_2022, contratado, 'SAP BRASIL LTDA').
contract_metadata(contrato_ocs_0044_2022, cnpj_contratante, '33.657.248/0001-89').
contract_metadata(contrato_ocs_0044_2022, cnpj_contratado, '74.544.297/0001-92').
contract_metadata(contrato_ocs_0044_2022, procedimento_licitatorio, 'Inexigibilidade de Licitação nº 06/2022').
contract_metadata(contrato_ocs_0044_2022, data_autorizacao, '25/02/2022').
contract_metadata_raw(contrato_ocs_0044_2022, 'ip_aic_deroc', '002/2022', 'trecho_literal').
contract_metadata_raw(contrato_ocs_0044_2022, 'data_ip_aic_deroc', '02/02/2022', 'trecho_literal').
contract_metadata(contrato_ocs_0044_2022, rubrica_orcamentaria, '3101700021').
contract_metadata(contrato_ocs_0044_2022, centro_custo, 'BN00004000').
contract_metadata(contrato_ocs_0044_2022, centro_custo, 'BN30010000').
contract_metadata(contrato_ocs_0044_2022, lei_aplicavel, 'Lei nº 13.303/2016').
contract_metadata(contrato_ocs_0044_2022, regulamento, 'Regulamento de Formalização, Execução e Fiscalização dos Contratos Administrativos do Sistema BNDES').
contract_clause(contrato_ocs_0044_2022, clausula_primeira_objeto, 'CLÁUSULA PRIMEIRA – OBJETO', 'O presente Contrato tem por objeto a aquisição de licenças do pacote de conectores desenvolvidos pela SAP para o produto SAP Identity Management (SAP IdM) e a prestação do serviço de suporte técnico SAP Enterprise Suppor prestação continuada de serviço de suporte SAP Enterprise Support, conforme especificações constantes do Projeto Básico e também da Proposta, e respectivos anexos apresentados pela CONTRATADA, respectivamente, Anexos I e II deste Contrato.').
contract_clause(contrato_ocs_0044_2022, clausula_segunda_vigencia, 'CLÁUSULA SEGUNDA – VIGÊNCIA', 'O presente Contrato terá duração de 24 (vinte e quatro) meses, a contar da data de sua assinatura, podendo ser prorrogado, por períodos sucessivos, até o limite total de 60 (sessenta) meses. Parágrafo Primeiro Até 90 (noventa) dias antes do término de cada período de vigência contratual, cabe à CONTRATADA comunicar ao Gestor do Contrato, por escrito, o seu propósito de não prorrogar a vigência por um novo período, sob pena de se presumir a sua anuência em celebrar o aditivo de prorrogação, nas mesmas condições então vigentes.  Parágrafo Segundo Caso a CONTRATADA se recuse a celebrar aditivo contratual de prorrogação, tendo antes manifestado sua intenção de prorrogar o Contrato ou deixado de manifestar seu propósito de não prorrogar, nos termos do Parágrafo Primeiro desta Cláusula, ficará sujeita às penalidades previstas na Cláusula de Penalidades deste Contrato.').

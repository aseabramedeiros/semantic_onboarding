% ===== KOA Combined Output | contract_id: contrato_ocs_046_2024 =====
...
% UFO-only grounding generated from: KOA_Contrato_OCS_046_2024_-_SENSEDIA_S.pl
% contract_id: contrato_ocs_046_2024

instance_of(contrato_ocs_046_2024, legal_service_agreement).

instance_of(banco_nacional_de_desenvolvimento_economico_e_social_bndes, agent).
instance_of(sensedia_s_a, agent).

plays_role(banco_nacional_de_desenvolvimento_economico_e_social_bndes, service_customer_role, contrato_ocs_046_2024).
plays_role(sensedia_s_a, hired_service_provider_role, contrato_ocs_046_2024).

clause_of(clausula_primeira_objeto, contrato_ocs_046_2024).
clause_of(clausula_segunda_vigencia, contrato_ocs_046_2024).
clause_of(clausula_terceira_local_prazo_condicoes_execucao_objeto, contrato_ocs_046_2024).
clause_of(clausula_quarta_niveis_servico, contrato_ocs_046_2024).
clause_of(clausula_quinta_recebimento_objeto, contrato_ocs_046_2024).
clause_of(clausula_sexta_preco, contrato_ocs_046_2024).
clause_of(clausula_setima_pagamento, contrato_ocs_046_2024).
clause_of(clausula_oitava_equilibrio_economico_financeiro_contrato, contrato_ocs_046_2024).
clause_of(clausula_decima_garantia_contratual, contrato_ocs_046_2024).
clause_of(clausula_decima_primeira_obrigações_contratado, contrato_ocs_046_2024).
clause_of(clausula_decima_segunda_conduta_etica_do_contratado_e_do_bndes, contrato_ocs_046_2024).
clause_of(clausula_decima_terceira_sigilo_das_informações, contrato_ocs_046_2024).
clause_of(clausula_decima_quarta_acesso_protecao_dados_pessoais, contrato_ocs_046_2024).
clause_of(clausula_decima_quinta_obrigacoes_bndes, contrato_ocs_046_2024).
clause_of(clausula_decima_sexta_equidade_genero_valorizacao_diversidade, contrato_ocs_046_2024).
clause_of(clausula_decima_setima_cessao_contrato_credito_sucessao_contratual_subcontratacao, contrato_ocs_046_2024).
clause_of(clausula_decima_oitava_penalidades, contrato_ocs_046_2024).
clause_of(clausula_decima_nona_alteracoes_contratuais, contrato_ocs_046_2024).
clause_of(clausula_vigésima_extincao_contrato, contrato_ocs_046_2024).
clause_of(clausula_vigésima_primeira_disposicoes_finais, contrato_ocs_046_2024).
clause_of(clausula_vigésima_segunda_foro, contrato_ocs_046_2024).
clause_of(clausula_nona_matriz_riscos, contrato_ocs_046_2024).

legal_relation_instance(clausula_primeira_objeto, duty_to_act, sensedia_s_a, provide_cloud_services).
legal_relation_instance(clausula_primeira_objeto, right_to_action, sensedia_s_a, provide_cloud_services).
legal_relation_instance(clausula_primeira_objeto, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, receive_cloud_services).
legal_relation_instance(clausula_segunda_vigencia, duty_to_act, sensedia_s_a, present_manifestation_on_contract_extension).
legal_relation_instance(clausula_segunda_vigencia, duty_to_act, sensedia_s_a, communicate_interest_regarding_contract_extension).
legal_relation_instance(clausula_segunda_vigencia, subjection, sensedia_s_a, be_subject_to_penalties).
legal_relation_instance(clausula_terceira_local_prazo_condicoes_execucao_objeto, duty_to_act, sensedia_s_a, execute_contract_object).
legal_relation_instance(clausula_terceira_local_prazo_condicoes_execucao_objeto, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, require_contract_object_execution).
legal_relation_instance(clausula_quarta_niveis_servico, duty_to_act, sensedia_s_a, execute_services_according_to_standards).
...
legal_relation_instance(clausula_quarta_niveis_servico, subjection, sensedia_s_a, be_subject_to_price_reductions).
legal_relation_instance(clausula_quarta_niveis_servico, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, demand_services_meet_standards).
...
legal_relation_instance(clausula_quarta_niveis_servico, subjection, sensedia_s_a, be_subject_to_penalties).
...
legal_relation_instance(clausula_quinta_recebimento_objeto, duty_to_act, unknown, observar_disposto_anexo_i).
...
legal_relation_instance(clausula_quinta_recebimento_objeto, right_to_action, unknown, observar_disposto_anexo_i).
legal_relation_instance(clausula_sexta_preco, no_right_to_action, sensedia_s_a, demand_indemnification).
legal_relation_instance(clausula_sexta_preco, duty_to_act, sensedia_s_a, bear_errors_in_quantification).
legal_relation_instance(clausula_sexta_preco, right_to_action, sensedia_s_a, receive_payment).
...
legal_relation_instance(clausula_sexta_preco, subjection, sensedia_s_a, price_reduction_for_partial_execution).
legal_relation_instance(clausula_sexta_preco, duty_to_act, sensedia_s_a, execute_contract_object).
...
legal_relation_instance(clausula_setima_pagamento, duty_to_act, sensedia_s_a, present_fiscal_document).
legal_relation_instance(clausula_setima_pagamento, duty_to_act, sensedia_s_a, provide_supporting_documents).
legal_relation_instance(clausula_setima_pagamento, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, reject_document_presented_out_of_time).
...
legal_relation_instance(clausula_setima_pagamento, right_to_action, sensedia_s_a, receive_payment).
legal_relation_instance(clausula_setima_pagamento, duty_to_omit, sensedia_s_a, omit_presenting_noncompliant_document).
...
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, right_to_action, sensedia_s_a, request_price_revision).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, right_to_action, sensedia_s_a, request_price_readjustment).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, sensedia_s_a, present_information_requested_by_bndes).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, sensedia_s_a, request_readjustment_revision_before_end).
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, sensedia_s_a, provide_contractual_guarantee).
...
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, sensedia_s_a, obtain_guarantor_consent).
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, sensedia_s_a, notify_guarantor_extension).
legal_relation_instance(clausula_decima_garantia_contratual, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, extend_presentation_period).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, sensedia_s_a, maintain_conditions_of_qualification).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, sensedia_s_a, communicate_penalty).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, sensedia_s_a, repair_correct_remove_reconstruct_or_substitute).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, sensedia_s_a, repair_damages_and_losses).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, sensedia_s_a, pay_taxes_and_fees).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, sensedia_s_a, assume_responsibility_for_charges).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, sensedia_s_a, prove_exclusion_from_simples_nacional).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, sensedia_s_a, allow_inspections).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, sensedia_s_a, obey_instructions_and_procedures).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, sensedia_s_a, designate_representative).
legal_relation_instance(clausula_decima_segunda_conduta_etica_do_contratado_e_do_bndes, duty_to_act, sensedia_s_a, maintain_integrity_public_private_relations).
legal_relation_instance(clausula_decima_segunda_conduta_etica_do_contratado_e_do_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, maintain_integrity_public_private_relations_bndes).
legal_relation_instance(clausula_decima_segunda_conduta_etica_do_contratado_e_do_bndes, duty_to_omit, sensedia_s_a, not_offer_undue_advantage).
legal_relation_instance(clausula_decima_segunda_conduta_etica_do_contratado_e_do_bndes, duty_to_omit, sensedia_s_a, prevent_favored_participation).
legal_relation_instance(clausula_decima_segunda_conduta_etica_do_contratado_e_do_bndes, duty_to_omit, sensedia_s_a, prevent_allocation_of_relatives).
legal_relation_instance(clausula_decima_segunda_conduta_etica_do_contratado_e_do_bndes, duty_to_act, sensedia_s_a, observe_bndes_policies).
legal_relation_instance(clausula_decima_segunda_conduta_etica_do_contratado_e_do_bndes, duty_to_act, sensedia_s_a, report_conflict_of_interest).
legal_relation_instance(clausula_decima_segunda_conduta_etica_do_contratado_e_do_bndes, duty_to_act, sensedia_s_a, notify_investigations).
legal_relation_instance(clausula_decima_segunda_conduta_etica_do_contratado_e_do_bndes, duty_to_act, sensedia_s_a, remove_agents_implying_impediments).
legal_relation_instance(clausula_decima_segunda_conduta_etica_do_contratado_e_do_bndes, duty_to_act, sensedia_s_a, prevent_corruption).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, sensedia_s_a, comply_with_bndes_security_policy).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_omit, sensedia_s_a, not_access_confidential_info).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, sensedia_s_a, maintain_confidentiality).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, sensedia_s_a, limit_access_to_information).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, sensedia_s_a, inform_violation_of_secrecy_rules).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, sensedia_s_a, deliver_material_to_bndes).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, sensedia_s_a, present_confidentiality_terms).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, sensedia_s_a, observe_terms_of_confidentiality).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, permission_to_act, sensedia_s_a, access_confidential_info).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, enforce_security_policy).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, protect_freedom_privacy).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, sensedia_s_a, obtain_consent).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, sensedia_s_a, follow_bndes_instructions).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, sensedia_s_a, maintain_confidentiality).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, sensedia_s_a, store_data_securely).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, sensedia_s_a, provide_formal_knowledge).
...
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, sensedia_s_a, provide_data_access).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, sensedia_s_a, inform_bndes_of_requests).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, sensedia_s_a, maintain_data_operation_records).
...
legal_relation_instance(clausula_decima_quinta_obrigacoes_bndes, right_to_action, sensedia_s_a, receive_payments).
...
legal_relation_instance(clausula_decima_quinta_obrigacoes_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, provide_contract_access_to_ethics_code).
legal_relation_instance(clausula_decima_quinta_obrigacoes_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, provide_information_for_service_execution).
legal_relation_instance(clausula_decima_quinta_obrigacoes_bndes, right_to_action, sensedia_s_a, request_information_for_service_execution).
...
legal_relation_instance(clausula_decima_quinta_obrigacoes_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, communicate_administrative_procedure_opening).
legal_relation_instance(clausula_decima_quinta_obrigacoes_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, communicate_application_of_penalty).
legal_relation_instance(clausula_decima_sexta_equidade_genero_valorizacao_diversidade, duty_to_act, sensedia_s_a, prove_no_discriminatory_practices).
legal_relation_instance(clausula_decima_sexta_equidade_genero_valorizacao_diversidade, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, request_proof_of_no_discriminatory_practices).
...
legal_relation_instance(clausula_decima_sexta_equidade_genero_valorizacao_diversidade, duty_to_omit, banco_nacional_de_desenvolvimento_economico_e_social_bndes, omit_contract_suspension).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_contratual_subcontratacao, no_right_to_action, sensedia_s_a, assign_contract_or_credit).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_contratual_subcontratacao, no_right_to_action, sensedia_s_a, issue_credit_title).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_contratual_subcontratacao, duty_to_act, sensedia_s_a, execute_contract).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_contratual_subcontratacao, right_to_action, sensedia_s_a, receive_credit).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_contratual_subcontratacao, no_right_to_action, sensedia_s_a, subcontract_execution).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_contratual_subcontratacao, duty_to_act, sensedia_s_a, maintain_contract_conditions).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_contratual_subcontratacao, permission_to_act, sensedia_s_a, corporate_restructuring).
legal_relation_instance(clausula_decima_oitava_penalidades, subjection, sensedia_s_a, be_subject_to_penalties).
...
legal_relation_instance(clausula_decima_oitava_penalidades, right_to_action, sensedia_s_a, request_reconsideration).
legal_relation_instance(clausula_decima_oitava_penalidades, right_to_action, sensedia_s_a, interpose_recourse).
...
legal_relation_instance(clausula_decima_oitava_penalidades, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, charge_judicially).
...
legal_relation_instance(clausula_decima_nona_alteracoes_contratuais, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, formalize_alteration).
legal_relation_instance(clausula_decima_nona_alteracoes_contratuais, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, compensate_damages).
legal_relation_instance(clausula_decima_nona_alteracoes_contratuais, subjection, banco_nacional_de_desenvolvimento_economico_e_social_bndes, compensate_damages_subjection).
legal_relation_instance(clausula_decima_nona_alteracoes_contratuais, no_right_to_omission, banco_nacional_de_desenvolvimento_economico_e_social_bndes, omit_formalization).
legal_relation_instance(clausula_vigésima_extincao_contrato, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, provide_written_notice_prior_termination).
legal_relation_instance(clausula_vigésima_extincao_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, rescind_contract_due_failure_to_release).
legal_relation_instance(clausula_vigésima_extincao_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, suspend_contract_execution).
legal_relation_instance(clausula_vigésima_extincao_contrato, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_contract_due_breach).
legal_relation_instance(clausula_vigésima_extincao_contrato, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, notify_other_party_of_breach).
legal_relation_instance(clausula_vigésima_extincao_contrato, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_contract_due_force_majeure).
legal_relation_instance(clausula_vigésima_primeira_disposicoes_finais, no_right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, waiver_through_omission).
...
legal_relation_instance(clausula_vigésima_segunda_foro, power, unknown, establish_jurisdiction).
legal_relation_instance(clausula_vigésima_segunda_foro, no_right_to_action, unknown, litigate_elsewhere).
legal_relation_instance(clausula_nona_matriz_riscos, duty_to_omit, sensedia_s_a, omit_celebration_of_additives).
legal_relation_instance(clausula_nona_matriz_riscos, no_right_to_action, sensedia_s_a, right_to_celebrate_additives).

% --- Action catalog (local to this contract grounding) ---
action_type(access_confidential_info).
action_label(access_confidential_info, 'Access confidential info if authorized').
action_type(adopt_environmental_practices).
action_label(adopt_environmental_practices, 'Adopt environmental sustainability practices').
...
action_label(apply_price_reduction_indexes, 'Apply price reductions').
...
action_label(be_subject_to_penalties, 'Subject to penalties for refusal').
...
action_label(bear_errors_in_quantification, 'Bear cost of quantification errors').
...
action_label(communicate_application_of_penalty, 'Communicate penalty application').
...
action_type(communicate_interest_regarding_contract_extension).
action_label(communicate_interest_regarding_contract_extension, 'Communicate interest on extension').
...
action_type(compensate_damages_subjection).
action_label(compensate_damages_subjection, 'Be subjected to damages').
...
action_label(corporate_restructuring, 'Permission for corporate restructuring').
...
action_label(demand_indemnification, 'No right to indemnification').
action_type(demand_services_meet_standards).
action_label(demand_services_meet_standards, 'Demand services meet standards').
...
action_type(enforce_security_policy).
action_label(enforce_security_policy, 'Enforce security policy').
...
action_label(exercise_contractual_rights, 'Right to exercise rights').
action_type(extend_presentation_period).
action_label(extend_presentation_period, 'Extend presentation period').
...
action_type(inform_violation_of_secrecy_rules).
action_label(inform_violation_of_secrecy_rules, 'Inform violation of secrecy rules').
...
action_label(litigate_elsewhere, 'No litigation elsewhere').
...
action_type(notify_guarantor_extension).
action_label(notify_guarantor_extension, 'Notify guarantor of extension').
action_type(notify_investigations).
action_label(notify_investigations, 'Notify investigations of anticorruption violations').
action_type(notify_other_party_of_breach).
action_label(notify_other_party_of_breach, 'Notify of breach').
...
action_type(observar_disposto_anexo_i).
action_label(observar_disposto_anexo_i, 'Observe Attachment I').
action_type(observe_bndes_policies).
action_label(observe_bndes_policies, 'Observe BNDES ethics policies').
...
action_type(omit_contract_suspension).
action_label(omit_contract_suspension, 'Omit contract suspension').
action_type(omit_formalization).
action_label(omit_formalization, 'Omit formalization').
action_type(omit_presenting_noncompliant_document).
action_label(omit_presenting_noncompliant_document, 'Omit presenting noncompliant document').
...
action_label(present_manifestation_on_contract_extension, 'Present manifestation on extension').
action_type(prevent_allocation_of_relatives).
action_label(prevent_allocation_of_relatives, 'Prevent allocation of relatives in service execution').
action_type(prevent_corruption).
action_label(prevent_corruption, 'Prevent corruption by others').
action_type(prevent_favored_participation).
action_label(prevent_favored_participation, 'Prevent favored participation by BNDES employees').
action_type(price_reduction_for_partial_execution).
action_label(price_reduction_for_partial_execution, 'Subject to price reduction').
action_type(protect_freedom_privacy).
action_label(protect_freedom_privacy, 'Protect freedom and privacy').
...
action_type(provide_cloud_services).
action_label(provide_cloud_services, 'Provide cloud services').
action_type(provide_contract_access_to_ethics_code).
action_label(provide_contract_access_to_ethics_code, 'Provide access to ethics code').
...
action_type(provide_formal_knowledge).
action_label(provide_formal_knowledge, 'Provide formal knowledge').
...
action_type(provide_written_notice_prior_termination).
action_label(provide_written_notice_prior_termination, 'Provide written notice').
action_type(receive_cloud_services).
action_label(receive_cloud_services, 'Right to receive services').
action_type(receive_credit).
action_label(receive_credit, 'Right to receive credit').
...
action_type(reject_document_presented_out_of_time).
action_label(reject_document_presented_out_of_time, 'Reject out-of-time document').
action_type(remove_agents_implying_impediments).
action_label(remove_agents_implying_impediments, 'Remove agents causing impediments').
action_type(repair_correct_remove_reconstruct_or_substitute).
action_label(repair_correct_remove_reconstruct_or_substitute, 'Repair, correct, remove, or substitute').
...
action_type(request_readjustment_revision_before_end).
action_label(request_readjustment_revision_before_end, 'Request readjustment/revision before end').
action_type(request_reconsideration).
action_label(request_reconsideration, 'Request reconsideration').
action_type(require_contract_object_execution).
action_label(require_contract_object_execution, 'Require contract object execution').
action_type(rescind_contract_due_failure_to_release).
action_label(rescind_contract_due_failure_to_release, 'Rescind due to failure to release').
...
action_type(right_to_celebrate_additives).
action_label(right_to_celebrate_additives, 'No right to celebrate additives').

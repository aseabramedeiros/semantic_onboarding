% ===== KOA Combined Output | contract_id: contrato_ocs_0011_2022 =====
...
% UFO-only grounding generated from: KOA_Contrato_OCS_011_2022_-_Zoom_(Storage_Huawei).pl
% contract_id: contrato_ocs_0011_2022

instance_of(contrato_ocs_0011_2022, legal_service_agreement).

instance_of(banco_nacional_de_1desenvolvimento_economico_e_social_bndes, agent).
instance_of(zoom_tecnologia_ltda, agent).

plays_role(banco_nacional_de_1desenvolvimento_economico_e_social_bndes, service_customer_role, contrato_ocs_0011_2022).
plays_role(zoom_tecnologia_ltda, hired_service_provider_role, contrato_ocs_0011_2022).

clause_of(clausula_primeira_objeto, contrato_ocs_0011_2022).
clause_of(clausula_segunda_vigencia, contrato_ocs_0011_2022).
clause_of(clausula_terceira_local_prazo_condicoes_execucao_objeto, contrato_ocs_0011_2022).
clause_of(clausula_quarta_niveis_servico, contrato_ocs_0011_2022).
clause_of(clausula_quinta_recebimento_objeto, contrato_ocs_0011_2022).
clause_of(clausula_sexta_preco, contrato_ocs_0011_2022).
clause_of(clausula_oitava_equilibrio_economico_financeiro_contrato, contrato_ocs_0011_2022).
clause_of(clausula_decima_garantia_contratual, contrato_ocs_0011_2022).
clause_of(clausula_decima_primeira_obrigacoes_contratado, contrato_ocs_0011_2022).
clause_of(clausula_decima_segunda_conduta_etica_contratado_bndes, contrato_ocs_0011_2022).
clause_of(clausula_decima_terceira_sigilo_informacoes, contrato_ocs_0011_2022).
clause_of(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, contrato_ocs_0011_2022).
clause_of(clausula_decima_quinta_obrigações_do_bndes, contrato_ocs_0011_2022).
clause_of(clausula_decima_sexta_cessão_de_contrato_ou_de_crédito_sucessão_contratual_e_subcontratação, contrato_ocs_0011_2022).
clause_of(clausula_decima_setima_penalidades, contrato_ocs_0011_2022).
clause_of(clausula_decima_oitava_alteracoes_contratuais, contrato_ocs_0011_2022).
clause_of(clausula_decima_nona_extincao_contrato, contrato_ocs_0011_2022).
clause_of(clausula_vigesima_divulgacao_dados_pessoais, contrato_ocs_0011_2022).
clause_of(clausula_vigesima_primeira_disposicoes_finais, contrato_ocs_0011_2022).
clause_of(clausula_vigesima_segunda_foro, contrato_ocs_0011_2022).
clause_of(clausula_setima_pagamento, contrato_ocs_0011_2022).
clause_of(clausula_nona_matriz_riscos, contrato_ocs_0011_2022).

legal_relation_instance(clausula_primeira_objeto, duty_to_act, zoom_tecnologia_ltda, provide_data_storage_solution).
legal_relation_instance(clausula_primeira_objeto, right_to_action, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, receive_data_storage_solution).
legal_relation_instance(clausula_primeira_objeto, duty_to_act, zoom_tecnologia_ltda, provide_software_licenses).
legal_relation_instance(clausula_primeira_objeto, duty_to_act, zoom_tecnologia_ltda, provide_related_services).
legal_relation_instance(clausula_primeira_objeto, right_to_action, zoom_tecnologia_ltda, receive_payment_for_data_storage_solution).
legal_relation_instance(clausula_segunda_vigencia, power, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, set_contract_duration).
legal_relation_instance(clausula_segunda_vigencia, power, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, set_contract_duration_data_center).
legal_relation_instance(clausula_segunda_vigencia, power, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, set_contract_duration_secondary_data_center).
legal_relation_instance(clausula_terceira_local_prazo_condicoes_execucao_objeto, duty_to_act, zoom_tecnologia_ltda, execute_contract_subject).
legal_relation_instance(clausula_terceira_local_prazo_condicoes_execucao_objeto, right_to_action, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, require_execution_according_to_specifications).
...
legal_relation_instance(clausula_quarta_niveis_servico, right_to_action, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, apply_price_reduction_due_to_non_compliance).
legal_relation_instance(clausula_quarta_niveis_servico, right_to_action, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, demand_services_according_to_standards).
legal_relation_instance(clausula_quarta_niveis_servico, duty_to_omit, zoom_tecnologia_ltda, violate_service_levels).
legal_relation_instance(clausula_quarta_niveis_servico, power, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, impose_penalties_for_non_compliance).
legal_relation_instance(clausula_quarta_niveis_servico, subjection, zoom_tecnologia_ltda, be_subject_to_penalties_for_non_compliance).
legal_relation_instance(clausula_quinta_recebimento_objeto, duty_to_act, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, effect_receipt_of_object).
legal_relation_instance(clausula_quinta_recebimento_objeto, power, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, effect_receipt_of_object_through_manager).
legal_relation_instance(clausula_quinta_recebimento_objeto, right_to_action, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, effect_receipt_of_object).
legal_relation_instance(clausula_sexta_preco, duty_to_act, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, pay_contracted_party).
legal_relation_instance(clausula_sexta_preco, right_to_action, zoom_tecnologia_ltda, receive_payment).
legal_relation_instance(clausula_sexta_preco, no_right_to_action, zoom_tecnologia_ltda, demand_compensation).
legal_relation_instance(clausula_sexta_preco, duty_to_act, zoom_tecnologia_ltda, bear_burden_of_errors).
legal_relation_instance(clausula_sexta_preco, power, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, reduce_payment_proportionally).
legal_relation_instance(clausula_sexta_preco, subjection, zoom_tecnologia_ltda, accept_reduced_payment).
...
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, right_to_action, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, request_price_review).
...
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, analyze_price_adjustment_request).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, no_right_to_action, zoom_tecnologia_ltda, request_price_adjust_after_deadline).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, zoom_tecnologia_ltda, request_price_adjustment_before_contract_end).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, zoom_tecnologia_ltda, present_price_reduction_information).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, right_to_action, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, call_for_price_reduction_negotiation).
...
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, zoom_tecnologia_ltda, obtain_new_guarantee).
legal_relation_instance(clausula_decima_garantia_contratual, right_to_action, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, apply_penalty).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, zoom_tecnologia_ltda, maintain_conditions_of_habilitation).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, zoom_tecnologia_ltda, communicate_imposition_of_penalty).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, zoom_tecnologia_ltda, repair_correct_remove_reconstruct_or_replace).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, zoom_tecnologia_ltda, repair_damages_to_bndes_or_third_parties).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, zoom_tecnologia_ltda, pay_taxes_and_fees).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, zoom_tecnologia_ltda, assume_full_responsibility_for_burdens).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, zoom_tecnologia_ltda, prove_exclusion_from_simples_nacional).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, zoom_tecnologia_ltda, allow_inspections).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, zoom_tecnologia_ltda, obey_instructions_and_procedures).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, zoom_tecnologia_ltda, appoint_representative).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, zoom_tecnologia_ltda, maintain_integrity).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, maintain_integrity).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_omit, zoom_tecnologia_ltda, offer_undue_advantage).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, zoom_tecnologia_ltda, prevent_favored_participation).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, zoom_tecnologia_ltda, allocate_non_related_persons).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, zoom_tecnologia_ltda, observe_system_policies).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, zoom_tecnologia_ltda, adopt_sustainable_practices).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, zoom_tecnologia_ltda, comply_with_bndes_security_policy).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_omit, zoom_tecnologia_ltda, not_access_confidential_info).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, zoom_tecnologia_ltda, keep_info_confidential).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, zoom_tecnologia_ltda, limit_info_access).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, zoom_tecnologia_ltda, inform_bndes_of_violations).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, zoom_tecnologia_ltda, return_materials_to_bndes).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_omit, zoom_tecnologia_ltda, not_use_confidential_info).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, zoom_tecnologia_ltda, present_confidentiality_terms).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, zoom_tecnologia_ltda, observe_confidentiality_term).
legal_relation_instance(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, duty_to_act, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, adopt_security_measures).
legal_relation_instance(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, duty_to_act, zoom_tecnologia_ltda, eliminate_personal_data).
legal_relation_instance(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, duty_to_omit, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, not_share_data_without_authorization).
legal_relation_instance(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, duty_to_act, zoom_tecnologia_ltda, maintain_data_confidentiality).
legal_relation_instance(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, right_to_action, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, right_of_recourse).
legal_relation_instance(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, duty_to_act, zoom_tecnologia_ltda, provide_data_access_channel).
legal_relation_instance(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, right_to_action, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, receive_info_from_contracted_party).
legal_relation_instance(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, duty_to_act, zoom_tecnologia_ltda, inform_bndes_of_data_requests).
legal_relation_instance(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, power, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, approve_data_collection).
legal_relation_instance(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, permission_to_omit, zoom_tecnologia_ltda, permission_not_to_delete).
legal_relation_instance(clausula_decima_quinta_obrigações_do_bndes, duty_to_act, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, make_payments).
legal_relation_instance(clausula_decima_quinta_obrigações_do_bndes, right_to_action, zoom_tecnologia_ltda, receive_payments).
legal_relation_instance(clausula_decima_quinta_obrigações_do_bndes, duty_to_act, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, designate_contract_manager).
legal_relation_instance(clausula_decima_quinta_obrigações_do_bndes, duty_to_act, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, designate_substitute_contract_manager).
legal_relation_instance(clausula_decima_quinta_obrigações_do_bndes, duty_to_act, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, designate_receiving_committee).
legal_relation_instance(clausula_decima_quinta_obrigações_do_bndes, duty_to_act, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, provide_code_of_ethics).
legal_relation_instance(clausula_decima_quinta_obrigações_do_bndes, duty_to_act, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, provide_information_for_service_execution).
legal_relation_instance(clausula_decima_quinta_obrigações_do_bndes, duty_to_act, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, communicate_instructions).
legal_relation_instance(clausula_decima_quinta_obrigações_do_bndes, duty_to_act, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, communicate_investigation).
legal_relation_instance(clausula_decima_quinta_obrigações_do_bndes, duty_to_act, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, communicate_penalty).
legal_relation_instance(clausula_decima_sexta_cessão_de_contrato_ou_de_crédito_sucessão_contratual_e_subcontratação, no_right_to_action, zoom_tecnologia_ltda, assign_contract_or_credit).
legal_relation_instance(clausula_decima_sexta_cessão_de_contrato_ou_de_crédito_sucessão_contratual_e_subcontratação, no_right_to_action, zoom_tecnologia_ltda, issue_credit_title).
legal_relation_instance(clausula_decima_sexta_cessão_de_contrato_ou_de_crédito_sucessão_contratual_e_subcontratação, duty_to_act, zoom_tecnologia_ltda, maintain_contractual_conditions).
legal_relation_instance(clausula_decima_sexta_cessão_de_contrato_ou_de_crédito_sucessão_contratual_e_subcontratação, duty_to_act, zoom_tecnologia_ltda, present_supporting_documents).
legal_relation_instance(clausula_decima_sexta_cessão_de_contrato_ou_de_crédito_sucessão_contratual_e_subcontratação, duty_to_act, zoom_tecnologia_ltda, present_confidentiality_terms).
legal_relation_instance(clausula_decima_sexta_cessão_de_contrato_ou_de_crédito_sucessão_contratual_e_subcontratação, permission_to_act, zoom_tecnologia_ltda, perform_corporate_restructuring).
legal_relation_instance(clausula_decima_sexta_cessão_de_contrato_ou_de_crédito_sucessão_contratual_e_subcontratação, permission_to_act, zoom_tecnologia_ltda, subcontract_data_migration_and_training).
legal_relation_instance(clausula_decima_sexta_cessão_de_contrato_ou_de_crédito_sucessão_contratual_e_subcontratação, subjection, zoom_tecnologia_ltda, be_responsible_for_subcontractor_actions).
legal_relation_instance(clausula_decima_setima_penalidades, duty_to_omit, zoom_tecnologia_ltda, omit_total_inexecution).
legal_relation_instance(clausula_decima_setima_penalidades, duty_to_omit, zoom_tecnologia_ltda, omit_partial_inexecution).
legal_relation_instance(clausula_decima_setima_penalidades, duty_to_omit, zoom_tecnologia_ltda, omit_disobeying_bndes_requirements).
legal_relation_instance(clausula_decima_setima_penalidades, duty_to_omit, zoom_tecnologia_ltda, omit_legal_obligation_noncompliance).
legal_relation_instance(clausula_decima_setima_penalidades, duty_to_omit, zoom_tecnologia_ltda, omit_unjustified_delay).
legal_relation_instance(clausula_decima_setima_penalidades, power, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, apply_warning).
legal_relation_instance(clausula_decima_setima_penalidades, power, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, apply_fine).
legal_relation_instance(clausula_decima_setima_penalidades, power, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, suspend_from_bidding).
legal_relation_instance(clausula_decima_setima_penalidades, subjection, zoom_tecnologia_ltda, be_subject_to_warning).
legal_relation_instance(clausula_decima_setima_penalidades, subjection, zoom_tecnologia_ltda, be_subject_to_fine).
legal_relation_instance(clausula_decima_oitava_alteracoes_contratuais, permission_to_act, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, alterar_contrato).
legal_relation_instance(clausula_decima_oitava_alteracoes_contratuais, duty_to_omit, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, omit_changing_essential_conditions).
legal_relation_instance(clausula_decima_oitava_alteracoes_contratuais, duty_to_act, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, formalizar_alteracao_contratual).
legal_relation_instance(clausula_decima_oitava_alteracoes_contratuais, right_to_action, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, claim_damages).
legal_relation_instance(clausula_decima_oitava_alteracoes_contratuais, duty_to_omit, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, omit_refusing_contract_change).
legal_relation_instance(clausula_decima_nona_extincao_contrato, power, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, extinguish_contract_consensually).
legal_relation_instance(clausula_decima_nona_extincao_contrato, duty_to_act, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, provide_written_notice_of_termination).
legal_relation_instance(clausula_decima_nona_extincao_contrato, right_to_action, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, terminate_contract_for_breach).
legal_relation_instance(clausula_decima_nona_extincao_contrato, power, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, suspend_contract_execution).
legal_relation_instance(clausula_decima_nona_extincao_contrato, duty_to_act, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, notify_other_party_of_termination).
legal_relation_instance(clausula_decima_nona_extincao_contrato, duty_to_act, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, provide_opportunity_for_defense).
legal_relation_instance(clausula_decima_nona_extincao_contrato, power, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, extinguish_contract_force_majeure).
legal_relation_instance(clausula_vigesima_divulgacao_dados_pessoais, permission_to_act, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, treat_personal_data).
legal_relation_instance(clausula_vigesima_divulgacao_dados_pessoais, right_to_action, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, request_additional_personal_data).
legal_relation_instance(clausula_vigesima_divulgacao_dados_pessoais, duty_to_act, zoom_tecnologia_ltda, collect_consent).
legal_relation_instance(clausula_vigesima_divulgacao_dados_pessoais, duty_to_act, zoom_tecnologia_ltda, inform_data_holders).
legal_relation_instance(clausula_vigesima_primeira_disposicoes_finais, no_right_to_action, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, demand_strict_compliance).
legal_relation_instance(clausula_vigesima_primeira_disposicoes_finais, right_to_action, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, exercise_rights).
legal_relation_instance(clausula_vigesima_segunda_foro, power, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, agree_on_forum).
legal_relation_instance(clausula_vigesima_segunda_foro, no_right_to_action, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, sue_in_other_forum).
legal_relation_instance(clausula_setima_pagamento, duty_to_act, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, make_payment).
legal_relation_instance(clausula_setima_pagamento, right_to_action, zoom_tecnologia_ltda, receive_payment).
legal_relation_instance(clausula_setima_pagamento, duty_to_act, zoom_tecnologia_ltda, present_fiscal_documents).
legal_relation_instance(clausula_setima_pagamento, right_to_action, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, deduct_overpayments).
legal_relation_instance(clausula_setima_pagamento, duty_to_omit, banco_nacional_de_1desenvolvimento_economico_e_social_bndes, pay_if_documents_late).
legal_relation_instance(clausula_nona_matriz_riscos, duty_to_omit, zoom_tecnologia_ltda, omit_celebrating_addenda).
legal_relation_instance(clausula_nona_matriz_riscos, no_right_to_action, zoom_tecnologia_ltda, no_right_to_celebrate_addenda).
...
action_type(agree_on_forum).
action_label(agree_on_forum, 'Agree on forum').
action_type(allocate_non_related_persons).
action_label(allocate_non_related_persons, 'Allocate non-related personnel').
...
action_type(assume_full_responsibility_for_burdens).
action_label(assume_full_responsibility_for_burdens, 'Assume responsibility for burdens').
action_type(be_responsible_for_subcontractor_actions).
action_label(be_responsible_for_subcontractor_actions, 'Subject to responsibility for subcontractors').
action_type(be_subject_to_bidding_suspension).
action_label(be_subject_to_bidding_suspension, 'Be subject to bidding suspension').
...
action_type(claim_damages).
action_label(claim_damages, 'Claim damages').
...
action_type(effect_receipt_of_object_through_manager).
action_label(effect_receipt_of_object_through_manager, 'Receipt via manager').
...
action_label(ensure_compliance_with_security_norms, 'Ensure compliance with security').
...
action_type(extinguish_contract_force_majeure).
action_label(extinguish_contract_force_majeure, 'Extinguish contract force majeure').
...
action_label(impose_penalties_for_non_compliance, 'Impose penalties for non-compliance').
...
action_type(keep_info_confidential).
action_label(keep_info_confidential, 'Keep information confidential').
action_type(limit_info_access).
action_label(limit_info_access, 'Limit information access').
...
action_label(maintain_contractual_conditions, 'Duty to maintain conditions').
...
action_label(not_access_confidential_info, 'Do not access confidential information').
action_type(not_share_data_without_authorization).
action_label(not_share_data_without_authorization, 'Not share data w/o authorization').
...
action_type(observe_system_policies).
action_label(observe_system_policies, 'Observe system policies').
...
action_label(offer_undue_advantage, 'Do not offer advantage').
action_type(omit_celebrating_addenda).
action_label(omit_celebrating_addenda, 'Omit celebrating addenda').
action_type(omit_changing_essential_conditions).
action_label(omit_changing_essential_conditions, 'Omit changing essential conditions').
action_type(omit_disobeying_bndes_requirements).
action_label(omit_disobeying_bndes_requirements, 'Omit disobeying BNDES requirements').
action_type(omit_legal_obligation_noncompliance).
action_label(omit_legal_obligation_noncompliance, 'Omit legal obligation noncompliance').
action_type(omit_partial_inexecution).
action_label(omit_partial_inexecution, 'Omit partial inexecution').
action_type(omit_refusing_contract_change).
action_label(omit_refusing_contract_change, 'Omit refusing contract change').
action_type(omit_total_inexecution).
action_label(omit_total_inexecution, 'Omit total inexecution').
...
action_type(pay_if_documents_late).
action_label(pay_if_documents_late, 'Avoid paying if documents late').
action_type(pay_taxes_and_fees).
action_label(pay_taxes_and_fees, 'Pay taxes and fees').
action_type(perform_corporate_restructuring).
action_label(perform_corporate_restructuring, 'Permission to restructure company').
action_type(permission_not_to_delete).
action_label(permission_not_to_delete, 'Permission not to delete').
action_type(present_confidentiality_term_a).
action_label(present_confidentiality_term_a, 'Present confidentiality term A').
action_type(present_confidentiality_term_b).
action_label(present_confidentiality_term_b, 'Present confidentiality term B').
...
action_type(present_price_reduction_information).
action_label(present_price_reduction_information, 'Present price reduction information').
action_type(present_supporting_documents).
action_label(present_supporting_documents, 'Duty to present documents').
...
action_label(provide_information_for_service_execution, 'Provide info for service execution').
action_type(provide_opportunity_for_defense).
action_label(provide_opportunity_for_defense, 'Provide opportunity for defense').
action_type(provide_related_services).
action_label(provide_related_services, 'Provide related services').
...
action_type(receive_info_from_contracted_party).
action_label(receive_info_from_contracted_party, 'Receive data info').
action_type(receive_payment).
action_label(receive_payment, 'Receive payment').
action_type(receive_payment_for_data_storage_solution).
action_label(receive_payment_for_data_storage_solution, 'Receive payment for solution').
...
action_label(repair_correct_remove_reconstruct_or_replace, 'Repair or replace defective object').
...
action_type(request_price_adjust_after_deadline).
action_label(request_price_adjust_after_deadline, 'Cannot request price adjust after deadline').
...
action_label(request_price_adjustment_before_contract_end, 'Request price adjust before end').
action_type(request_price_review).
action_label(request_price_review, 'Request price review').
action_type(require_execution_according_to_specifications).
action_label(require_execution_according_to_specifications, 'Require execution per specifications').
action_type(return_materials_to_bndes).
action_label(return_materials_to_bndes, 'Return materials to BNDES').
action_type(return_resources_revoke_access_eliminate_mailboxes).
action_label(return_resources_revoke_access_eliminate_mailboxes, 'Return resources and revoke access').
action_type(right_of_recourse).
action_label(right_of_recourse, 'Right of recourse').
action_type(set_contract_duration).
action_label(set_contract_duration, 'Set contract duration').
action_type(set_contract_duration_data_center).
action_label(set_contract_duration_data_center, 'Set contract duration for data center assistance').
action_type(set_contract_duration_secondary_data_center).
action_label(set_contract_duration_secondary_data_center, 'Set contract duration for secondary data center').
action_type(subcontract_data_migration_and_training).
action_label(subcontract_data_migration_and_training, 'Permission to subcontract').
action_type(submit_dif).
action_label(submit_dif, 'Submit DIF').
action_type(sue_in_other_forum).
action_label(sue_in_other_forum, 'Sue in another forum').
action_type(suspend_contract_execution).
action_label(suspend_contract_execution, 'Suspend contract execution').
action_type(suspend_from_bidding).
action_label(suspend_from_bidding, 'Suspend from bidding').

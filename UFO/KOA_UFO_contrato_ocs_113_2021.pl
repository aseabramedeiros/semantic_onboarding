% ===== KOA Combined Output | contract_id: contrato_ocs_113_2021 =====
...
% UFO-only grounding generated from: KOA_Contrato_OCS_113_2021_-_Algar_(Link_Bloomberg_DC_alternativo).pl
% contract_id: contrato_ocs_113_2021

instance_of(contrato_ocs_113_2021, legal_service_agreement).

instance_of(banco_nacional_de_desenvolvimento_economico_e_social_bndes, agent).
instance_of(algar_solucoes_em_tic_s_a, agent).

plays_role(banco_nacional_de_desenvolvimento_economico_e_social_bndes, service_customer_role, contrato_ocs_113_2021).
plays_role(algar_solucoes_em_tic_s_a, hired_service_provider_role, contrato_ocs_113_2021).

clause_of(clausula_primeira_objeto, contrato_ocs_113_2021).
clause_of(clausula_segunda_vigencia, contrato_ocs_113_2021).
clause_of(clausula_terceira_local_prazo_condicoes_execucao_objeto, contrato_ocs_113_2021).
clause_of(clausula_quarta_niveis_servico, contrato_ocs_113_2021).
clause_of(clausula_quinta_recebimento_objeto, contrato_ocs_113_2021).
clause_of(clausula_sexta_preco, contrato_ocs_113_2021).
clause_of(clausula_setima_pagamento, contrato_ocs_113_2021).
clause_of(clausula_oitava_equilibrio_economico_financeiro_contrato, contrato_ocs_113_2021).
clause_of(clausula_decima_garantia_contratual, contrato_ocs_113_2021).
clause_of(clausula_decima_primeira_obrigações_contratado, contrato_ocs_113_2021).
clause_of(clausula_decima_segunda_conduta_ética_do_contratado_e_do_bndes, contrato_ocs_113_2021).
clause_of(clausula_decima_terceira_sigilo_das_informações, contrato_ocs_113_2021).
clause_of(clausula_decima_quarta_acesso_protecao_dados_pessoais, contrato_ocs_113_2021).
clause_of(clausula_decima_quinta_obrigações_bndes, contrato_ocs_113_2021).
clause_of(clausula_decima_sexta_cessao_contrato_credito_sucessao_subcontratacao, contrato_ocs_113_2021).
clause_of(clausula_decima_setima_penalidades, contrato_ocs_113_2021).
clause_of(clausula_decima_oitava_alterações_contratuais, contrato_ocs_113_2021).
clause_of(clausula_decima_nona_extinção_do_contrato, contrato_ocs_113_2021).
clause_of(clausula_vigesima_disposições_finais, contrato_ocs_113_2021).
clause_of(clausula_vigesima_primeira_foro, contrato_ocs_113_2021).
clause_of(clausula_nona_matriz_riscos, contrato_ocs_113_2021).

legal_relation_instance(clausula_primeira_objeto, duty_to_act, algar_solucoes_em_tic_s_a, provide_data_communication_service).
legal_relation_instance(clausula_primeira_objeto, right_to_action, algar_solucoes_em_tic_s_a, provide_data_communication_service).
...
legal_relation_instance(clausula_segunda_vigencia, duty_to_act, algar_solucoes_em_tic_s_a, start_implementation).
legal_relation_instance(clausula_segunda_vigencia, duty_to_act, algar_solucoes_em_tic_s_a, complete_implementation).
legal_relation_instance(clausula_segunda_vigencia, duty_to_act, algar_solucoes_em_tic_s_a, provide_data_service).
legal_relation_instance(clausula_terceira_local_prazo_condicoes_execucao_objeto, duty_to_act, algar_solucoes_em_tic_s_a, execute_contract_object_per_specifications).
...
legal_relation_instance(clausula_quarta_niveis_servico, duty_to_act, algar_solucoes_em_tic_s_a, execute_services_according_to_standards).
...
legal_relation_instance(clausula_quarta_niveis_servico, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, define_service_standards).
legal_relation_instance(clausula_quarta_niveis_servico, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, require_services_execution_according_to_standards).
legal_relation_instance(clausula_quarta_niveis_servico, duty_to_omit, algar_solucoes_em_tic_s_a, not_breach_service_levels).
...
legal_relation_instance(clausula_sexta_preco, no_right_to_action, algar_solucoes_em_tic_s_a, demand_indemnization).
legal_relation_instance(clausula_sexta_preco, subjection, algar_solucoes_em_tic_s_a, accept_proportional_reduction).
legal_relation_instance(clausula_sexta_preco, duty_to_act, algar_solucoes_em_tic_s_a, bear_cost_of_errors).
legal_relation_instance(clausula_sexta_preco, right_to_action, algar_solucoes_em_tic_s_a, receive_payment).
...
legal_relation_instance(clausula_setima_pagamento, duty_to_act, algar_solucoes_em_tic_s_a, present_fiscal_document).
legal_relation_instance(clausula_setima_pagamento, duty_to_omit, banco_nacional_de_desenvolvimento_economico_e_social_bndes, omit_direct_payment_subcontractors).
legal_relation_instance(clausula_setima_pagamento, right_to_omission, banco_nacional_de_desenvolvimento_economico_e_social_bndes, reject_late_payment).
...
legal_relation_instance(clausula_setima_pagamento, right_to_action, algar_solucoes_em_tic_s_a, receive_payment).
...
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, power, algar_solucoes_em_tic_s_a, request_price_adjustment).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, initiate_price_review).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, algar_solucoes_em_tic_s_a, request_price_adjustment_revision).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, no_right_to_action, algar_solucoes_em_tic_s_a, claim_price_adjustment_revision).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, subjection, algar_solucoes_em_tic_s_a, renounce_right_price_adjustment_revision).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, algar_solucoes_em_tic_s_a, formulate_request_for_contract_revision).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, algar_solucoes_em_tic_s_a, provide_information_for_price_reduction).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, algar_solucoes_em_tic_s_a, submit_cost_variation_proofs).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, immunity, banco_nacional_de_desenvolvimento_economico_e_social_bndes, suspend_analysis_period).
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, algar_solucoes_em_tic_s_a, provide_contractual_guarantee).
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, algar_solucoes_em_tic_s_a, obtain_new_guarantee_if_guarantor_refuses).
...
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, algar_solucoes_em_tic_s_a, obtain_guarantor_agreement).
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, algar_solucoes_em_tic_s_a, provide_updated_guarantee).
...
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, algar_solucoes_em_tic_s_a, maintain_conditions_of_habilitation).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, algar_solucoes_em_tic_s_a, communicate_imposition_of_penalty).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, algar_solucoes_em_tic_s_a, repair_correct_remove_rebuild_substitute).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, algar_solucoes_em_tic_s_a, repair_damages_and_losses).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, algar_solucoes_em_tic_s_a, pay_all_fees_and_taxes).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, algar_solucoes_em_tic_s_a, assume_full_responsibility_for_charges).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, algar_solucoes_em_tic_s_a, provide_exclusion_from_simples_nacional).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, algar_solucoes_em_tic_s_a, allow_inspections_and_monitoring).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, algar_solucoes_em_tic_s_a, obey_instructions_and_procedures).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, algar_solucoes_em_tic_s_a, designate_representative).
legal_relation_instance(clausula_decima_segunda_conduta_ética_do_contratado_e_do_bndes, duty_to_act, algar_solucoes_em_tic_s_a, maintain_integrity_in_public_private_relations).
legal_relation_instance(clausula_decima_segunda_conduta_ética_do_contratado_e_do_bndes, duty_to_act, algar_solucoes_em_tic_s_a, act_in_good_faith).
legal_relation_instance(clausula_decima_segunda_conduta_ética_do_contratado_e_do_bndes, duty_to_omit, algar_solucoes_em_tic_s_a, not_offer_undue_advantage).
legal_relation_instance(clausula_decima_segunda_conduta_ética_do_contratado_e_do_bndes, duty_to_omit, algar_solucoes_em_tic_s_a, prevent_bndes_employee_favortism).
legal_relation_instance(clausula_decima_segunda_conduta_ética_do_contratado_e_do_bndes, duty_to_omit, algar_solucoes_em_tic_s_a, not_allocate_family_members).
legal_relation_instance(clausula_decima_segunda_conduta_ética_do_contratado_e_do_bndes, duty_to_act, algar_solucoes_em_tic_s_a, observe_bndes_code_of_ethics).
legal_relation_instance(clausula_decima_segunda_conduta_ética_do_contratado_e_do_bndes, duty_to_act, algar_solucoes_em_tic_s_a, adopt_good_environmental_practices).
legal_relation_instance(clausula_decima_segunda_conduta_ética_do_contratado_e_do_bndes, duty_to_act, algar_solucoes_em_tic_s_a, remove_agents_involved_in_favortism).
legal_relation_instance(clausula_decima_segunda_conduta_ética_do_contratado_e_do_bndes, duty_to_act, algar_solucoes_em_tic_s_a, notify_bndes_of_favortism).
legal_relation_instance(clausula_decima_segunda_conduta_ética_do_contratado_e_do_bndes, duty_to_act, algar_solucoes_em_tic_s_a, prevent_employees_corruption).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, algar_solucoes_em_tic_s_a, maintain_confidentiality).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, algar_solucoes_em_tic_s_a, provide_confidentiality_agreement).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, algar_solucoes_em_tic_s_a, orient_professionals).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, request_confidentiality_agreement).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, algar_solucoes_em_tic_s_a, adopt_correct_security_measures).
...
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, algar_solucoes_em_tic_s_a, provide_data_access).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, algar_solucoes_em_tic_s_a, inform_bndes_of_requests).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, algar_solucoes_em_tic_s_a, maintain_treatment_operation_records).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, algar_solucoes_em_tic_s_a, inform_bndes_of_incidents).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, algar_solucoes_em_tic_s_a, eliminate_personal_data).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_omit, banco_nacional_de_desenvolvimento_economico_e_social_bndes, omit_sharing_or_using_collected_data_without_authorization).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, algar_solucoes_em_tic_s_a, maintain_data_confidentiality).
...
legal_relation_instance(clausula_decima_quinta_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, designate_contract_auditor).
...
legal_relation_instance(clausula_decima_quinta_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, make_available_information).
...
legal_relation_instance(clausula_decima_quinta_obrigações_bndes, right_to_action, algar_solucoes_em_tic_s_a, request_information).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_subcontratacao, duty_to_omit, algar_solucoes_em_tic_s_a, refrain_from_assignment).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_subcontratacao, no_right_to_action, algar_solucoes_em_tic_s_a, assign_contract).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_subcontratacao, duty_to_omit, algar_solucoes_em_tic_s_a, refrain_from_issuing_credit_titles).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_subcontratacao, no_right_to_action, algar_solucoes_em_tic_s_a, issue_credit_titles).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_subcontratacao, duty_to_act, algar_solucoes_em_tic_s_a, present_confidentiality_terms).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_subcontratacao, subjection, algar_solucoes_em_tic_s_a, remain_responsible_for_subcontractor).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_subcontratacao, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, analyze_risks_succession).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_subcontratacao, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, deny_subcontracting_approval).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_subcontratacao, subjection, algar_solucoes_em_tic_s_a, get_approval_for_subcontracting).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_subcontratacao, duty_to_act, algar_solucoes_em_tic_s_a, present_documents_for_subcontracting).
legal_relation_instance(clausula_decima_setima_penalidades, duty_to_omit, algar_solucoes_em_tic_s_a, omit_breach_of_contract).
legal_relation_instance(clausula_decima_setima_penalidades, subjection, algar_solucoes_em_tic_s_a, be_subject_to_penalties).
legal_relation_instance(clausula_decima_setima_penalidades, right_to_action, algar_solucoes_em_tic_s_a, request_reconsideration).
legal_relation_instance(clausula_decima_setima_penalidades, right_to_action, algar_solucoes_em_tic_s_a, appeal_penalty_decision).
...
legal_relation_instance(clausula_decima_setima_penalidades, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, deduct_fine_from_credits).
...
legal_relation_instance(clausula_decima_oitava_alterações_contratuais, permission_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, alter_contract).
...
legal_relation_instance(clausula_decima_oitava_alterações_contratuais, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, claim_damages_unjustified_refusal).
legal_relation_instance(clausula_decima_oitava_alterações_contratuais, subjection, banco_nacional_de_desenvolvimento_economico_e_social_bndes, respond_damages_unjustified_refusal).
legal_relation_instance(clausula_decima_nona_extinção_do_contrato, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, provide_notice_of_contract_termination).
legal_relation_instance(clausula_decima_nona_extinção_do_contrato, duty_to_act, algar_solucoes_em_tic_s_a, allow_contract_termination_due_to_bankruptcy).
legal_relation_instance(clausula_decima_nona_extinção_do_contrato, subjection, algar_solucoes_em_tic_s_a, be_subject_to_contract_termination_due_to_bankruptcy).
legal_relation_instance(clausula_decima_nona_extinção_do_contrato, subjection, algar_solucoes_em_tic_s_a, be_subject_to_termination_for_lesive_act).
legal_relation_instance(clausula_decima_nona_extinção_do_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_contract_unilaterally).
legal_relation_instance(clausula_decima_nona_extinção_do_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_contract_due_to_lesive_act).
legal_relation_instance(clausula_decima_nona_extinção_do_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_contract_due_to_force_majeure).
legal_relation_instance(clausula_vigesima_disposições_finais, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, exercise_contractual_rights).
legal_relation_instance(clausula_vigesima_disposições_finais, no_right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, demand_strict_compliance).
...
legal_relation_instance(clausula_vigesima_primeira_foro, no_right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, bring_suit_in_another_court).
legal_relation_instance(clausula_nona_matriz_riscos, duty_to_omit, algar_solucoes_em_tic_s_a, not_use_additives_for_allocated_events).
legal_relation_instance(clausula_nona_matriz_riscos, duty_to_act, algar_solucoes_em_tic_s_a, respect_economic_financial_balance).
legal_relation_instance(clausula_nona_matriz_riscos, right_to_action, algar_solucoes_em_tic_s_a, reajust_risk_matrix).
...
action_type(allow_contract_termination_due_to_bankruptcy).
action_label(allow_contract_termination_due_to_bankruptcy, 'Allow contract termination due to bankruptcy').
...
action_label(apply_penalty_if_guarantee_not_provided, 'Apply penalty for lack of guarantee').
...
action_type(assume_full_responsibility_for_charges).
action_label(assume_full_responsibility_for_charges, 'Assume responsibility for charges').
action_type(assume_technical_administrative_responsibility).
action_label(assume_technical_administrative_responsibility, 'Assume responsibility').
action_type(attend_to_requests_during_closure).
action_label(attend_to_requests_during_closure, 'Attend to requests during closure').
...
action_type(be_subject_to_contract_termination_due_to_bankruptcy).
action_label(be_subject_to_contract_termination_due_to_bankruptcy, 'Subject to contract termination due to bankruptcy').
action_type(be_subject_to_penalties).
action_label(be_subject_to_penalties, 'Be subject to penalties').
action_type(be_subject_to_termination_for_lesive_act).
action_label(be_subject_to_termination_for_lesive_act, 'Subject to termination for lesive act').
...
action_type(bring_suit_in_another_court).
action_label(bring_suit_in_another_court, 'Bring suit elsewhere').
action_type(choose_rio_de_janeiro_court).
action_label(choose_rio_de_janeiro_court, 'Choose Rio de Janeiro court').
action_type(claim_damages_unjustified_refusal).
action_label(claim_damages_unjustified_refusal, 'Claim damages for refusal').
action_type(claim_price_adjustment_revision).
action_label(claim_price_adjustment_revision, 'Claim price adjustment/revision').
...
action_type(communicate_urgent_abnormality).
action_label(communicate_urgent_abnormality, 'Communicate urgent abnormality').
...
action_type(define_service_standards).
action_label(define_service_standards, 'Define service standards').
...
action_label(demand_strict_compliance, 'Demand strict compliance waived previously').
action_type(deny_subcontracting_approval).
action_label(deny_subcontracting_approval, 'Deny Subcontracting approval').
...
action_type(execute_contract_object_per_specifications).
action_label(execute_contract_object_per_specifications, 'Execute object per specs').
...
action_type(formulate_request_for_contract_revision).
action_label(formulate_request_for_contract_revision, 'Formulate request for contract revision').
action_type(get_approval_for_subcontracting).
action_label(get_approval_for_subcontracting, 'Get approval for subcontracting').
...
action_type(identify_employees_with_badges).
action_label(identify_employees_with_badges, 'Identify employees with badges').
action_type(implement_permanent_supervision).
action_label(implement_permanent_supervision, 'Implement supervision').
action_type(indicate_address_and_contact_information).
action_label(indicate_address_and_contact_information, 'Indicate contact information').
action_type(inform_bndes_of_incidents).
action_label(inform_bndes_of_incidents, 'Inform BNDES of data incidents').
action_type(inform_bndes_of_requests).
action_label(inform_bndes_of_requests, 'Inform BNDES of data requests').
action_type(inform_cpf_name_contact).
action_label(inform_cpf_name_contact, 'Inform contact details').
...
action_type(maintain_organized_communication_channels).
action_label(maintain_organized_communication_channels, 'Maintain organized communication').
action_type(maintain_treatment_operation_records).
action_label(maintain_treatment_operation_records, 'Maintain treatment operation records').
action_type(maintain_updated_escalation_list).
action_label(maintain_updated_escalation_list, 'Maintain escalation list').
action_type(make_available_information).
action_label(make_available_information, 'Make available information').
...
action_type(not_breach_service_levels).
action_label(not_breach_service_levels, 'Not breach service levels').
...
action_type(not_use_additives_for_allocated_events).
action_label(not_use_additives_for_allocated_events, 'Do not use addenda for allocated events').
action_type(notify_bndes_of_favortism).
action_label(notify_bndes_of_favortism, 'Notify BNDES of favoritism').
action_type(notify_risks_to_bndes).
action_label(notify_risks_to_bndes, 'Notify risks').
...
action_label(obtain_new_guarantee_if_guarantor_refuses, 'Obtain new guarantee if guarantor refuses').
action_type(omit_breach_of_contract).
action_label(omit_breach_of_contract, 'Omit breach of contract').
action_type(omit_direct_payment_subcontractors).
action_label(omit_direct_payment_subcontractors, 'Omit direct payment to subcontractors').
action_type(omit_sharing_or_using_collected_data_without_authorization).
action_label(omit_sharing_or_using_collected_data_without_authorization, 'Don\'t share data without consent').
action_type(orient_professionals).
action_label(orient_professionals, 'Orient professionals').
action_type(pay_all_fees_and_taxes).
action_label(pay_all_fees_and_taxes, 'Pay fees and taxes').
...
action_type(present_documents_for_subcontracting).
action_label(present_documents_for_subcontracting, 'Present subcontracting documents').
...
action_type(prevent_bndes_employee_favortism).
action_label(prevent_bndes_employee_favortism, 'Prevent BNDES employee favoritism').
action_type(prevent_employee_participation).
action_label(prevent_employee_participation, 'Prevent employee participation').
action_type(prevent_employees_corruption).
action_label(prevent_employees_corruption, 'Prevent employee corruption').
action_type(proceed_with_new_installations).
action_label(proceed_with_new_installations, 'Proceed with new installations').
...
action_label(provide_data_access, 'Provide data access to data subject').
...
action_type(provide_data_service).
action_label(provide_data_service, 'Provide data service').
...
action_type(provide_information_for_price_reduction).
action_label(provide_information_for_price_reduction, 'Provide information for price reduction').
action_type(provide_necessary_information).
action_label(provide_necessary_information, 'Provide necessary information').
action_type(provide_notice_of_contract_termination).
action_label(provide_notice_of_contract_termination, 'Provide notice of contract termination').
action_type(provide_updated_guarantee).
action_label(provide_updated_guarantee, 'Provide updated guarantee').
action_type(reajust_risk_matrix).
action_label(reajust_risk_matrix, 'Readjust risk matrix').
...
action_type(refrain_from_assignment).
action_label(refrain_from_assignment, 'Refrain from assignment').
action_type(refrain_from_issuing_credit_titles).
action_label(refrain_from_issuing_credit_titles, 'Refrain from issuing credit titles').
...
action_label(remain_responsible_for_subcontractor, 'Remain responsible for subcontractor').
action_type(remove_agents_involved_in_favortism).
action_label(remove_agents_involved_in_favortism, 'Remove agents involved in favoritism').
action_type(renounce_right_price_adjustment_revision).
action_label(renounce_right_price_adjustment_revision, 'Renounce right to price adjustment/revision').
action_type(repair_correct_remove_rebuild_substitute).
action_label(repair_correct_remove_rebuild_substitute, 'Repair defects').
...
action_label(request_information, 'Request Information').
...
action_type(require_services_execution_according_to_standards).
action_label(require_services_execution_according_to_standards, 'Require service execution').
action_type(respect_economic_financial_balance).
action_label(respect_economic_financial_balance, 'Respect economic financial balance clause').
action_type(respond_damages_unjustified_refusal).
action_label(respond_damages_unjustified_refusal, 'Liable to damages for refusal').
action_type(retroactive_financial_effects).
action_label(retroactive_financial_effects, 'Retroactive financial effects').
action_type(return_resources_and_revoke_access).
action_label(return_resources_and_revoke_access, 'Return resources').
action_type(right_of_regress).
action_label(right_of_regress, 'Right of regress').
action_type(start_implementation).
action_label(start_implementation, 'Start implementation').
action_type(submit_cost_variation_proofs).
action_label(submit_cost_variation_proofs, 'Submit cost variation proofs').
action_type(suspend_analysis_period).
action_label(suspend_analysis_period, 'Suspend analysis period').

% ===== KOA Combined Output | contract_id: contrato_ocs_0147_2022 =====
...
% UFO-only grounding generated from: KOA_Contrato_OCS_147_2022_-_ALCTEL.pl
% contract_id: contrato_ocs_0147_2022

instance_of(contrato_ocs_0147_2022, legal_service_agreement).

instance_of(banco_nacional_de_desenvolvimento_economico_e_social_bndes, agent).
instance_of(alctel_telecomunicacoes_e_informatica_ltda, agent).

plays_role(banco_nacional_de_desenvolvimento_economico_e_social_bndes, service_customer_role, contrato_ocs_0147_2022).
plays_role(alctel_telecomunicacoes_e_informatica_ltda, hired_service_provider_role, contrato_ocs_0147_2022).

clause_of(clausula_primeira_objeto, contrato_ocs_0147_2022).
clause_of(clausula_segunda_vigencia, contrato_ocs_0147_2022).
clause_of(clausula_terceira_local_prazo_condicoes_execucao_objeto, contrato_ocs_0147_2022).
clause_of(clausula_quarta_niveis_servico, contrato_ocs_0147_2022).
clause_of(clausula_quinta_recebimento_objeto, contrato_ocs_0147_2022).
clause_of(clausula_sexta_preco, contrato_ocs_0147_2022).
clause_of(clausula_setima_pagamento, contrato_ocs_0147_2022).
clause_of(clausula_oitava_equilibrio_economico_financeiro_contrato, contrato_ocs_0147_2022).
clause_of(clausula_decima_garantia_contratual, contrato_ocs_0147_2022).
clause_of(clausula_decima_primeira_obrigações_contratado, contrato_ocs_0147_2022).
clause_of(clausula_decima_segunda_conduta_etica_contratado_bndes, contrato_ocs_0147_2022).
clause_of(clausula_decima_terceira_sigilo_informacoes, contrato_ocs_0147_2022).
clause_of(clausula_decima_quarta_acesso_protecao_dados_pessoais, contrato_ocs_0147_2022).
clause_of(clausula_decima_quinta_obrigações_bndes, contrato_ocs_0147_2022).
clause_of(clausula_decima_sexta_equidade_genero_valorizacao_diversidade, contrato_ocs_0147_2022).
clause_of(clausula_decima_setima_cessao_contrato_credito_sucessao_subcontratacao, contrato_ocs_0147_2022).
clause_of(clausula_decima_oitava_penalidades, contrato_ocs_0147_2022).
clause_of(clausula_decima_nona_alteracoes_contratuais, contrato_ocs_0147_2022).
clause_of(clausula_vigesima_extincao_contrato, contrato_ocs_0147_2022).
clause_of(clausula_vigesima_primeira_disposicoes_finais, contrato_ocs_0147_2022).
clause_of(clausula_vigesima_segunda_foro, contrato_ocs_0147_2022).
clause_of(clausula_nona_matriz_riscos, contrato_ocs_0147_2022).

legal_relation_instance(clausula_primeira_objeto, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, provide_telephony_services).
legal_relation_instance(clausula_primeira_objeto, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, receive_telephony_services).
legal_relation_instance(clausula_primeira_objeto, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, provide_implementation_services).
legal_relation_instance(clausula_primeira_objeto, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, provide_training_services).
legal_relation_instance(clausula_segunda_vigencia, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, communicate_interest_regarding_extension).
legal_relation_instance(clausula_segunda_vigencia, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, present_manifestation_about_extension).
legal_relation_instance(clausula_segunda_vigencia, subjection, alctel_telecomunicacoes_e_informatica_ltda, be_subject_to_penalties).
legal_relation_instance(clausula_segunda_vigencia, permission_to_act, unknown, extend_contract).
legal_relation_instance(clausula_terceira_local_prazo_condicoes_execucao_objeto, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, execute_contract_subject).
legal_relation_instance(clausula_terceira_local_prazo_condicoes_execucao_objeto, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, receive_executed_contract_subject).
legal_relation_instance(clausula_quarta_niveis_servico, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, execute_services_according_to_standards).
legal_relation_instance(clausula_quarta_niveis_servico, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, apply_price_reductions_for_non_compliance).
legal_relation_instance(clausula_quarta_niveis_servico, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, establish_service_level_standards).
legal_relation_instance(clausula_quarta_niveis_servico, subjection, alctel_telecomunicacoes_e_informatica_ltda, be_subject_to_price_reductions).
...
legal_relation_instance(clausula_sexta_preco, right_to_action, alctel_telecomunicacoes_e_informatica_ltda, receive_payment).
legal_relation_instance(clausula_sexta_preco, no_right_to_action, alctel_telecomunicacoes_e_informatica_ltda, demand_indemnization_for_no_total_demand).
legal_relation_instance(clausula_sexta_preco, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, bear_costs_of_errors).
legal_relation_instance(clausula_sexta_preco, subjection, alctel_telecomunicacoes_e_informatica_ltda, accept_price_reduction_for_partial_performance).
legal_relation_instance(clausula_setima_pagamento, duty_to_omit, banco_nacional_de_desenvolvimento_economico_e_social_bndes, nao_pagar_subcontratado).
...
legal_relation_instance(clausula_setima_pagamento, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, apresentar_documento_fiscal).
legal_relation_instance(clausula_setima_pagamento, right_to_action, alctel_telecomunicacoes_e_informatica_ltda, receive_payment).
legal_relation_instance(clausula_setima_pagamento, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, rejeitar_documento_fiscal_fora_prazo).
legal_relation_instance(clausula_setima_pagamento, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, deduzir_valores).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, right_to_action, alctel_telecomunicacoes_e_informatica_ltda, request_price_adjustment).
...
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, right_to_action, alctel_telecomunicacoes_e_informatica_ltda, request_price_revision).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, provide_requested_info).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, request_price_adjustment_revision).
...
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, provide_contractual_guarantee).
legal_relation_instance(clausula_decima_garantia_contratual, subjection, alctel_telecomunicacoes_e_informatica_ltda, penalty_for_not_providing_guarantee).
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, obtain_guarantor_consent).
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, obtain_new_guarantee).
legal_relation_instance(clausula_decima_garantia_contratual, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, receive_guarantee).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, maintain_conditions_habilitation).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, communicate_impediment_to_contract).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, repair_correct_object).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, repair_damages_bndes_third_parties).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, pay_charges_taxes).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, assume_responsibility_fiscal_burdens).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, exclude_simples_nacional).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, obey_instructions_procedures).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, designate_representative).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, present_dif).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, maintain_integrity).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, act_in_good_faith).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_omit, alctel_telecomunicacoes_e_informatica_ltda, not_offer_undue_advantage).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, prevent_corruption).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_omit, alctel_telecomunicacoes_e_informatica_ltda, prevent_favoritism).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_omit, alctel_telecomunicacoes_e_informatica_ltda, not_allocate_family_members).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, observe_bndes_policies).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, adopt_sustainable_practices).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, remove_agents_from_contract).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, inform_bndes_of_situations).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, comply_with_bndes_security_policy).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_omit, alctel_telecomunicacoes_e_informatica_ltda, not_access_bndes_confidential_info).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, maintain_confidentiality_info).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, limit_access_to_info).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, inform_bndes_of_violation).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, return_bndes_materials).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, present_confidentiality_terms).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, observe_legal_rep_confidentiality).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, expect_contracted_party_compliance_security_policy).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, adopt_security_measures).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, obtain_consent).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, follow_bndes_instructions).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, maintain_confidentiality).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, store_data_securely).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, inform_employees_clause).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, provide_data_access_channel).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, inform_bndes_of_requests).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, maintain_records_of_data).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, communicate_data_incidents).
...
legal_relation_instance(clausula_decima_quinta_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, appoint_receiving_committee).
legal_relation_instance(clausula_decima_quinta_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, provide_ethics_information).
legal_relation_instance(clausula_decima_quinta_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, make_available_necessary_information).
...
legal_relation_instance(clausula_decima_quinta_obrigações_bndes, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, change_contract_manager).
legal_relation_instance(clausula_decima_sexta_equidade_genero_valorizacao_diversidade, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, prove_no_discriminatory_sanction).
legal_relation_instance(clausula_decima_sexta_equidade_genero_valorizacao_diversidade, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, request_proof_no_discriminatory_sanction).
...
legal_relation_instance(clausula_decima_sexta_equidade_genero_valorizacao_diversidade, subjection, alctel_telecomunicacoes_e_informatica_ltda, face_contract_suspension).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_subcontratacao, no_right_to_action, alctel_telecomunicacoes_e_informatica_ltda, assign_contract).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_subcontratacao, no_right_to_action, alctel_telecomunicacoes_e_informatica_ltda, issue_credit_title).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_subcontratacao, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, maintain_contract_conditions).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_subcontratacao, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, provide_evidence_of_compliance).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_subcontratacao, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, present_confidentiality_terms).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_subcontratacao, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, obtain_bndes_acquiescence).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_subcontratacao, right_to_action, alctel_telecomunicacoes_e_informatica_ltda, receive_credits).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_subcontratacao, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, analyse_risks).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_subcontratacao, permission_to_act, alctel_telecomunicacoes_e_informatica_ltda, merge_company).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_subcontratacao, permission_to_act, alctel_telecomunicacoes_e_informatica_ltda, subcontract_training).
legal_relation_instance(clausula_decima_oitava_penalidades, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, execute_contract_completely).
legal_relation_instance(clausula_decima_oitava_penalidades, subjection, alctel_telecomunicacoes_e_informatica_ltda, suffer_penalty_for_non_execution).
...
legal_relation_instance(clausula_decima_oitava_penalidades, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, observe_legal_obligations).
legal_relation_instance(clausula_decima_oitava_penalidades, subjection, alctel_telecomunicacoes_e_informatica_ltda, deduction_from_credits).
legal_relation_instance(clausula_decima_nona_alteracoes_contratuais, permission_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, agree_to_contract_modification).
...
legal_relation_instance(clausula_decima_nona_alteracoes_contratuais, duty_to_omit, banco_nacional_de_desenvolvimento_economico_e_social_bndes, omit_refusal_to_amend).
legal_relation_instance(clausula_decima_nona_alteracoes_contratuais, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, claim_damages_for_refusal_to_amend).
legal_relation_instance(clausula_decima_nona_alteracoes_contratuais, subjection, banco_nacional_de_desenvolvimento_economico_e_social_bndes, be_liable_for_damages_refusal_to_amend).
legal_relation_instance(clausula_vigesima_extincao_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_contract).
legal_relation_instance(clausula_vigesima_extincao_contrato, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, notify_termination).
legal_relation_instance(clausula_vigesima_extincao_contrato, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, defend_against_termination).
legal_relation_instance(clausula_vigesima_primeira_disposicoes_finais, permission_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, exercise_rights_at_any_time).
...
legal_relation_instance(clausula_vigesima_segunda_foro, subjection, banco_nacional_de_desenvolvimento_economico_e_social_bndes, submit_to_rio_de_janeiro_court).
legal_relation_instance(clausula_vigesima_segunda_foro, no_right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, litigate_in_another_court).
legal_relation_instance(clausula_nona_matriz_riscos, duty_to_act, alctel_telecomunicacoes_e_informatica_ltda, bear_supervening_events).
legal_relation_instance(clausula_nona_matriz_riscos, no_right_to_action, alctel_telecomunicacoes_e_informatica_ltda, claim_additional_payment_supervening_events).

% --- Action catalog (local to this contract grounding) ---
action_type(accept_price_reduction_for_partial_performance).
action_label(accept_price_reduction_for_partial_performance, 'Accept price reduction for partial performance').
...
action_type(agree_to_contract_modification).
action_label(agree_to_contract_modification, 'Agree to contract modification').
action_type(analyse_risks).
action_label(analyse_risks, 'Power to analyze risks').
...
action_type(apply_price_reductions_for_non_compliance).
action_label(apply_price_reductions_for_non_compliance, 'Apply price reductions').
...
action_type(assume_responsibility_fiscal_burdens).
action_label(assume_responsibility_fiscal_burdens, 'Assume responsibility for fiscal burdens').
action_type(be_liable_for_damages_refusal_to_amend).
action_label(be_liable_for_damages_refusal_to_amend, 'Be liable for refusal to amend').
action_type(be_subject_to_penalties).
action_label(be_subject_to_penalties, 'Be subject to penalties').
action_type(be_subject_to_price_reductions).
action_label(be_subject_to_price_reductions, 'Subject to price reductions').
action_type(bear_costs_of_errors).
action_label(bear_costs_of_errors, 'Bear costs of errors').
action_type(bear_supervening_events).
action_label(bear_supervening_events, 'Bear supervening events').
action_type(cannot_transfer_responsibility).
action_label(cannot_transfer_responsibility, 'Cannot transfer responsibility').
action_type(change_contract_manager).
action_label(change_contract_manager, 'Change contract manager').
action_type(claim_additional_payment_supervening_events).
action_label(claim_additional_payment_supervening_events, 'No claim for additional payment').
action_type(claim_damages_for_refusal_to_amend).
action_label(claim_damages_for_refusal_to_amend, 'Claim damages for refusal to amend').
...
action_type(communicate_gestor_contrato).
action_label(communicate_gestor_contrato, 'Communicate with Gestor Contrato').
action_type(communicate_impediment_to_contract).
action_label(communicate_impediment_to_contract, 'Communicate impediment to contract').
...
action_label(communicate_interest_regarding_extension, 'Communicate interest to extend').
...
action_type(comply_federal_state_municipal_laws).
action_label(comply_federal_state_municipal_laws, 'Comply federal, state, municipal laws').
...
action_type(deduzir_valores).
action_label(deduzir_valores, 'Deduct amounts').
action_type(defend_against_termination).
action_label(defend_against_termination, 'Right to defend').
action_type(delete_personal_data).
action_label(delete_personal_data, 'Delete personal data').
action_type(demand_indemnization_for_no_total_demand).
action_label(demand_indemnization_for_no_total_demand, 'Demand indemnization for no total demand').
...
action_label(demand_strict_compliance_after_omission, 'Demand compliance after omission.').
action_type(designate_representative).
action_label(designate_representative, 'Designate representative').
action_type(discount_contractor_credit).
action_label(discount_contractor_credit, 'Discount contractor credit').
...
action_type(establish_service_level_standards).
action_label(establish_service_level_standards, 'Establish service standards').
action_type(exclude_simples_nacional).
action_label(exclude_simples_nacional, 'Exclude from Simples Nacional').
action_type(execute_contract_completely).
action_label(execute_contract_completely, 'Execute contract completely').
...
action_type(expect_contracted_party_compliance_security_policy).
action_label(expect_contracted_party_compliance_security_policy, 'Expect compliance with security policy').
action_type(extend_contract).
action_label(extend_contract, 'Extend the contract').
...
action_type(identify_employees_badges).
action_label(identify_employees_badges, 'Identify employees with badges').
action_type(immunity_responsibility).
action_label(immunity_responsibility, 'Immunity from reduced liability').
action_type(impede_participation_employees_bndes).
action_label(impede_participation_employees_bndes, 'Impedes participation employees BNDES').
action_type(inform_bndes_of_requests).
action_label(inform_bndes_of_requests, 'Inform BNDES of requests').
action_type(inform_bndes_of_situations).
action_label(inform_bndes_of_situations, 'Inform BNDES of situations').
action_type(inform_bndes_of_violation).
action_label(inform_bndes_of_violation, 'Inform BNDES of violation').
action_type(inform_data_holders).
action_label(inform_data_holders, 'Inform data holders').
action_type(inform_employees_clause).
action_label(inform_employees_clause, 'Inform employees about clause').
action_type(inform_irregularity_contract_execution).
action_label(inform_irregularity_contract_execution, 'Inform irregularity contract execution').
...
action_label(limit_access_info, 'Limit access info').
...
action_label(litigate_in_another_court, 'No right to litigate in another court').
action_type(maintain_conditions_habilitation).
action_label(maintain_conditions_habilitation, 'Maintain conditions of habilitation').
action_type(maintain_confidentiality).
action_label(maintain_confidentiality, 'Maintain confidentiality').
action_type(maintain_confidentiality_info).
action_label(maintain_confidentiality_info, 'Maintain confidentiality').
action_type(maintain_contract_conditions).
action_label(maintain_contract_conditions, 'Duty to maintain contract conditions').
action_type(maintain_integrity).
action_label(maintain_integrity, 'Maintain integrity').
action_type(maintain_records_of_data).
action_label(maintain_records_of_data, 'Maintain records of data').
action_type(make_available_necessary_information).
action_label(make_available_necessary_information, 'Provide necessary information').
action_type(make_payments).
action_label(make_payments, 'Make payments').
action_type(merge_company).
action_label(merge_company, 'Permission to merge company').
action_type(nao_pagar_subcontratado).
action_label(nao_pagar_subcontratado, 'Do not pay subcontractor').
action_type(not_access_bndes_confidential_info).
action_label(not_access_bndes_confidential_info, 'Do not access BNDES confidential info').
...
action_type(notify_unauthorized_use).
action_label(notify_unauthorized_use, 'Notify unauthorized use').
...
action_type(observe_legal_rep_confidentiality).
action_label(observe_legal_rep_confidentiality, 'Observe legal rep confidentiality').
action_type(observe_rules_confidentiality).
action_label(observe_rules_confidentiality, 'Observe rules confidentiality').
action_type(obtain_bndes_acquiescence).
action_label(obtain_bndes_acquiescence, 'Duty to obtain BNDES acquiescence').
...
action_type(omit_refusal_to_amend).
action_label(omit_refusal_to_amend, 'Omit refusal to amend').
...
action_label(penalty_for_not_providing_guarantee, 'Subject to penalty if guarantee not provided').
action_type(permited_mergers_continuations).
action_label(permited_mergers_continuations, 'Permited mergers continuations').
...
action_type(prove_no_discriminatory_sanction).
action_label(prove_no_discriminatory_sanction, 'Prove no discriminatory sanction').
...
action_type(provide_ethics_information).
action_label(provide_ethics_information, 'Provide ethics information').
action_type(provide_evidence_of_compliance).
action_label(provide_evidence_of_compliance, 'Duty to provide evidence').
action_type(provide_implementation_services).
action_label(provide_implementation_services, 'Provide implementation services').
action_type(provide_requested_info).
action_label(provide_requested_info, 'Provide requested information').
action_type(provide_telephony_services).
action_label(provide_telephony_services, 'Provide telephony services').
...
action_type(receive_executed_contract_subject).
action_label(receive_executed_contract_subject, 'Receive executed contract subject').
action_type(receive_guarantee).
action_label(receive_guarantee, 'Right to receive guarantee').
...
action_type(receive_notice_investigation).
action_label(receive_notice_investigation, 'Receive investigation notice').
...
action_type(receive_telephony_services).
action_label(receive_telephony_services, 'Receive telephony services').
action_type(rejeitar_documento_fiscal_fora_prazo).
action_label(rejeitar_documento_fiscal_fora_prazo, 'Reject late invoice').
...
action_label(repair_correct_object, 'Repair/correct object').
action_type(repair_damages_bndes_third_parties).
action_label(repair_damages_bndes_third_parties, 'Repair damages to BNDES/third parties').
action_type(report_advantages_discounts).
action_label(report_advantages_discounts, 'Report advantages discounts').
...
action_type(request_proof_no_discriminatory_sanction).
action_label(request_proof_no_discriminatory_sanction, 'Request proof of no sanction').
action_type(require_proof_regularity).
action_label(require_proof_regularity, 'Require proof of regularity').
action_type(return_bndes_materials).
action_label(return_bndes_materials, 'Return BNDES materials').
action_type(return_resources_revocar_profiles).
action_label(return_resources_revocar_profiles, 'Return resources, revoke profiles').
action_type(share_or_use_data_without_authorization).
action_label(share_or_use_data_without_authorization, 'Do not share or use data without authorization').
action_type(store_data_securely).
action_label(store_data_securely, 'Store data securely').
action_type(subcontract_training).
action_label(subcontract_training, 'Permission to subcontract training').
action_type(subjection_access_central_bank).
action_label(subjection_access_central_bank, 'Subjection Access Central Bank').
action_type(subjection_vistories_contract_execution).
action_label(subjection_vistories_contract_execution, 'Subjection Vistories Contract Execution').
action_type(submit_to_rio_de_janeiro_court).
action_label(submit_to_rio_de_janeiro_court, 'Submit to Rio de Janeiro court').
action_type(suffer_penalty_for_non_execution).
action_label(suffer_penalty_for_non_execution, 'Suffer penalty for non-execution').

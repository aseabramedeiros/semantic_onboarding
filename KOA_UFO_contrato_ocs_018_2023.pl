% ===== KOA Combined Output | contract_id: contrato_ocs_018_2023 =====
...
% UFO-only grounding generated from: KOA_Contrato_OCS_018_2023_-_Asper.pl
% contract_id: contrato_ocs_018_2023

instance_of(contrato_ocs_018_2023, legal_service_agreement).

instance_of(banco_nacional_de_desenvolvimento_economico_e_social_bndes, agent).
instance_of(asper_tecnologia_ltda, agent).

plays_role(banco_nacional_de_desenvolvimento_economico_e_social_bndes, service_customer_role, contrato_ocs_018_2023).
plays_role(asper_tecnologia_ltda, hired_service_provider_role, contrato_ocs_018_2023).

clause_of(clausula_primeira_objeto, contrato_ocs_018_2023).
clause_of(clausula_segunda_vigencia, contrato_ocs_018_2023).
clause_of(clausula_terceira_local_prazo_condicoes_execucao_objeto, contrato_ocs_018_2023).
clause_of(clausula_quarta_niveis_servico, contrato_ocs_018_2023).
clause_of(clausula_quinta_recebimento_objeto, contrato_ocs_018_2023).
clause_of(clausula_sexta_preco, contrato_ocs_018_2023).
clause_of(clausula_setima_pagamento, contrato_ocs_018_2023).
clause_of(clausula_oitava_equilibrio_economico_financeiro_contrato, contrato_ocs_018_2023).
clause_of(clausula_decima_garantia_contratual, contrato_ocs_018_2023).
clause_of(clausula_decima_primeira_obrigações_contratado, contrato_ocs_018_2023).
clause_of(clausula_decima_segunda_conduta_etica_contratado_bndes, contrato_ocs_018_2023).
clause_of(clausula_decima_terceira_sigilo_informacoes, contrato_ocs_018_2023).
clause_of(clausula_decima_quarta_acesso_protecao_dados_pessoais, contrato_ocs_018_2023).
clause_of(clausula_decima_quinta_obrigações_bndes, contrato_ocs_018_2023).
clause_of(clausula_decima_sexta_equidade_genero_valorizacao_diversidade, contrato_ocs_018_2023).
clause_of(clausula_decima_setima_cessao_de_contrato_ou_de_credito_sucessao_contratual_e_subcontratacao, contrato_ocs_018_2023).
clause_of(clausula_decima_oitava_penalidades, contrato_ocs_018_2023).
clause_of(clausula_decima_nona_alteracoes_contratuais, contrato_ocs_018_2023).
clause_of(clausula_vigesima_extincao_do_contrato, contrato_ocs_018_2023).
clause_of(clausula_vigesima_primeira_disposicoes_finais, contrato_ocs_018_2023).
clause_of(clausula_vigesima_segunda_foro, contrato_ocs_018_2023).
clause_of(clausula_nona_matriz_riscos, contrato_ocs_018_2023).

legal_relation_instance(clausula_primeira_objeto, duty_to_act, asper_tecnologia_ltda, provide_software_subscription).
legal_relation_instance(clausula_primeira_objeto, duty_to_act, asper_tecnologia_ltda, implement_software).
legal_relation_instance(clausula_primeira_objeto, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, receive_software_services).
legal_relation_instance(clausula_primeira_objeto, right_to_action, asper_tecnologia_ltda, receive_payment_for_services).
legal_relation_instance(clausula_segunda_vigencia, duty_to_act, asper_tecnologia_ltda, apresentar_manifestacao_sobre_prorrogacao).
legal_relation_instance(clausula_segunda_vigencia, duty_to_act, asper_tecnologia_ltda, comunicar_interesse_prorrogacao).
legal_relation_instance(clausula_segunda_vigencia, subjection, asper_tecnologia_ltda, sujeicao_as_penalidades).
legal_relation_instance(clausula_terceira_local_prazo_condicoes_execucao_objeto, duty_to_act, asper_tecnologia_ltda, execute_contract_object_according_to_specifications).
...
legal_relation_instance(clausula_quarta_niveis_servico, duty_to_act, asper_tecnologia_ltda, execute_services_according_to_standards).
...
legal_relation_instance(clausula_quarta_niveis_servico, subjection, asper_tecnologia_ltda, be_subject_to_price_reduction_indexes).
...
legal_relation_instance(clausula_quarta_niveis_servico, subjection, asper_tecnologia_ltda, be_subject_to_penalties).
...
legal_relation_instance(clausula_sexta_preco, no_right_to_action, asper_tecnologia_ltda, demand_indemnification).
legal_relation_instance(clausula_sexta_preco, duty_to_act, asper_tecnologia_ltda, bear_cost_quantification_error).
legal_relation_instance(clausula_sexta_preco, subjection, asper_tecnologia_ltda, accept_price_reduction_partial_execution).
legal_relation_instance(clausula_sexta_preco, right_to_action, asper_tecnologia_ltda, receive_payment).
...
legal_relation_instance(clausula_setima_pagamento, right_to_action, asper_tecnologia_ltda, receive_payment).
legal_relation_instance(clausula_setima_pagamento, duty_to_omit, banco_nacional_de_desenvolvimento_economico_e_social_bndes, omit_direct_payment).
legal_relation_instance(clausula_setima_pagamento, no_right_to_action, asper_tecnologia_ltda, claim_direct_payment).
legal_relation_instance(clausula_setima_pagamento, duty_to_act, asper_tecnologia_ltda, present_fiscal_document).
...
legal_relation_instance(clausula_setima_pagamento, duty_to_act, asper_tecnologia_ltda, reimburse_values).
legal_relation_instance(clausula_setima_pagamento, subjection, asper_tecnologia_ltda, payment_with_interest).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, asper_tecnologia_ltda, request_price_readjustment_revision).
...
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, right_to_action, asper_tecnologia_ltda, request_price_readjustment).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, right_to_action, asper_tecnologia_ltda, request_price_revision).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, asper_tecnologia_ltda, present_information_requested_by_bndes).
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, asper_tecnologia_ltda, provide_contractual_guarantee).
legal_relation_instance(clausula_decima_garantia_contratual, subjection, asper_tecnologia_ltda, penalty_for_not_providing_guarantee).
...
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, asper_tecnologia_ltda, obtain_new_guarantee).
...
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, asper_tecnologia_ltda, obtain_guarantor_consent).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, asper_tecnologia_ltda, maintain_conditions_of_habilitation).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, asper_tecnologia_ltda, communicate_penalty_impeding_contract).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, asper_tecnologia_ltda, repair_defects).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, asper_tecnologia_ltda, repair_damages).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, asper_tecnologia_ltda, pay_taxes).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, asper_tecnologia_ltda, assume_full_responsibility).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, asper_tecnologia_ltda, provide_exclusion_from_simples_nacional).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, asper_tecnologia_ltda, allow_inspections).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, asper_tecnologia_ltda, obey_instructions_and_procedures).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, asper_tecnologia_ltda, designate_representative).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, asper_tecnologia_ltda, maintain_integrity_public_private_relations).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_omit, asper_tecnologia_ltda, not_offer_undue_advantage).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_omit, asper_tecnologia_ltda, prevent_employee_favoritism).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_omit, asper_tecnologia_ltda, not_allocate_family_members).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, asper_tecnologia_ltda, comply_with_bndes_policies).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, asper_tecnologia_ltda, adopt_sustainable_practices).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, asper_tecnologia_ltda, comply_with_bndes_info_security_policy).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_omit, asper_tecnologia_ltda, not_access_confidential_info).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, asper_tecnologia_ltda, maintain_info_secrecy).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, asper_tecnologia_ltda, limit_info_access).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, asper_tecnologia_ltda, inform_violation_to_bndes).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, asper_tecnologia_ltda, return_bndes_material).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, asper_tecnologia_ltda, present_confidentiality_terms).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, asper_tecnologia_ltda, observe_confidentiality_term).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, asper_tecnologia_ltda, obtain_consent_data_subjects).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, asper_tecnologia_ltda, follow_bndes_instructions_data_treatment).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, asper_tecnologia_ltda, maintain_data_confidentiality).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, asper_tecnologia_ltda, inform_employees_about_data_clause).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, right_of_recourse_against_contractor).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, asper_tecnologia_ltda, provide_channel_for_data_subject_access).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, asper_tecnologia_ltda, inform_bndes_about_data_requests).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, asper_tecnologia_ltda, maintain_data_treatment_records).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, asper_tecnologia_ltda, communicate_data_breaches_to_bndes).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, asper_tecnologia_ltda, delete_data_at_end_of_contract).
...
legal_relation_instance(clausula_decima_quinta_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, provide_ethical_info).
...
legal_relation_instance(clausula_decima_quinta_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, provide_virtual_machines).
legal_relation_instance(clausula_decima_quinta_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, provide_technical_staff).
...
legal_relation_instance(clausula_decima_quinta_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, communicate_irregularities).
...
legal_relation_instance(clausula_decima_sexta_equidade_genero_valorizacao_diversidade, duty_to_act, asper_tecnologia_ltda, prove_absence_of_discriminatory_acts).
legal_relation_instance(clausula_decima_sexta_equidade_genero_valorizacao_diversidade, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, request_proof_absence_discrimination).
...
legal_relation_instance(clausula_decima_sexta_equidade_genero_valorizacao_diversidade, disability, asper_tecnologia_ltda, continue_contract_execution_after_discriminatory_act).
legal_relation_instance(clausula_decima_sexta_equidade_genero_valorizacao_diversidade, duty_to_act, asper_tecnologia_ltda, fulfill_imposed_reparation).
legal_relation_instance(clausula_decima_setima_cessao_de_contrato_ou_de_credito_sucessao_contratual_e_subcontratacao, no_right_to_action, asper_tecnologia_ltda, assign_contract).
legal_relation_instance(clausula_decima_setima_cessao_de_contrato_ou_de_credito_sucessao_contratual_e_subcontratacao, no_right_to_action, asper_tecnologia_ltda, issue_credit_title).
legal_relation_instance(clausula_decima_setima_cessao_de_contrato_ou_de_credito_sucessao_contratual_e_subcontratacao, duty_to_act, asper_tecnologia_ltda, present_supporting_documents).
legal_relation_instance(clausula_decima_setima_cessao_de_contrato_ou_de_credito_sucessao_contratual_e_subcontratacao, subjection, asper_tecnologia_ltda, be_responsible_for_subcontractor).
legal_relation_instance(clausula_decima_setima_cessao_de_contrato_ou_de_credito_sucessao_contratual_e_subcontratacao, duty_to_act, asper_tecnologia_ltda, present_confidentiality_terms).
legal_relation_instance(clausula_decima_setima_cessao_de_contrato_ou_de_credito_sucessao_contratual_e_subcontratacao, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, analyze_risks).
legal_relation_instance(clausula_decima_setima_cessao_de_contrato_ou_de_credito_sucessao_contratual_e_subcontratacao, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, analyze_subcontracting_risks).
legal_relation_instance(clausula_decima_oitava_penalidades, duty_to_omit, asper_tecnologia_ltda, omit_total_or_partial_non_performance).
legal_relation_instance(clausula_decima_oitava_penalidades, subjection, asper_tecnologia_ltda, be_subject_to_penalties).
legal_relation_instance(clausula_decima_oitava_penalidades, right_to_action, asper_tecnologia_ltda, request_reconsideration).
legal_relation_instance(clausula_decima_oitava_penalidades, right_to_action, asper_tecnologia_ltda, interpose_appeal).
...
legal_relation_instance(clausula_decima_oitava_penalidades, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, deduct_credit).
...
legal_relation_instance(clausula_decima_nona_alteracoes_contratuais, subjection, banco_nacional_de_desenvolvimento_economico_e_social_bndes, liable_for_damages_refusal_contract_alteration).
legal_relation_instance(clausula_decima_nona_alteracoes_contratuais, no_right_to_omission, banco_nacional_de_desenvolvimento_economico_e_social_bndes, omit_formalization_contract_alteration).
legal_relation_instance(clausula_vigesima_extincao_do_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_contract_consensually).
legal_relation_instance(clausula_vigesima_extincao_do_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, suspend_execution_of_contract).
legal_relation_instance(clausula_vigesima_extincao_do_contrato, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, notify_other_party_of_breach).
legal_relation_instance(clausula_vigesima_extincao_do_contrato, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_contract_due_to_breach).
legal_relation_instance(clausula_vigesima_extincao_do_contrato, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_contract_due_to_bankruptcy).
legal_relation_instance(clausula_vigesima_extincao_do_contrato, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_contract_due_to_suspension_of_licensing).
legal_relation_instance(clausula_vigesima_extincao_do_contrato, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_contract_due_to_lesive_act).
legal_relation_instance(clausula_vigesima_extincao_do_contrato, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_contract_due_to_dissolution).
legal_relation_instance(clausula_vigesima_extincao_do_contrato, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_contract_due_to_force_majeure).
legal_relation_instance(clausula_vigesima_extincao_do_contrato, duty_to_omit, banco_nacional_de_desenvolvimento_economico_e_social_bndes, omit_impeding_execution).
...
legal_relation_instance(clausula_vigesima_segunda_foro, subjection, banco_nacional_de_desenvolvimento_economico_e_social_bndes, be_subject_to_rio_de_janeiro_forum).
legal_relation_instance(clausula_vigesima_segunda_foro, no_right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, sue_in_another_forum).
legal_relation_instance(clausula_nona_matriz_riscos, duty_to_act, asper_tecnologia_ltda, respect_economic_financial_equilibrium_clause).
legal_relation_instance(clausula_nona_matriz_riscos, duty_to_omit, asper_tecnologia_ltda, not_add_events_supervenientes_allocated_in_risk_matrix).
legal_relation_instance(clausula_nona_matriz_riscos, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, demand_respect_for_economic_financial_equilibrium_clause).
legal_relation_instance(clausula_nona_matriz_riscos, no_right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, no_right_to_add_events_supervenientes_allocated_in_risk_matrix).

% --- Action catalog (local to this contract grounding) ---
action_type(accept_price_reduction_partial_execution).
action_label(accept_price_reduction_partial_execution, 'Accept price reduction').
action_type(activate_elastic_stack).
action_label(activate_elastic_stack, 'Activate Elastic Stack').
...
action_label(analyze_risks, 'Analyze risks of corporate operations').
action_type(analyze_subcontracting_risks).
action_label(analyze_subcontracting_risks, 'Analyze risks of subcontracting').
...
action_label(apresentar_manifestacao_sobre_prorrogacao, 'Present manifestation on contract extension').
action_type(assign_contract).
action_label(assign_contract, 'No right to assign contract').
action_type(assist_contractual_transition).
action_label(assist_contractual_transition, 'Assist contractual transition').
action_type(assume_full_responsibility).
action_label(assume_full_responsibility, 'Assume full responsibility').
action_type(be_responsible_for_subcontractor).
action_label(be_responsible_for_subcontractor, 'Be responsible for subcontractor').
...
action_label(be_subject_to_price_reduction_indexes, 'Be subject to price reduction indexes').
action_type(be_subject_to_rio_de_janeiro_forum).
action_label(be_subject_to_rio_de_janeiro_forum, 'Be subject to Rio forum').
action_type(bear_cost_quantification_error).
action_label(bear_cost_quantification_error, 'Bear cost of error').
...
action_type(claim_direct_payment).
action_label(claim_direct_payment, 'No right to claim direct payment').
action_type(communicate_data_breaches_to_bndes).
action_label(communicate_data_breaches_to_bndes, 'Communicate data breaches to BNDES').
...
action_type(communicate_penalty_impeding_contract).
action_label(communicate_penalty_impeding_contract, 'Communicate penalty impeding contract').
...
action_type(continue_contract_execution_after_discriminatory_act).
action_label(continue_contract_execution_after_discriminatory_act, 'Continue execution after discriminatory act').
...
action_type(deliver_implementation_plan).
action_label(deliver_implementation_plan, 'Deliver implementation plan').
action_type(demand_indemnification).
action_label(demand_indemnification, 'Demand indemnification').
action_type(demand_respect_for_economic_financial_equilibrium_clause).
action_label(demand_respect_for_economic_financial_equilibrium_clause, 'Demand respect for economic-financial equilibrium clause.').
...
action_label(demand_strict_compliance_after_omission, 'Demand compliance').
...
action_type(ensure_compliance_security_rules).
action_label(ensure_compliance_security_rules, 'Ensure compliance security rules').
action_type(execute_contract_object_according_to_specifications).
action_label(execute_contract_object_according_to_specifications, 'Execute contract object per specs').
...
action_label(expect_execution_per_specifications, 'Expect execution per specs').
...
action_label(follow_bndes_instructions_data_treatment, 'Follow BNDES instructions on data').
action_type(formalize_contract_alteration).
action_label(formalize_contract_alteration, 'Formalize contract alteration').
action_type(fulfill_imposed_reparation).
action_label(fulfill_imposed_reparation, 'Fulfill reparation').
...
action_type(implement_software).
action_label(implement_software, 'Implement software').
action_type(inform_bndes_about_data_requests).
action_label(inform_bndes_about_data_requests, 'Inform BNDES about data requests').
action_type(inform_email_and_website).
action_label(inform_email_and_website, 'Inform email and website').
action_type(inform_employees_about_data_clause).
action_label(inform_employees_about_data_clause, 'Inform employees about data clause').
action_type(inform_violation_to_bndes).
action_label(inform_violation_to_bndes, 'Inform violation to BNDES').
action_type(inspect_and_supervise).
action_label(inspect_and_supervise, 'Inspect and supervise').
...
action_type(liable_for_damages_refusal_contract_alteration).
action_label(liable_for_damages_refusal_contract_alteration, 'Liable for damages - refusal contract alteration').
...
action_label(make_payments_to_contracted_party, 'Make payments to contractor').
action_type(no_right_to_add_events_supervenientes_allocated_in_risk_matrix).
action_label(no_right_to_add_events_supervenientes_allocated_in_risk_matrix, 'No right to add events allocated in risk matrix.').
action_type(not_access_confidential_info).
action_label(not_access_confidential_info, 'Not access confidential info').
action_type(not_add_events_supervenientes_allocated_in_risk_matrix).
action_label(not_add_events_supervenientes_allocated_in_risk_matrix, 'Do not add events allocated in risk matrix.').
...
action_type(obtain_consent_data_subjects).
action_label(obtain_consent_data_subjects, 'Obtain data subject consent').
...
action_type(omit_direct_payment).
action_label(omit_direct_payment, 'Omit direct payment to subcontractor').
action_type(omit_formalization_contract_alteration).
action_label(omit_formalization_contract_alteration, 'Omit formalization contract alteration').
action_type(omit_impeding_execution).
action_label(omit_impeding_execution, 'Not impede execution').
...
action_type(payment_with_interest).
action_label(payment_with_interest, 'Subject to interest').
action_type(penalty_for_not_providing_guarantee).
action_label(penalty_for_not_providing_guarantee, 'Subject to penalty for not providing guarantee').
...
action_type(process_personal_data_from_licitation).
action_label(process_personal_data_from_licitation, 'Process personal data from licitation').
action_type(prove_absence_of_discriminatory_acts).
action_label(prove_absence_of_discriminatory_acts, 'Prove no discrimination').
action_type(provide_channel_for_data_subject_access).
action_label(provide_channel_for_data_subject_access, 'Provide channel for data access').
action_type(provide_contract_manager_info).
action_label(provide_contract_manager_info, 'Provide contract manager info').
action_type(provide_contractual_guarantee).
action_label(provide_contractual_guarantee, 'Provide contractual guarantee').
action_type(provide_ethical_info).
action_label(provide_ethical_info, 'Provide ethical info').
...
action_type(provide_software_subscription).
action_label(provide_software_subscription, 'Provide software subscription service').
action_type(provide_technical_staff).
action_label(provide_technical_staff, 'Provide technical staff').
action_type(provide_virtual_machines).
action_label(provide_virtual_machines, 'Provide virtual machines').
...
action_type(receive_software_services).
action_label(receive_software_services, 'Receive software services').
action_type(receive_virtual_machines).
action_label(receive_virtual_machines, 'Receive virtual machines').
action_type(reimburse_values).
action_label(reimburse_values, 'Reimburse values').
...
action_type(request_price_readjustment_revision).
action_label(request_price_readjustment_revision, 'Request price adjustment/revision').
action_type(request_price_revision).
action_label(request_price_revision, 'Request price revision').
action_type(request_proof_absence_discrimination).
action_label(request_proof_absence_discrimination, 'Request proof of no discrimination').
...
action_type(return_proportional_value).
action_label(return_proportional_value, 'Return proportional value').
action_type(return_resources).
action_label(return_resources, 'Return resources').
action_type(right_of_recourse_against_contractor).
action_label(right_of_recourse_against_contractor, 'Right of recourse against contractor').
action_type(sue_in_another_forum).
action_label(sue_in_another_forum, 'Sue in another forum').
action_type(sujeicao_as_penalidades).
action_label(sujeicao_as_penalidades, 'Subject to penalties').

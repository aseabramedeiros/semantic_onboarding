% ===== KOA Combined Output | contract_id: contrato_ocs_261_2020 =====
...
% UFO-only grounding generated from: KOA_Contrato_OCS_261_2020_-_Teletex_(Websphere).pl
% contract_id: contrato_ocs_261_2020

instance_of(contrato_ocs_261_2020, legal_service_agreement).

instance_of(banco_nacional_de_desenvolvimento_economico_e_social_bndes, agent).
instance_of(teletex_computadores_e_sistemas_ltda, agent).

plays_role(banco_nacional_de_desenvolvimento_economico_e_social_bndes, service_customer_role, contrato_ocs_261_2020).
plays_role(teletex_computadores_e_sistemas_ltda, hired_service_provider_role, contrato_ocs_261_2020).

clause_of(clausula_primeira_objeto, contrato_ocs_261_2020).
clause_of(clausula_segunda_vigencia, contrato_ocs_261_2020).
clause_of(clausula_terceira_local_prazo_condicoes_execucao_objeto, contrato_ocs_261_2020).
clause_of(clausula_quarta_niveis_servico, contrato_ocs_261_2020).
clause_of(clausula_quinta_recebimento_objeto, contrato_ocs_261_2020).
clause_of(clausula_sexta_preco, contrato_ocs_261_2020).
clause_of(clausula_setima_pagamento, contrato_ocs_261_2020).
clause_of(clausula_oitava_equilibrio_economico_financeiro_contrato, contrato_ocs_261_2020).
clause_of(clausula_decima_garantia_contratual, contrato_ocs_261_2020).
clause_of(clausula_decima_primeira_obrigações_contratada, contrato_ocs_261_2020).
clause_of(clausula_decima_segunda_conduta_etica_da_contratada_e_do_bndes, contrato_ocs_261_2020).
clause_of(clausula_decima_terceira_sigilo_das_informações, contrato_ocs_261_2020).
clause_of(clausula_decima_quarta_obrigações_do_bndes, contrato_ocs_261_2020).
clause_of(clausula_decima_quinta_cessão_de_contrato_ou_de_crédito_sucessão_contratual_e_subcontratação, contrato_ocs_261_2020).
clause_of(clausula_decima_sexta_penalidades, contrato_ocs_261_2020).
clause_of(clausula_decima_setima_alterações_contratuais, contrato_ocs_261_2020).
clause_of(clausula_decima_oitava_extinção_do_contrato, contrato_ocs_261_2020).
clause_of(clausula_decima_nona_disposições_finais, contrato_ocs_261_2020).
clause_of(clausula_vigésima_foro, contrato_ocs_261_2020).
clause_of(clausula_nona_matriz_riscos, contrato_ocs_261_2020).

legal_relation_instance(clausula_primeira_objeto, duty_to_act, teletex_computadores_e_sistemas_ltda, provide_technical_support).
...
legal_relation_instance(clausula_segunda_vigencia, duty_to_act, teletex_computadores_e_sistemas_ltda, inform_intention_not_to_renew).
legal_relation_instance(clausula_segunda_vigencia, subjection, teletex_computadores_e_sistemas_ltda, be_penalized_for_refusal_to_extend).
legal_relation_instance(clausula_segunda_vigencia, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, extend_contract_duration).
legal_relation_instance(clausula_terceira_local_prazo_condicoes_execucao_objeto, duty_to_act, teletex_computadores_e_sistemas_ltda, execute_service_according_to_specs).
legal_relation_instance(clausula_terceira_local_prazo_condicoes_execucao_objeto, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, expect_service_execution_according_to_specs).
legal_relation_instance(clausula_quarta_niveis_servico, duty_to_act, teletex_computadores_e_sistemas_ltda, execute_service_according_to_standards).
legal_relation_instance(clausula_quarta_niveis_servico, subjection, teletex_computadores_e_sistemas_ltda, be_subject_to_price_reduction).
...
legal_relation_instance(clausula_quarta_niveis_servico, subjection, teletex_computadores_e_sistemas_ltda, be_subject_to_penalties).
...
legal_relation_instance(clausula_sexta_preco, right_to_action, teletex_computadores_e_sistemas_ltda, receive_payment).
legal_relation_instance(clausula_sexta_preco, duty_to_act, teletex_computadores_e_sistemas_ltda, bear_costs).
legal_relation_instance(clausula_sexta_preco, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, reduce_values).
...
legal_relation_instance(clausula_setima_pagamento, duty_to_act, teletex_computadores_e_sistemas_ltda, present_fiscal_document).
...
legal_relation_instance(clausula_setima_pagamento, right_to_action, teletex_computadores_e_sistemas_ltda, receive_monthly_payment).
legal_relation_instance(clausula_setima_pagamento, right_to_action, teletex_computadores_e_sistemas_ltda, receive_payment_10_days).
legal_relation_instance(clausula_setima_pagamento, duty_to_omit, banco_nacional_de_desenvolvimento_economico_e_social_bndes, omit_discount_without_cause).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, teletex_computadores_e_sistemas_ltda, provide_information_for_price_reduction).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, no_right_to_action, teletex_computadores_e_sistemas_ltda, claim_retroactive_effects_after_deadline).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, right_to_action, teletex_computadores_e_sistemas_ltda, receive_payments_until_contract_termination).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, teletex_computadores_e_sistemas_ltda, present_information_for_revision).
...
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, right_to_action, teletex_computadores_e_sistemas_ltda, request_price_revision).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, right_to_action, teletex_computadores_e_sistemas_ltda, request_price_adjustment).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, teletex_computadores_e_sistemas_ltda, request_price_adjustment_revision).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, subjection, teletex_computadores_e_sistemas_ltda, negotiate_price_reduction).
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, teletex_computadores_e_sistemas_ltda, provide_contractual_guarantee).
...
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, teletex_computadores_e_sistemas_ltda, complement_or_replace_guarantee).
legal_relation_instance(clausula_decima_garantia_contratual, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, demand_complement_or_replacement_of_guarantee).
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, teletex_computadores_e_sistemas_ltda, obtain_guarantor_agreement).
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, teletex_computadores_e_sistemas_ltda, obtain_new_guarantee).
legal_relation_instance(clausula_decima_primeira_obrigações_contratada, duty_to_act, teletex_computadores_e_sistemas_ltda, maintain_qualification).
legal_relation_instance(clausula_decima_primeira_obrigações_contratada, duty_to_act, teletex_computadores_e_sistemas_ltda, communicate_penalty).
legal_relation_instance(clausula_decima_primeira_obrigações_contratada, duty_to_act, teletex_computadores_e_sistemas_ltda, repair_object).
legal_relation_instance(clausula_decima_primeira_obrigações_contratada, duty_to_act, teletex_computadores_e_sistemas_ltda, repair_damages).
legal_relation_instance(clausula_decima_primeira_obrigações_contratada, duty_to_act, teletex_computadores_e_sistemas_ltda, pay_taxes).
legal_relation_instance(clausula_decima_primeira_obrigações_contratada, duty_to_act, teletex_computadores_e_sistemas_ltda, exclude_simples_nacional).
legal_relation_instance(clausula_decima_primeira_obrigações_contratada, duty_to_act, teletex_computadores_e_sistemas_ltda, allow_inspections).
legal_relation_instance(clausula_decima_primeira_obrigações_contratada, duty_to_act, teletex_computadores_e_sistemas_ltda, obey_instructions).
legal_relation_instance(clausula_decima_primeira_obrigações_contratada, duty_to_act, teletex_computadores_e_sistemas_ltda, designate_representative).
legal_relation_instance(clausula_decima_primeira_obrigações_contratada, duty_to_act, teletex_computadores_e_sistemas_ltda, present_dif).
legal_relation_instance(clausula_decima_segunda_conduta_etica_da_contratada_e_do_bndes, duty_to_act, teletex_computadores_e_sistemas_ltda, prevent_undue_advantage).
legal_relation_instance(clausula_decima_segunda_conduta_etica_da_contratada_e_do_bndes, duty_to_act, teletex_computadores_e_sistemas_ltda, prevent_favoritism_bndes_employee).
legal_relation_instance(clausula_decima_segunda_conduta_etica_da_contratada_e_do_bndes, duty_to_act, teletex_computadores_e_sistemas_ltda, prevent_allocation_family_bndes).
legal_relation_instance(clausula_decima_segunda_conduta_etica_da_contratada_e_do_bndes, duty_to_act, teletex_computadores_e_sistemas_ltda, observe_bndes_ethics_code).
legal_relation_instance(clausula_decima_segunda_conduta_etica_da_contratada_e_do_bndes, duty_to_act, teletex_computadores_e_sistemas_ltda, adopt_environmental_sustainability_practices).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, teletex_computadores_e_sistemas_ltda, comply_with_bndes_security_policy).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_omit, teletex_computadores_e_sistemas_ltda, not_access_confidential_info).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, teletex_computadores_e_sistemas_ltda, maintain_confidentiality).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, teletex_computadores_e_sistemas_ltda, limit_access_to_professionals).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, teletex_computadores_e_sistemas_ltda, inform_bndes_of_breach).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, teletex_computadores_e_sistemas_ltda, return_bndes_property).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, teletex_computadores_e_sistemas_ltda, present_confidentiality_terms).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, teletex_computadores_e_sistemas_ltda, observe_confidentiality_term).
legal_relation_instance(clausula_decima_quarta_obrigações_do_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, make_payments_to_contracted_party).
legal_relation_instance(clausula_decima_quarta_obrigações_do_bndes, right_to_action, teletex_computadores_e_sistemas_ltda, receive_payments_from_bndes).
...
legal_relation_instance(clausula_decima_quarta_obrigações_do_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, provide_documents_to_contracted_party).
legal_relation_instance(clausula_decima_quarta_obrigações_do_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, provide_information_to_contracted_party).
legal_relation_instance(clausula_decima_quarta_obrigações_do_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, communicate_instructions_to_contracted_party).
legal_relation_instance(clausula_decima_quarta_obrigações_do_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, communicate_investigation_to_contracted_party).
legal_relation_instance(clausula_decima_quarta_obrigações_do_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, communicate_penalty_to_contracted_party).
legal_relation_instance(clausula_decima_quarta_obrigações_do_bndes, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, alter_contract_manager).
legal_relation_instance(clausula_decima_quarta_obrigações_do_bndes, subjection, teletex_computadores_e_sistemas_ltda, subjected_to_potential_penalty).
legal_relation_instance(clausula_decima_quinta_cessão_de_contrato_ou_de_crédito_sucessão_contratual_e_subcontratação, duty_to_omit, teletex_computadores_e_sistemas_ltda, omit_contract_assignment).
legal_relation_instance(clausula_decima_quinta_cessão_de_contrato_ou_de_crédito_sucessão_contratual_e_subcontratação, no_right_to_action, teletex_computadores_e_sistemas_ltda, no_right_to_assign_contract).
legal_relation_instance(clausula_decima_quinta_cessão_de_contrato_ou_de_crédito_sucessão_contratual_e_subcontratação, duty_to_omit, teletex_computadores_e_sistemas_ltda, omit_credit_issuance).
legal_relation_instance(clausula_decima_quinta_cessão_de_contrato_ou_de_crédito_sucessão_contratual_e_subcontratação, no_right_to_action, teletex_computadores_e_sistemas_ltda, no_right_to_issue_credit).
legal_relation_instance(clausula_decima_quinta_cessão_de_contrato_ou_de_crédito_sucessão_contratual_e_subcontratação, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, analyze_risks_of_contractual_change).
legal_relation_instance(clausula_decima_quinta_cessão_de_contrato_ou_de_crédito_sucessão_contratual_e_subcontratação, duty_to_omit, teletex_computadores_e_sistemas_ltda, omit_subcontracting).
legal_relation_instance(clausula_decima_quinta_cessão_de_contrato_ou_de_crédito_sucessão_contratual_e_subcontratação, no_right_to_action, teletex_computadores_e_sistemas_ltda, no_right_to_subcontract).
legal_relation_instance(clausula_decima_quinta_cessão_de_contrato_ou_de_crédito_sucessão_contratual_e_subcontratação, duty_to_omit, teletex_computadores_e_sistemas_ltda, omit_contractual_succession).
legal_relation_instance(clausula_decima_quinta_cessão_de_contrato_ou_de_crédito_sucessão_contratual_e_subcontratação, no_right_to_action, teletex_computadores_e_sistemas_ltda, no_right_to_contractual_succession).
legal_relation_instance(clausula_decima_sexta_penalidades, subjection, teletex_computadores_e_sistemas_ltda, be_subject_to_penalties).
legal_relation_instance(clausula_decima_sexta_penalidades, right_to_action, teletex_computadores_e_sistemas_ltda, defense_against_penalties).
...
legal_relation_instance(clausula_decima_sexta_penalidades, right_to_action, teletex_computadores_e_sistemas_ltda, lodge_appeal).
...
legal_relation_instance(clausula_decima_setima_alterações_contratuais, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, responder_danos_recusa_injustificada).
legal_relation_instance(clausula_decima_setima_alterações_contratuais, subjection, banco_nacional_de_desenvolvimento_economico_e_social_bndes, responder_danos_recusa).
legal_relation_instance(clausula_decima_setima_alterações_contratuais, duty_to_omit, banco_nacional_de_desenvolvimento_economico_e_social_bndes, omitir_modificacao_desnature).
legal_relation_instance(clausula_decima_setima_alterações_contratuais, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, formalizar_alteracao_imprescindivel).
legal_relation_instance(clausula_decima_setima_alterações_contratuais, permission_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, alterar_contrato_acordo).
...
legal_relation_instance(clausula_decima_oitava_extinção_do_contrato, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, notify_other_party_breach).
legal_relation_instance(clausula_decima_oitava_extinção_do_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, suspend_contract_execution).
legal_relation_instance(clausula_decima_oitava_extinção_do_contrato, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, require_other_party_compliance).
legal_relation_instance(clausula_decima_oitava_extinção_do_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, resolve_contract).
legal_relation_instance(clausula_decima_oitava_extinção_do_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_contract_failure_to_cure).
legal_relation_instance(clausula_decima_nona_disposições_finais, no_right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, waiver_strict_compliance).
legal_relation_instance(clausula_decima_nona_disposições_finais, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, exercise_rights_any_time).
legal_relation_instance(clausula_decima_nona_disposições_finais, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, determine_contract_interpretation).
legal_relation_instance(clausula_vigésima_foro, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, select_rio_de_janeiro_forum).
legal_relation_instance(clausula_vigésima_foro, no_right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, bring_dispute_outside_rio).
legal_relation_instance(clausula_nona_matriz_riscos, subjection, teletex_computadores_e_sistemas_ltda, bear_risks_allocated_in_matrix).

% --- Action catalog (local to this contract grounding) ---
action_type(adopt_environmental_sustainability_practices).
action_label(adopt_environmental_sustainability_practices, 'Adopt environmental sustainability practices').
...
action_type(be_penalized_for_refusal_to_extend).
action_label(be_penalized_for_refusal_to_extend, 'Be penalized for refusal to extend').
...
action_type(bear_costs).
action_label(bear_costs, 'Bear costs').
action_type(bear_risks_allocated_in_matrix).
action_label(bear_risks_allocated_in_matrix, 'Bear allocated risks').
action_type(bring_dispute_outside_rio).
action_label(bring_dispute_outside_rio, 'Bring dispute outside Rio').
action_type(claim_retroactive_effects_after_deadline).
action_label(claim_retroactive_effects_after_deadline, 'Claim retroactive effects after deadline').
...
action_type(communicate_penalty_to_contracted_party).
action_label(communicate_penalty_to_contracted_party, 'Communicate penalty').
...
action_type(defense_against_penalties).
action_label(defense_against_penalties, 'Right to defend').
action_type(demand_complement_or_replacement_of_guarantee).
action_label(demand_complement_or_replacement_of_guarantee, 'Demand guarantee complement/replacement').
...
action_type(determine_contract_interpretation).
action_label(determine_contract_interpretation, 'Power to contract interpretation').
...
action_label(execute_service_according_to_specs, 'Execute service per specs').
...
action_label(exercise_rights_any_time, 'Right to exercise rights').
action_type(expect_service_execution_according_to_specs).
action_label(expect_service_execution_according_to_specs, 'Expect service per specs').
action_type(extend_contract_duration).
action_label(extend_contract_duration, 'Extend contract duration').
action_type(formalizar_alteracao_imprescindivel).
action_label(formalizar_alteracao_imprescindivel, 'Formalize essential change').
action_type(guarantee_no_infringement).
action_label(guarantee_no_infringement, 'Guarantee no infringement').
action_type(inform_bndes_of_breach).
action_label(inform_bndes_of_breach, 'Inform BNDES of breach').
action_type(inform_contact_details).
action_label(inform_contact_details, 'Inform contact details').
action_type(inform_intention_not_to_renew).
action_label(inform_intention_not_to_renew, 'Inform intention not to renew').
action_type(limit_access_to_professionals).
action_label(limit_access_to_professionals, 'Limit access to professionals').
action_type(lodge_appeal).
action_label(lodge_appeal, 'Lodge appeal').
...
action_type(no_right_to_issue_credit).
action_label(no_right_to_issue_credit, 'No right to issue credit').
...
action_type(notify_other_party_breach).
action_label(notify_other_party_breach, 'Notify of breach').
...
action_type(omit_discount_without_cause).
action_label(omit_discount_without_cause, 'Omit discount without cause').
action_type(omit_subcontracting).
action_label(omit_subcontracting, 'Omit subcontracting').
action_type(omitir_modificacao_desnature).
action_label(omitir_modificacao_desnature, 'Do not denature contract').
...
action_type(present_information_for_revision).
action_label(present_information_for_revision, 'Present information for revision').
action_type(prevent_allocation_family_bndes).
action_label(prevent_allocation_family_bndes, 'Prevent allocate family BNDES').
action_type(prevent_favoritism_bndes_employee).
action_label(prevent_favoritism_bndes_employee, 'Prevent favoritism BNDES employee').
...
action_label(provide_information_for_price_reduction, 'Provide info for price reduction').
...
action_label(receber_objeto, 'Right to receive object').
...
action_type(receive_payment_10_days).
action_label(receive_payment_10_days, 'Receive payment in 10 days').
action_type(receive_payments_from_bndes).
action_label(receive_payments_from_bndes, 'Receive payments').
action_type(receive_payments_until_contract_termination).
action_label(receive_payments_until_contract_termination, 'Receive payments until term').
action_type(receive_technical_support).
action_label(receive_technical_support, 'Receive technical support').
action_type(reduce_values).
action_label(reduce_values, 'Reduce values').
...
action_label(request_price_adjustment_revision, 'Request price adj/rev').
...
action_type(require_other_party_compliance).
action_label(require_other_party_compliance, 'Require compliance').
action_type(resolve_contract).
action_label(resolve_contract, 'Resolve contract').
action_type(responder_danos_recusa).
action_label(responder_danos_recusa, 'Be liable for damage').
action_type(responder_danos_recusa_injustificada).
action_label(responder_danos_recusa_injustificada, 'Claim damages for refusal').
action_type(return_bndes_property).
action_label(return_bndes_property, 'Return BNDES property').
action_type(select_rio_de_janeiro_forum).
action_label(select_rio_de_janeiro_forum, 'Select Rio de Janeiro forum').
action_type(stipulate_service_standards).
action_label(stipulate_service_standards, 'Stipulate service standards').
action_type(subjected_to_potential_penalty).
action_label(subjected_to_potential_penalty, 'Subject to penalty').
...
action_type(terminate_contract_failure_to_cure).
action_label(terminate_contract_failure_to_cure, 'Terminate contract').
action_type(waiver_strict_compliance).
action_label(waiver_strict_compliance, 'No right to waiver of compliance').

% ===== 3) Original Contract ABox =====
contract(contrato_ocs_261_2020).
contract_metadata(contrato_ocs_261_2020, numero_ocs, '261/2020').
contract_metadata(contrato_ocs_261_2020, numero_sap, '4400004461').
contract_metadata(contrato_ocs_261_2020, tipo_contrato, 'CONTRATO DE PRESTAÇÃO DE SERVIÇO').
contract_metadata(contrato_ocs_261_2020, partes, ['BANCO NACIONAL DE DESENVOLVIMENTO ECONÔMICO E SOCIAL – BNDES', 'TELETEX COMPUTADORES E SISTEMAS LTDA.']).
contract_metadata(contrato_ocs_261_2020, contratante, 'BANCO NACIONAL DE DESENVOLVIMENTO ECONÔMICO E SOCIAL – BNDES').
contract_metadata(contrato_ocs_261_2020, contratado, 'TELETEX COMPUTADORES E SISTEMAS LTDA.').
contract_metadata(contrato_ocs_261_2020, cnpj_contratante, '33.657.248/0001-89').
contract_metadata(contrato_ocs_261_2020, cnpj_contratado, '79.345.583/0001-42').
contract_metadata(contrato_ocs_261_2020, procedimento_licitatorio, 'Pregão Eletrônico nº 52/2020').
contract_metadata(contrato_ocs_261_2020, data_autorizacao, '25/11/2020').
contract_metadata(contrato_ocs_261_2020, ip_ati_degat, '11/2020').
contract_metadata(contrato_ocs_261_2020, data_ip_ati_degat, '19/11/2020').
contract_metadata(contrato_ocs_261_2020, rubrica_orcamentaria, '3101700021').
contract_metadata(contrato_ocs_261_2020, centro_custo, 'BN00004000 – CC TI1').
contract_metadata(contrato_ocs_261_2020, lei_aplicavel, 'Lei nº 13.303/2016').
contract_metadata(contrato_ocs_261_2020, regulamento, 'Regulamento de Formalização, Execução e Fiscalização dos Contratos Administrativos do Sistema BNDES').
contract_clause(contrato_ocs_261_2020, clausula_primeira_objeto, 'CLÁUSULA PRIMEIRA – OBJETO', 'O presente Contrato tem por objeto a contratação do serviço de suporte técnico e atualização de software dos produtos IBM (ITEM I) e HCL Technologies (ITEM II) que compõem a Plataforma de Integração Tecnológica do BNDES, conforme especificações constantes do Termo de Referência e da Proposta apresentada pela CONTRATADA, respectivamente, Anexos I e II deste Contrato.').
contract_clause(contrato_ocs_261_2020, clausula_segunda_vigencia, 'CLÁUSULA SEGUNDA – VIGÊNCIA', 'O presente Contrato terá duração de 24 (vinte e quatro) meses, a contar da data de sua assinatura, podendo ser prorrogado, mediante aditivo contratual, por períodos sucessivos, até o limite total de 60 (sessenta) meses, observando-se que alguns produtos só terão os serviços de suporte e atualização iniciados no dia 30/06/2021, conforme previsto no Termo de Referência.  Parágrafo Primeiro Até 90 (noventa) dias antes do término de cada período de vigência contratual, cabe ao CONTRATADO comunicar ao Gestor do Contrato, por escrito, o seu propósito de não prorrogar a vigência por um novo período, sob pena de se presumir a sua anuência em celebrar o aditivo de prorrogação.  Parágrafo Segundo Caso o CONTRATADO se recuse a celebrar aditivo contratual de prorrogação, tendo antes manifestado sua intenção de prorrogar o Contrato ou deixado de manifestar seu propósito de não prorrogar, nos termos do Parágrafo Primeiro desta Cláusula, ficará sujeito às penalidades previstas na Cláusula de Penalidades deste Contrato.').

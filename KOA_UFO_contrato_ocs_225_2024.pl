% ===== KOA Combined Output | contract_id: contrato_ocs_225_2024 =====
...
% UFO-only grounding generated from: KOA_Contrato_OCS_225_2024_-_Logicallis_Plataforma_de_Dados.pl
% contract_id: contrato_ocs_225_2024

instance_of(contrato_ocs_225_2024, legal_service_agreement).

instance_of(banco_nacional_de_desenvolvimento_economico_e_social_bndes, agent).
instance_of(ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, agent).

plays_role(banco_nacional_de_desenvolvimento_economico_e_social_bndes, service_customer_role, contrato_ocs_225_2024).
plays_role(ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, hired_service_provider_role, contrato_ocs_225_2024).

clause_of(clausula_primeira_objeto, contrato_ocs_225_2024).
clause_of(clausula_segunda_vigencia, contrato_ocs_225_2024).
clause_of(clausula_terceira_local_prazo_condicoes_execucao_objeto, contrato_ocs_225_2024).
clause_of(clausula_quarta_niveis_servico, contrato_ocs_225_2024).
clause_of(clausula_quinto_recebimento_objeto, contrato_ocs_225_2024).
clause_of(clausula_sexta_preco, contrato_ocs_225_2024).
clause_of(clausula_setima_pagamento, contrato_ocs_225_2024).
clause_of(clausula_oitava_equilibrio_economico_financeiro_contrato, contrato_ocs_225_2024).
clause_of(clausula_decima_garantia_contratual, contrato_ocs_225_2024).
clause_of(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, contrato_ocs_225_2024).
clause_of(clausula_decima_quinta_obrigacoes_do_bndes, contrato_ocs_225_2024).
clause_of(clausula_decima_sexta_equidade_de_genero_e_valorizacao_da_diversidade, contrato_ocs_225_2024).
clause_of(clausula_decima_setima_cessao_contrato_credito_sucessao_subcontratacao, contrato_ocs_225_2024).
clause_of(clausula_decima_oitava_penalidades, contrato_ocs_225_2024).
clause_of(clausula_decima_nona_alteracoes_contratuais, contrato_ocs_225_2024).
clause_of(clausula_vigesima_extincao_contrato, contrato_ocs_225_2024).
clause_of(clausula_vigesima_primeira_disposicoes_finais, contrato_ocs_225_2024).
clause_of(clausula_vigesima_segunda_foro, contrato_ocs_225_2024).
clause_of(clausula_nona_matriz_riscos, contrato_ocs_225_2024).
clause_of(clausula_decima_primeira_obrigacoes_contratado, contrato_ocs_225_2024).
clause_of(clausula_decima_segunda_conduta_etica_contratado_bndes, contrato_ocs_225_2024).
clause_of(clausula_decima_terceira_sigilo_informacoes, contrato_ocs_225_2024).

legal_relation_instance(clausula_primeira_objeto, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, provide_cloud_data_platform).
legal_relation_instance(clausula_primeira_objeto, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, receive_cloud_data_platform).
legal_relation_instance(clausula_primeira_objeto, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, provide_implementation_support_updates).
legal_relation_instance(clausula_primeira_objeto, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, provide_cloud_credits).
legal_relation_instance(clausula_primeira_objeto, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, use_cloud_credits).
legal_relation_instance(clausula_primeira_objeto, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, receive_implementation_support_updates).
legal_relation_instance(clausula_primeira_objeto, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, provide_analysis_and_consumption_management).
legal_relation_instance(clausula_primeira_objeto, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, receive_analysis_and_consumption_management).
legal_relation_instance(clausula_segunda_vigencia, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, apresentar_manifestacao_sobre_prorrogacao).
legal_relation_instance(clausula_segunda_vigencia, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, comunicar_interesse_prorrogacao).
legal_relation_instance(clausula_segunda_vigencia, power, unknown, prorrogar_contrato).
legal_relation_instance(clausula_segunda_vigencia, subjection, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, sujeitar_se_penalidades).
legal_relation_instance(clausula_segunda_vigencia, right_to_omission, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, recusar_celebrar_aditivo).
legal_relation_instance(clausula_terceira_local_prazo_condicoes_execucao_objeto, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, execute_object_according_specifications).
...
legal_relation_instance(clausula_quarta_niveis_servico, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, execute_services_according_to_standards).
...
legal_relation_instance(clausula_quarta_niveis_servico, subjection, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, be_subject_to_price_reduction_indices).
legal_relation_instance(clausula_quinto_recebimento_objeto, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, effect_object_receipt).
legal_relation_instance(clausula_quinto_recebimento_objeto, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, effect_object_receipt).
legal_relation_instance(clausula_sexta_preco, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, bear_burden_quantification_error).
legal_relation_instance(clausula_sexta_preco, subjection, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, subject_to_price_reduction).
legal_relation_instance(clausula_sexta_preco, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, execute_contract_object).
...
legal_relation_instance(clausula_setima_pagamento, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, bndes_make_payment).
legal_relation_instance(clausula_setima_pagamento, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, present_fiscal_document).
legal_relation_instance(clausula_setima_pagamento, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, provide_required_info_on_invoice).
legal_relation_instance(clausula_setima_pagamento, right_to_action, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, receive_payment).
...
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, demand_economic_financial_equilibrium).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, right_to_action, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, request_price_readjustment).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, initiate_price_review).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, right_to_action, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, request_price_review).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, present_information_requested_by_bndes).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, request_price_adjustment_or_review_before_contract_end).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, analyze_price_readjustment_review_request).
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, provide_contractual_guarantee).
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, obtain_guarantor_assent).
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, obtain_new_guarantee).
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, notify_guarantor).
...
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, complement_or_renew_guarantee).
legal_relation_instance(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, protect_fundamental_rights).
legal_relation_instance(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, follow_bndes_instructions).
legal_relation_instance(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, regress_against_contracted_party).
legal_relation_instance(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, provide_data_access_system).
legal_relation_instance(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, inform_bndes_of_requests).
legal_relation_instance(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, maintain_treatment_records).
legal_relation_instance(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, communicate_data_incident).
legal_relation_instance(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, eliminate_personal_data).
legal_relation_instance(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, request_additional_personal_data).
legal_relation_instance(clausula_decima_quarta_acesso_e_protecao_de_dados_pessoais, permission_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, use_collected_data).
legal_relation_instance(clausula_decima_quinta_obrigacoes_do_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, make_payments_to_contracted_party).
legal_relation_instance(clausula_decima_quinta_obrigacoes_do_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, designate_contract_manager).
legal_relation_instance(clausula_decima_quinta_obrigacoes_do_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, designate_substitute_contract_manager).
legal_relation_instance(clausula_decima_quinta_obrigacoes_do_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, designate_contract_auditor).
legal_relation_instance(clausula_decima_quinta_obrigacoes_do_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, designate_receiving_committee).
legal_relation_instance(clausula_decima_quinta_obrigacoes_do_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, provide_contracted_access_to_ethical_code).
legal_relation_instance(clausula_decima_quinta_obrigacoes_do_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, provide_necessary_information).
legal_relation_instance(clausula_decima_quinta_obrigacoes_do_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, communicate_instructions_or_procedures).
legal_relation_instance(clausula_decima_quinta_obrigacoes_do_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, communicate_opening_administrative_procedure).
legal_relation_instance(clausula_decima_quinta_obrigacoes_do_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, communicate_application_of_penalty).
legal_relation_instance(clausula_decima_sexta_equidade_de_genero_e_valorizacao_da_diversidade, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, provide_proof_of_no_discrimination).
legal_relation_instance(clausula_decima_sexta_equidade_de_genero_e_valorizacao_da_diversidade, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, request_proof_of_no_discrimination).
legal_relation_instance(clausula_decima_sexta_equidade_de_genero_e_valorizacao_da_diversidade, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, suspend_contract_execution).
legal_relation_instance(clausula_decima_sexta_equidade_de_genero_e_valorizacao_da_diversidade, permission_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, suspend_contract_execution).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_subcontratacao, duty_to_omit, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, not_assign_contract).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_subcontratacao, no_right_to_action, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, assign_contract).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_subcontratacao, duty_to_omit, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, issue_credit_title).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_subcontratacao, no_right_to_action, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, issue_credit_title).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_subcontratacao, duty_to_omit, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, subcontract_contract_execution).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_subcontratacao, no_right_to_action, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, subcontract_contract_execution).
legal_relation_instance(clausula_decima_setima_cessao_contrato_credito_sucessao_subcontratacao, permission_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, corporate_restructuring).
legal_relation_instance(clausula_decima_oitava_penalidades, subjection, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, subjected_to_penalties).
...
legal_relation_instance(clausula_decima_oitava_penalidades, right_to_action, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, request_reconsideration_or_appeal).
legal_relation_instance(clausula_decima_oitava_penalidades, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, deduct_fines_and_damages).
legal_relation_instance(clausula_decima_oitava_penalidades, duty_to_omit, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, omit_total_or_partial_failure).
legal_relation_instance(clausula_decima_oitava_penalidades, duty_to_omit, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, omit_disobeying_bndes_requirement).
legal_relation_instance(clausula_decima_oitava_penalidades, duty_to_omit, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, omit_legal_obligation_infraction).
legal_relation_instance(clausula_decima_oitava_penalidades, duty_to_omit, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, omit_unjustified_delay).
...
legal_relation_instance(clausula_decima_nona_alteracoes_contratuais, no_right_to_omission, banco_nacional_de_desenvolvimento_economico_e_social_bndes, omit_contract_alteration_when_required).
...
legal_relation_instance(clausula_decima_nona_alteracoes_contratuais, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, compensate_for_refusal).
...
legal_relation_instance(clausula_vigesima_extincao_contrato, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, notify_breaching_party).
...
legal_relation_instance(clausula_vigesima_extincao_contrato, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_contract_breach).
...
legal_relation_instance(clausula_vigesima_segunda_foro, no_right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, litigate_in_other_court).
legal_relation_instance(clausula_nona_matriz_riscos, duty_to_omit, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, omit_to_request_additives_for_allocated_risks).
legal_relation_instance(clausula_nona_matriz_riscos, no_right_to_action, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, no_right_to_request_additives_for_allocated_risks).
legal_relation_instance(clausula_nona_matriz_riscos, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, respect_economic_financial_balance_clause).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, maintain_qualification).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, communicate_penalty).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, repair_object).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, repair_damages).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, pay_taxes).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, assume_tax_responsibility).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, providenciar_exclusao_simples).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, permit_inspections).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, obey_instructions).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, designate_representative).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_omit, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, omit_improper_advantage).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_omit, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, omit_favor_bndes_employee).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_omit, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, omit_allocate_bndes_family).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, observe_ethics_policy).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, inform_bndes_conflict).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, notify_bndes_investigation).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, take_measures_to_prevent_corruption).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, adopt_sustainability_practices).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, comply_with_bndes_info_security_policy).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_omit, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, not_access_confidential_information).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, maintain_confidentiality).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, limit_access_to_info).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, inform_bndes_of_security_breach).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, return_bndes_property_upon_termination).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_omit, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, not_use_confidential_info_after_termination).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, present_confidentiality_terms).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, ptls_servicos_de_tecnologia_e_assessoria_tecnica_ltda, observe_confidentiality_term).
...
action_type(analyze_price_readjustment_review_request).
action_label(analyze_price_readjustment_review_request, 'Analyze price adjustment/review request').
...
action_label(apply_penalty_for_failure_to_provide_guarantee, 'Apply penalty for failing to guarantee').
...
action_label(apresentar_manifestacao_sobre_prorrogacao, 'Present views on contract extension').
action_type(assign_contract).
action_label(assign_contract, 'Assign contract').
action_type(assume_tax_responsibility).
action_label(assume_tax_responsibility, 'Assume tax responsibility').
...
action_label(be_subject_to_price_reduction_indices, 'Be subject to price reduction indices').
action_type(be_subject_to_rio_de_janeiro_court).
action_label(be_subject_to_rio_de_janeiro_court, 'Subject to RJ court').
...
action_type(bndes_make_payment).
action_label(bndes_make_payment, 'Make payment').
...
action_type(communicate_opening_administrative_procedure).
action_label(communicate_opening_administrative_procedure, 'Communicate administrative procedure').
action_type(communicate_penalty).
action_label(communicate_penalty, 'Communicate penalty').
action_type(compensate_for_refusal).
action_label(compensate_for_refusal, 'Compensate for refusal to alter').
...
action_label(corporate_restructuring, 'Restructure corporate').
action_type(deduct_fines_and_damages).
action_label(deduct_fines_and_damages, 'Deduct fines/damages').
...
action_label(demand_economic_financial_equilibrium, 'Demand economic equilibrium').
...
action_label(execute_object_according_specifications, 'Execute object according to specifications').
...
action_label(expect_execution_according_specifications, 'Expect execution as specified').
...
action_type(guarantee_copyrights).
action_label(guarantee_copyrights, 'Guarantee copyrights').
action_type(inform_bndes_conflict).
action_label(inform_bndes_conflict, 'Inform BNDES of conflict').
...
action_type(initiate_price_review).
action_label(initiate_price_review, 'Initiate price review').
action_type(issue_credit_title).
action_label(issue_credit_title, 'Not issue credit title').
...
action_label(litigate_in_other_court, 'No right to other court').
...
action_type(maintain_treatment_records).
action_label(maintain_treatment_records, 'Maintain treatment records').
action_type(make_payments_to_contracted_party).
action_label(make_payments_to_contracted_party, 'Make payments').
action_type(no_right_to_request_additives_for_allocated_risks).
action_label(no_right_to_request_additives_for_allocated_risks, 'No right to request additives for allocated risks').
...
action_label(not_use_confidential_info_after_termination, 'Do not use info after termination.').
...
action_type(obtain_guarantor_assent).
action_label(obtain_guarantor_assent, 'Obtain guarantor assent').
action_type(obtain_new_guarantee).
action_label(obtain_new_guarantee, 'Obtain new guarantee').
action_type(omit_allocate_bndes_family).
action_label(omit_allocate_bndes_family, 'Don\'t allocate BNDES family').
action_type(omit_contract_alteration_when_required).
action_label(omit_contract_alteration_when_required, 'No right to omit contract alteration').
action_type(omit_disobeying_bndes_requirement).
action_label(omit_disobeying_bndes_requirement, 'Omit disobeying BNDES requirement').
action_type(omit_favor_bndes_employee).
action_label(omit_favor_bndes_employee, 'Don\'t favor BNDES employee').
action_type(omit_improper_advantage).
action_label(omit_improper_advantage, 'Omit improper advantage').
action_type(omit_legal_obligation_infraction).
action_label(omit_legal_obligation_infraction, 'Omit legal obligation infraction').
action_type(omit_to_request_additives_for_allocated_risks).
action_label(omit_to_request_additives_for_allocated_risks, 'Omit to request additives for allocated risks').
action_type(omit_total_or_partial_failure).
action_label(omit_total_or_partial_failure, 'Omit total/partial failure').
action_type(omit_unjustified_delay).
action_label(omit_unjustified_delay, 'Omit unjustified delay').
...
action_label(present_information_requested_by_bndes, 'Present info requested by BNDES').
action_type(prorrogar_contrato).
action_label(prorrogar_contrato, 'Extend contract duration').
action_type(protect_fundamental_rights).
action_label(protect_fundamental_rights, 'Protect fundamental rights').
action_type(provide_analysis_and_consumption_management).
action_label(provide_analysis_and_consumption_management, 'Provide analysis and consumption management').
action_type(provide_cloud_credits).
action_label(provide_cloud_credits, 'Provide cloud credits').
action_type(provide_cloud_data_platform).
action_label(provide_cloud_data_platform, 'Provide cloud data platform services').
action_type(provide_contracted_access_to_ethical_code).
action_label(provide_contracted_access_to_ethical_code, 'Provide access to ethical code').
...
action_type(provide_implementation_support_updates).
action_label(provide_implementation_support_updates, 'Provide implementation, support and updates').
action_type(provide_necessary_information).
action_label(provide_necessary_information, 'Provide necessary information').
action_type(provide_proof_of_no_discrimination).
action_label(provide_proof_of_no_discrimination, 'Provide proof of no discrimination').
action_type(provide_required_info_on_invoice).
action_label(provide_required_info_on_invoice, 'Provide info on invoice').
action_type(provide_risk_info).
action_label(provide_risk_info, 'Provide risk information').
action_type(providenciar_exclusao_simples).
action_label(providenciar_exclusao_simples, 'Arrange exclusion from Simples').
action_type(receive_analysis_and_consumption_management).
action_label(receive_analysis_and_consumption_management, 'Receive analysis and consumption management').
action_type(receive_cloud_data_platform).
action_label(receive_cloud_data_platform, 'Receive cloud data platform services').
action_type(receive_implementation_support_updates).
action_label(receive_implementation_support_updates, 'Receive implementation, support and updates').
action_type(receive_payment).
action_label(receive_payment, 'Receive Payment').
action_type(recusar_celebrar_aditivo).
action_label(recusar_celebrar_aditivo, 'Refuse to sign extension').
...
action_type(request_price_adjustment_or_review_before_contract_end).
action_label(request_price_adjustment_or_review_before_contract_end, 'Request price adjustment/review').
...
action_label(respect_economic_financial_balance_clause, 'Respect the economic-financial balance clause').
action_type(responsible_security_compliance).
action_label(responsible_security_compliance, 'Responsible security compliance').
action_type(return_bndes_property_upon_termination).
action_label(return_bndes_property_upon_termination, 'Return property upon termination.').
action_type(return_resources).
action_label(return_resources, 'Return resources').
action_type(subcontract_contract_execution).
action_label(subcontract_contract_execution, 'Not subcontract work').
...
action_type(sujeitar_se_penalidades).
action_label(sujeitar_se_penalidades, 'Subject to penalties').

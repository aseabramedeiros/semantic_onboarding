% ===== KOA Combined Output | contract_id: contrato_ocs_159_2021 =====
...
% UFO-only grounding generated from: KOA_Contrato_OCS_159_2021_-_IBM_Content_Manager.pl
% contract_id: contrato_ocs_159_2021

instance_of(contrato_ocs_159_2021, legal_service_agreement).

instance_of(banco_nacional_de_desenvolvimento_economico_e_social_bndes, agent).
instance_of(ibm_brasil_industria_maquinas_e_servicos_ltda, agent).

plays_role(banco_nacional_de_desenvolvimento_economico_e_social_bndes, service_customer_role, contrato_ocs_159_2021).
plays_role(ibm_brasil_industria_maquinas_e_servicos_ltda, hired_service_provider_role, contrato_ocs_159_2021).

clause_of(clausula_primeira_objeto, contrato_ocs_159_2021).
clause_of(clausula_segunda_vigencia, contrato_ocs_159_2021).
clause_of(clausula_terceira_local_prazo_condicoes_execucao_objeto, contrato_ocs_159_2021).
clause_of(clausula_quarta_niveis_servico, contrato_ocs_159_2021).
clause_of(clausula_quinto_recebimento_objeto, contrato_ocs_159_2021).
clause_of(clausula_sexta_preco, contrato_ocs_159_2021).
clause_of(clausula_setima_pagamento, contrato_ocs_159_2021).
clause_of(clausula_decima_primeira_obrigações_contratado, contrato_ocs_159_2021).
clause_of(clausula_decima_segunda_conduta_etica_do_contratado_e_do_bndes, contrato_ocs_159_2021).
clause_of(clausula_decima_terceira_sigilo_das_informações, contrato_ocs_159_2021).
clause_of(clausula_decima_quarta_acesso_protecao_dados_pessoais, contrato_ocs_159_2021).
clause_of(clausula_decima_quinta_obrigações_bndes, contrato_ocs_159_2021).
clause_of(clausula_decima_sexta_cessao_contrato_credito_sucessao_contratual_subcontratacao, contrato_ocs_159_2021).
clause_of(clausula_decima_setima_penalidades, contrato_ocs_159_2021).
clause_of(clausula_decima_oitava_alteracoes_contratuais, contrato_ocs_159_2021).
clause_of(clausula_decima_nona_extincao_contrato, contrato_ocs_159_2021).
clause_of(clausula_vigesima_disposicoes_finais, contrato_ocs_159_2021).
clause_of(clausula_vigesima_primeira_foro, contrato_ocs_159_2021).
clause_of(clausula_oitava_equilibrio_economico_financeiro_contrato, contrato_ocs_159_2021).
clause_of(clausula_nona_matriz_riscos, contrato_ocs_159_2021).
clause_of(clausula_decima_garantia_contratual, contrato_ocs_159_2021).

legal_relation_instance(clausula_primeira_objeto, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, provide_technical_support).
...
legal_relation_instance(clausula_segunda_vigencia, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, apresentar_manifestacao_sobre_prorrogacao).
legal_relation_instance(clausula_segunda_vigencia, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, comunicar_interesse_prorrogacao).
legal_relation_instance(clausula_segunda_vigencia, subjection, ibm_brasil_industria_maquinas_e_servicos_ltda, ficar_sujeito_penalidades_recusa_prorrogacao).
legal_relation_instance(clausula_segunda_vigencia, no_right_to_omission, ibm_brasil_industria_maquinas_e_servicos_ltda, no_right_to_omit_manifest_intention_not_extend).
legal_relation_instance(clausula_terceira_local_prazo_condicoes_execucao_objeto, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, execute_contract_object).
legal_relation_instance(clausula_terceira_local_prazo_condicoes_execucao_objeto, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, ensure_contract_object_execution).
legal_relation_instance(clausula_quarta_niveis_servico, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, execute_services_according_to_standards).
...
legal_relation_instance(clausula_quarta_niveis_servico, subjection, ibm_brasil_industria_maquinas_e_servicos_ltda, be_subject_to_price_reduction).
legal_relation_instance(clausula_quarta_niveis_servico, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, stipulate_quality_standards).
legal_relation_instance(clausula_quinto_recebimento_objeto, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, effect_receipt_of_object).
legal_relation_instance(clausula_quinto_recebimento_objeto, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, effect_receipt).
...
legal_relation_instance(clausula_sexta_preco, right_to_action, ibm_brasil_industria_maquinas_e_servicos_ltda, receive_payment).
legal_relation_instance(clausula_sexta_preco, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, bear_cost_of_quantification_error).
legal_relation_instance(clausula_sexta_preco, subjection, ibm_brasil_industria_maquinas_e_servicos_ltda, accept_reduced_payment_for_partial_execution).
legal_relation_instance(clausula_sexta_preco, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, reduce_payment_for_partial_execution).
legal_relation_instance(clausula_sexta_preco, no_right_to_action, ibm_brasil_industria_maquinas_e_servicos_ltda, receive_indemnification).
...
legal_relation_instance(clausula_setima_pagamento, right_to_action, ibm_brasil_industria_maquinas_e_servicos_ltda, receive_payment).
legal_relation_instance(clausula_setima_pagamento, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, present_fiscal_document).
legal_relation_instance(clausula_setima_pagamento, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, reject_out_of_time_documents).
legal_relation_instance(clausula_setima_pagamento, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, deduct_penalties).
...
legal_relation_instance(clausula_setima_pagamento, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, provide_documentation_tax_benefits).
legal_relation_instance(clausula_setima_pagamento, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, conform_iss_rules).
legal_relation_instance(clausula_setima_pagamento, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, comply_with_tax_laws).
legal_relation_instance(clausula_setima_pagamento, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, return_fiscal_document).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, maintain_conditions).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, notify_penalty).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, repair_defects).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, repair_damages).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, pay_charges_and_taxes).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, assume_full_responsibility).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, provide_exclusion_proof).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, allow_inspections).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, obey_instructions).
legal_relation_instance(clausula_decima_primeira_obrigações_contratado, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, designate_project_manager).
legal_relation_instance(clausula_decima_segunda_conduta_etica_do_contratado_e_do_bndes, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, maintain_integrity).
legal_relation_instance(clausula_decima_segunda_conduta_etica_do_contratado_e_do_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, maintain_integrity_bndes).
legal_relation_instance(clausula_decima_segunda_conduta_etica_do_contratado_e_do_bndes, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, act_in_good_faith).
legal_relation_instance(clausula_decima_segunda_conduta_etica_do_contratado_e_do_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, act_in_good_faith_bndes).
legal_relation_instance(clausula_decima_segunda_conduta_etica_do_contratado_e_do_bndes, duty_to_omit, ibm_brasil_industria_maquinas_e_servicos_ltda, not_offer_undue_advantage).
legal_relation_instance(clausula_decima_segunda_conduta_etica_do_contratado_e_do_bndes, duty_to_omit, ibm_brasil_industria_maquinas_e_servicos_ltda, prevent_favoritism).
legal_relation_instance(clausula_decima_segunda_conduta_etica_do_contratado_e_do_bndes, duty_to_omit, ibm_brasil_industria_maquinas_e_servicos_ltda, prevent_allocation_of_family_members).
legal_relation_instance(clausula_decima_segunda_conduta_etica_do_contratado_e_do_bndes, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, observe_bndes_policies).
legal_relation_instance(clausula_decima_segunda_conduta_etica_do_contratado_e_do_bndes, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, adopt_good_practices).
legal_relation_instance(clausula_decima_segunda_conduta_etica_do_contratado_e_do_bndes, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, remove_agents).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, comply_with_bndes_security_policy).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_omit, ibm_brasil_industria_maquinas_e_servicos_ltda, not_access_confidential_info_without_authorization).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, maintain_confidentiality).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, limit_information_access).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, report_breaches).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, return_materials_at_term).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_omit, ibm_brasil_industria_maquinas_e_servicos_ltda, not_use_confidential_info_after_contract).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, present_confidentiality_terms).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, observe_legal_representative_confidentiality_term).
...
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, follow_bndes_instructions).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, maintain_data_confidentiality).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, store_data_securely).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, inform_employees).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, provide_data_access_channel).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, inform_bndes_of_requests).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, maintain_data_processing_records).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, communicate_data_breaches).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, delete_personal_data).
...
legal_relation_instance(clausula_decima_quinta_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, designate_contract_supervisor).
legal_relation_instance(clausula_decima_quinta_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, provide_documents_on_request).
...
legal_relation_instance(clausula_decima_quinta_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, communicate_instructions_or_procedures).
legal_relation_instance(clausula_decima_quinta_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, communicate_investigation_and_provide_defense_period).
...
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_contratual_subcontratacao, duty_to_omit, ibm_brasil_industria_maquinas_e_servicos_ltda, omit_contract_assignment).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_contratual_subcontratacao, no_right_to_action, ibm_brasil_industria_maquinas_e_servicos_ltda, assign_contract).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_contratual_subcontratacao, duty_to_omit, ibm_brasil_industria_maquinas_e_servicos_ltda, omit_credit_assignment).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_contratual_subcontratacao, no_right_to_action, ibm_brasil_industria_maquinas_e_servicos_ltda, assign_credit).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_contratual_subcontratacao, duty_to_omit, ibm_brasil_industria_maquinas_e_servicos_ltda, omit_issue_credit_title).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_contratual_subcontratacao, no_right_to_action, ibm_brasil_industria_maquinas_e_servicos_ltda, issue_credit_title).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_contratual_subcontratacao, duty_to_omit, ibm_brasil_industria_maquinas_e_servicos_ltda, omit_subcontracting).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_contratual_subcontratacao, no_right_to_action, ibm_brasil_industria_maquinas_e_servicos_ltda, subcontract).
...
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_contratual_subcontratacao, subjection, ibm_brasil_industria_maquinas_e_servicos_ltda, obtain_bndes_approval).
legal_relation_instance(clausula_decima_setima_penalidades, subjection, ibm_brasil_industria_maquinas_e_servicos_ltda, be_subject_to_penalties).
...
legal_relation_instance(clausula_decima_setima_penalidades, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, request_reconsideration_or_appeal).
legal_relation_instance(clausula_decima_setima_penalidades, right_to_action, ibm_brasil_industria_maquinas_e_servicos_ltda, request_reconsideration_or_appeal).
...
legal_relation_instance(clausula_decima_oitava_alteracoes_contratuais, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, responder_por_danos).
legal_relation_instance(clausula_decima_oitava_alteracoes_contratuais, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, formalizar_alteracao).
legal_relation_instance(clausula_decima_oitava_alteracoes_contratuais, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, alegar_justo_motivo).
legal_relation_instance(clausula_decima_oitava_alteracoes_contratuais, power, unknown, formalizar_alteracoes_contratuais).
legal_relation_instance(clausula_decima_oitava_alteracoes_contratuais, permission_to_act, unknown, celebrar_por_meio_epistolar).
legal_relation_instance(clausula_decima_nona_extincao_contrato, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, notify_other_party_of_breach).
legal_relation_instance(clausula_decima_nona_extincao_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_contract_upon_written_authorization).
legal_relation_instance(clausula_decima_nona_extincao_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_contract_due_to_insolvency).
legal_relation_instance(clausula_decima_nona_extincao_contrato, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_contract_upon_breach).
...
legal_relation_instance(clausula_vigesima_disposicoes_finais, no_right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, renounce_rights).
legal_relation_instance(clausula_vigesima_disposicoes_finais, permission_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, enforce_obligations).
...
legal_relation_instance(clausula_vigesima_primeira_foro, no_right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, pursue_litigation_in_other_court).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, analyze_price_review_request).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, right_to_action, ibm_brasil_industria_maquinas_e_servicos_ltda, receive_full_payment_after_termination).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, right_to_action, ibm_brasil_industria_maquinas_e_servicos_ltda, request_price_review).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, analyze_price_review_request_within_timeframe).
legal_relation_instance(clausula_nona_matriz_riscos, duty_to_omit, ibm_brasil_industria_maquinas_e_servicos_ltda, omit_celebrating_additives).
legal_relation_instance(clausula_nona_matriz_riscos, no_right_to_action, ibm_brasil_industria_maquinas_e_servicos_ltda, no_right_to_celebrate_additives).
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, ibm_brasil_industria_maquinas_e_servicos_ltda, complement_or_renew_guarantee).
legal_relation_instance(clausula_decima_garantia_contratual, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, require_complement_or_renew_guarantee).

% --- Action catalog (local to this contract grounding) ---
action_type(accept_reduced_payment_for_partial_execution).
action_label(accept_reduced_payment_for_partial_execution, 'Accept reduced payment').
...
action_type(analyze_price_review_request).
action_label(analyze_price_review_request, 'Analyze price review request').
action_type(analyze_price_review_request_within_timeframe).
action_label(analyze_price_review_request_within_timeframe, 'Analyze price review request within timeframe').
...
action_type(attach_required_docs).
action_label(attach_required_docs, 'Attach required documents').
...
action_type(bear_cost_of_quantification_error).
action_label(bear_cost_of_quantification_error, 'Bear cost of quantification error').
action_type(celebrar_por_meio_epistolar).
action_label(celebrar_por_meio_epistolar, 'Celebrate epistolarily').
...
action_type(communicate_investigation_and_provide_defense_period).
action_label(communicate_investigation_and_provide_defense_period, 'Communicate investigation and give period for defense').
...
action_label(comply_with_bndes_security_policy, 'Comply with security policy').
action_type(comply_with_tax_laws).
action_label(comply_with_tax_laws, 'Comply with tax laws').
...
action_type(conform_iss_rules).
action_label(conform_iss_rules, 'Conform to ISS rules').
...
action_type(designate_project_manager).
action_label(designate_project_manager, 'Designate project manager').
...
action_type(ensure_contract_object_execution).
action_label(ensure_contract_object_execution, 'Ensure contract object execution').
action_type(execute_contract_object).
action_label(execute_contract_object, 'Execute contract object').
action_type(execute_contracted_services).
action_label(execute_contracted_services, 'Execute contracted services').
action_type(execute_services_according_to_standards).
action_label(execute_services_according_to_standards, 'Execute services as specified').
action_type(exercise_rights).
action_label(exercise_rights, 'Exercise rights').
action_type(ficar_sujeito_penalidades_recusa_prorrogacao).
action_label(ficar_sujeito_penalidades_recusa_prorrogacao, 'Subject to penalties for refusing extension').
action_type(follow_bndes_instructions).
action_label(follow_bndes_instructions, 'Follow BNDES instructions').
action_type(formalizar_alteracao).
action_label(formalizar_alteracao, 'Formalize alteration').
action_type(formalizar_alteracoes_contratuais).
action_label(formalizar_alteracoes_contratuais, 'Formalize contract changes').
action_type(impede_favorecimento).
action_label(impede_favorecimento, 'Prevent favoritism').
action_type(impose_penalties).
action_label(impose_penalties, 'Impose penalties').
action_type(inform_bndes).
action_label(inform_bndes, 'Inform BNDES').
...
action_type(interrupt_payment_deadline).
action_label(interrupt_payment_deadline, 'Interrupt payment deadline').
...
action_label(maintain_conditions, 'Maintain conditions of contract').
...
action_label(maintain_integrity, 'Maintain integrity in relations').
action_type(maintain_integrity_bndes).
action_label(maintain_integrity_bndes, 'Maintain integrity in relations').
...
action_type(no_right_to_omit_manifest_intention_not_extend).
action_label(no_right_to_omit_manifest_intention_not_extend, 'No right to omit manifestation against extending').
action_type(not_access_confidential_info_without_authorization).
action_label(not_access_confidential_info_without_authorization, 'Do not access confidential info').
...
action_type(notify_impactful_occurrences).
action_label(notify_impactful_occurrences, 'Notify impactful occurrences').
...
action_type(observe_legal_representative_confidentiality_term).
action_label(observe_legal_representative_confidentiality_term, 'Observe legal rep. term').
action_type(obtain_bndes_approval).
action_label(obtain_bndes_approval, 'Obtain BNDES approval').
action_type(omit_celebrating_additives).
action_label(omit_celebrating_additives, 'Omit celebrating additives').
...
action_type(present_service_proof).
action_label(present_service_proof, 'Present service proof').
...
action_type(provide_documentation_tax_benefits).
action_label(provide_documentation_tax_benefits, 'Provide tax benefit documentation').
action_type(provide_documents_on_request).
action_label(provide_documents_on_request, 'Provide documents on request').
...
action_type(pursue_litigation_in_other_court).
action_label(pursue_litigation_in_other_court, 'Pursue litigation in other court').
action_type(receive_full_payment_after_termination).
action_label(receive_full_payment_after_termination, 'Receive full payment after termination').
...
action_type(reduce_payment_for_partial_execution).
action_label(reduce_payment_for_partial_execution, 'Reduce payment').
...
action_type(renounce_rights).
action_label(renounce_rights, 'Cannot renounce rights by omission').
...
action_type(report_breaches).
action_label(report_breaches, 'Report breaches').
...
action_type(require_complement_or_renew_guarantee).
action_label(require_complement_or_renew_guarantee, 'Require complement or renew guarantee').
...
action_type(return_materials_at_term).
action_label(return_materials_at_term, 'Return materials at term').
...
action_type(stipulate_quality_standards).
action_label(stipulate_quality_standards, 'Stipulate quality standards').

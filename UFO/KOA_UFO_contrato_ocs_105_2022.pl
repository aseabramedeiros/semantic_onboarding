% ===== KOA Combined Output | contract_id: contrato_ocs_105_2022 =====
...
% UFO-only grounding generated from: KOA_Contrato_OCS_105_2022_-_SAP_Active_Attention.pl
% contract_id: contrato_ocs_105_2022

instance_of(contrato_ocs_105_2022, legal_service_agreement).

instance_of(banco_nacional_de_desenvolvimento_economico_e_social_bndes, agent).
instance_of(sap_brasil_ltda, agent).

plays_role(banco_nacional_de_desenvolvimento_economico_e_social_bndes, service_customer_role, contrato_ocs_105_2022).
plays_role(sap_brasil_ltda, hired_service_provider_role, contrato_ocs_105_2022).

clause_of(clausula_primeira_objeto, contrato_ocs_105_2022).
clause_of(clausula_segunda_vigencia, contrato_ocs_105_2022).
clause_of(clausula_terceira_local_prazo_condicoes_execucao_objeto, contrato_ocs_105_2022).
clause_of(clausula_quarta_niveis_servico, contrato_ocs_105_2022).
clause_of(clausula_quinta_recebimento_objeto, contrato_ocs_105_2022).
clause_of(clausula_sexta_preco, contrato_ocs_105_2022).
clause_of(clausula_setima_pagamento, contrato_ocs_105_2022).
clause_of(clausula_oitava_equilibrio_economico_financeiro_contrato, contrato_ocs_105_2022).
clause_of(clausula_decima_garantia_contratual, contrato_ocs_105_2022).
clause_of(clausula_decima_primeira_obrigações_contratada, contrato_ocs_105_2022).
clause_of(clausula_decima_segunda_conduta_ética_da_contratada_e_do_bndes, contrato_ocs_105_2022).
clause_of(clausula_decima_terceira_sigilo_das_informações, contrato_ocs_105_2022).
clause_of(clausula_decima_quarta_obrigações_bndes, contrato_ocs_105_2022).
clause_of(clausula_decima_quinta_cessão_contrato_credito_sucessão_subcontratação, contrato_ocs_105_2022).
clause_of(clausula_decima_sexta_penalidades, contrato_ocs_105_2022).
clause_of(clausula_decima_setima_alterações_contratuais, contrato_ocs_105_2022).
clause_of(clausula_decima_oitava_extinção_contrato, contrato_ocs_105_2022).
clause_of(clausula_decima_nona_disposições_finais, contrato_ocs_105_2022).
clause_of(clausula_vigésima_foro, contrato_ocs_105_2022).
clause_of(clausula_nona_matriz_riscos, contrato_ocs_105_2022).

legal_relation_instance(clausula_primeira_objeto, duty_to_act, sap_brasil_ltda, provide_premium_support_service).
legal_relation_instance(clausula_primeira_objeto, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, receive_premium_support_service).
...
legal_relation_instance(clausula_segunda_vigencia, duty_to_act, sap_brasil_ltda, inform_intention_not_to_extend).
legal_relation_instance(clausula_segunda_vigencia, subjection, sap_brasil_ltda, liable_for_penalties).
legal_relation_instance(clausula_terceira_local_prazo_condicoes_execucao_objeto, duty_to_act, sap_brasil_ltda, execute_service_according_to_proposal_and_project).
...
legal_relation_instance(clausula_quarta_niveis_servico, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, expect_service_execution_according_to_standards).
legal_relation_instance(clausula_quarta_niveis_servico, subjection, sap_brasil_ltda, be_subject_to_consequences_of_non_compliance).
...
legal_relation_instance(clausula_sexta_preco, subjection, sap_brasil_ltda, accept_price_reduction).
legal_relation_instance(clausula_sexta_preco, duty_to_act, sap_brasil_ltda, bear_costs_of_quantities_error).
legal_relation_instance(clausula_sexta_preco, duty_to_act, sap_brasil_ltda, execute_contract_object).
legal_relation_instance(clausula_sexta_preco, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, receive_executed_contract_object).
...
legal_relation_instance(clausula_setima_pagamento, duty_to_act, sap_brasil_ltda, send_fiscal_document).
legal_relation_instance(clausula_setima_pagamento, duty_to_omit, banco_nacional_de_desenvolvimento_economico_e_social_bndes, withhold_payment_for_divergences).
legal_relation_instance(clausula_setima_pagamento, right_to_action, sap_brasil_ltda, receive_payment).
legal_relation_instance(clausula_setima_pagamento, right_to_omission, banco_nacional_de_desenvolvimento_economico_e_social_bndes, not_pay_without_proper_document).
legal_relation_instance(clausula_setima_pagamento, subjection, sap_brasil_ltda, withholding_taxes).
...
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, right_to_action, sap_brasil_ltda, right_to_request_price_adjustment).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, right_to_action, sap_brasil_ltda, right_to_request_price_revision).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, right_to_initiate_price_revision).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, power_to_negotiate_price_reduction).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, sap_brasil_ltda, duty_to_request_price_adjustment).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, subjection, sap_brasil_ltda, subjection_to_loss_of_retroactive_effects).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, sap_brasil_ltda, duty_to_submit_revision_request).
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, sap_brasil_ltda, provide_contractual_guarantee).
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, sap_brasil_ltda, complement_or_substitute_guarantee).
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, sap_brasil_ltda, obtain_guarantor_agreement).
...
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, sap_brasil_ltda, obtain_new_guarantee).
legal_relation_instance(clausula_decima_garantia_contratual, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, extend_new_guarantee_period).
legal_relation_instance(clausula_decima_primeira_obrigações_contratada, duty_to_act, sap_brasil_ltda, maintain_qualification).
legal_relation_instance(clausula_decima_primeira_obrigações_contratada, duty_to_act, sap_brasil_ltda, communicate_penalty).
legal_relation_instance(clausula_decima_primeira_obrigações_contratada, duty_to_act, sap_brasil_ltda, repair_object).
legal_relation_instance(clausula_decima_primeira_obrigações_contratada, duty_to_act, sap_brasil_ltda, repair_damages).
legal_relation_instance(clausula_decima_primeira_obrigações_contratada, duty_to_act, sap_brasil_ltda, pay_taxes).
legal_relation_instance(clausula_decima_primeira_obrigações_contratada, duty_to_act, sap_brasil_ltda, provide_exclusion_simples_nacional).
legal_relation_instance(clausula_decima_primeira_obrigações_contratada, duty_to_act, sap_brasil_ltda, allow_inspections).
legal_relation_instance(clausula_decima_primeira_obrigações_contratada, duty_to_act, sap_brasil_ltda, obey_instructions).
legal_relation_instance(clausula_decima_primeira_obrigações_contratada, duty_to_act, sap_brasil_ltda, designate_representative).
legal_relation_instance(clausula_decima_primeira_obrigações_contratada, duty_to_act, sap_brasil_ltda, allow_access_central_bank).
legal_relation_instance(clausula_decima_segunda_conduta_ética_da_contratada_e_do_bndes, duty_to_act, sap_brasil_ltda, maintain_integrity_public_private).
legal_relation_instance(clausula_decima_segunda_conduta_ética_da_contratada_e_do_bndes, duty_to_act, sap_brasil_ltda, act_in_good_faith).
legal_relation_instance(clausula_decima_segunda_conduta_ética_da_contratada_e_do_bndes, duty_to_act, sap_brasil_ltda, adopt_good_environmental_practices).
legal_relation_instance(clausula_decima_segunda_conduta_ética_da_contratada_e_do_bndes, duty_to_omit, sap_brasil_ltda, not_offer_undue_advantages).
legal_relation_instance(clausula_decima_segunda_conduta_ética_da_contratada_e_do_bndes, duty_to_act, sap_brasil_ltda, prevent_employee_favoritism).
legal_relation_instance(clausula_decima_segunda_conduta_ética_da_contratada_e_do_bndes, duty_to_omit, sap_brasil_ltda, not_allocate_family_members).
legal_relation_instance(clausula_decima_segunda_conduta_ética_da_contratada_e_do_bndes, duty_to_act, sap_brasil_ltda, observe_bndes_ethics_code).
legal_relation_instance(clausula_decima_segunda_conduta_ética_da_contratada_e_do_bndes, duty_to_act, sap_brasil_ltda, immediately_remove_agents).
legal_relation_instance(clausula_decima_segunda_conduta_ética_da_contratada_e_do_bndes, duty_to_act, sap_brasil_ltda, communicate_facts_to_bndes).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, sap_brasil_ltda, adopt_technical_measures).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_omit, sap_brasil_ltda, not_access_confidential_information).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, sap_brasil_ltda, maintain_secrecy_of_information).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, sap_brasil_ltda, limit_access_to_information).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, sap_brasil_ltda, inform_violations_to_bndes).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, sap_brasil_ltda, return_materials_to_bndes).
legal_relation_instance(clausula_decima_terceira_sigilo_das_informações, duty_to_act, sap_brasil_ltda, observe_confidentiality_term).
...
legal_relation_instance(clausula_decima_quarta_obrigações_bndes, right_to_action, sap_brasil_ltda, receive_payments_from_bndes).
...
legal_relation_instance(clausula_decima_quarta_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, provide_ethical_code).
legal_relation_instance(clausula_decima_quarta_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, provide_necessary_info).
...
legal_relation_instance(clausula_decima_quarta_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, provide_contract_manager_info).
legal_relation_instance(clausula_decima_quarta_obrigações_bndes, right_to_action, sap_brasil_ltda, defend_against_misconduct_claims).
legal_relation_instance(clausula_decima_quinta_cessão_contrato_credito_sucessão_subcontratação, duty_to_omit, sap_brasil_ltda, omit_contract_assignment).
legal_relation_instance(clausula_decima_quinta_cessão_contrato_credito_sucessão_subcontratação, no_right_to_action, sap_brasil_ltda, no_right_to_assign_contract).
legal_relation_instance(clausula_decima_quinta_cessão_contrato_credito_sucessão_subcontratação, duty_to_omit, sap_brasil_ltda, omit_credit_assignment).
legal_relation_instance(clausula_decima_quinta_cessão_contrato_credito_sucessão_subcontratação, no_right_to_action, sap_brasil_ltda, no_right_to_assign_credit).
legal_relation_instance(clausula_decima_quinta_cessão_contrato_credito_sucessão_subcontratação, duty_to_omit, sap_brasil_ltda, omit_issuing_credit_title).
legal_relation_instance(clausula_decima_quinta_cessão_contrato_credito_sucessão_subcontratação, no_right_to_action, sap_brasil_ltda, no_right_to_issue_credit_title).
legal_relation_instance(clausula_decima_quinta_cessão_contrato_credito_sucessão_subcontratação, duty_to_omit, sap_brasil_ltda, omit_subcontracting).
legal_relation_instance(clausula_decima_quinta_cessão_contrato_credito_sucessão_subcontratação, no_right_to_action, sap_brasil_ltda, no_right_to_subcontract).
legal_relation_instance(clausula_decima_quinta_cessão_contrato_credito_sucessão_subcontratação, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, analyze_risks_from_contractual_change).
legal_relation_instance(clausula_decima_quinta_cessão_contrato_credito_sucessão_subcontratação, permission_to_act, sap_brasil_ltda, perform_merger_acquisition_spin_off).
...
legal_relation_instance(clausula_decima_sexta_penalidades, right_to_action, sap_brasil_ltda, present_defense).
legal_relation_instance(clausula_decima_sexta_penalidades, right_to_action, sap_brasil_ltda, interpose_appeal).
legal_relation_instance(clausula_decima_sexta_penalidades, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, ensure_administrative_procedure).
...
legal_relation_instance(clausula_decima_sexta_penalidades, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, deduct_from_credits).
legal_relation_instance(clausula_decima_setima_alterações_contratuais, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, execute_contract_amendment).
...
legal_relation_instance(clausula_decima_setima_alterações_contratuais, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, pay_damages_for_refusal).
legal_relation_instance(clausula_decima_oitava_extinção_contrato, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, notify_breach).
...
legal_relation_instance(clausula_decima_oitava_extinção_contrato, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_due_to_breach).
...
legal_relation_instance(clausula_decima_oitava_extinção_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_due_to_bndes_failure).
legal_relation_instance(clausula_decima_oitava_extinção_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_due_to_bankruptcy).
legal_relation_instance(clausula_decima_oitava_extinção_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_due_to_cessation).
legal_relation_instance(clausula_decima_oitava_extinção_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_due_to_force_majeure).
legal_relation_instance(clausula_decima_oitava_extinção_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_due_to_inexecution).
...
legal_relation_instance(clausula_decima_nona_disposições_finais, duty_to_omit, banco_nacional_de_desenvolvimento_economico_e_social_bndes, omit_renunciation).
legal_relation_instance(clausula_decima_nona_disposições_finais, no_right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, no_right_to_claim_waiver).
...
legal_relation_instance(clausula_vigésima_foro, no_right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, no_right_to_litigate_outside_rio_de_janeiro).
legal_relation_instance(clausula_nona_matriz_riscos, duty_to_omit, sap_brasil_ltda, omit_celebration_of_additives).
legal_relation_instance(clausula_nona_matriz_riscos, no_right_to_action, sap_brasil_ltda, no_right_to_celebrate_additives).
legal_relation_instance(clausula_nona_matriz_riscos, duty_to_omit, banco_nacional_de_desenvolvimento_economico_e_social_bndes, omit_celebration_of_additives_bndes).
legal_relation_instance(clausula_nona_matriz_riscos, no_right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, no_right_to_celebrate_additives_bndes).
...
action_type(allow_access_central_bank).
action_label(allow_access_central_bank, 'Allow access Central Bank').
action_type(allow_inspections).
action_label(allow_inspections, 'Allow inspections').
action_type(analyze_risks_from_contractual_change).
action_label(analyze_risks_from_contractual_change, 'Analyze risks from change').
action_type(apply_penalties).
action_label(apply_penalties, 'Apply penalties').
action_type(be_responsible_security).
action_label(be_responsible_security, 'Be responsible security').
action_type(be_subject_to_consequences_of_non_compliance).
action_label(be_subject_to_consequences_of_non_compliance, 'Subject to non-compliance consequences').
action_type(be_subject_to_instructions).
action_label(be_subject_to_instructions, 'Be subject to instructions').
...
action_label(be_subject_to_rio_de_janeiro_forum, 'Subject to Rio de Janeiro forum.').
action_type(bear_costs_of_quantities_error).
action_label(bear_costs_of_quantities_error, 'Bear costs of quantities error').
action_type(claim_damages_for_refusal).
action_label(claim_damages_for_refusal, 'Claim damages').
...
action_label(complement_or_substitute_guarantee, 'Complement or substitute guarantee').
action_type(deduct_from_credits).
action_label(deduct_from_credits, 'Deduct from credits').
action_type(defend_against_misconduct_claims).
action_label(defend_against_misconduct_claims, 'Right to defend against misconduct').
...
action_type(duty_to_request_price_adjustment).
action_label(duty_to_request_price_adjustment, 'Duty to request price adjustment').
action_type(duty_to_submit_revision_request).
action_label(duty_to_submit_revision_request, 'Duty to submit revision request').
action_type(effect_payment).
action_label(effect_payment, 'Effect payment').
action_type(ensure_administrative_procedure).
action_label(ensure_administrative_procedure, 'Ensure administrative procedure').
action_type(ensure_data_protection).
action_label(ensure_data_protection, 'Ensure data protection').
action_type(execute_contract_amendment).
action_label(execute_contract_amendment, 'Execute contract amendment').
action_type(execute_contract_object).
action_label(execute_contract_object, 'Execute contract object').
action_type(execute_service_according_to_proposal_and_project).
action_label(execute_service_according_to_proposal_and_project, 'Execute service according to proposal').
...
action_label(expect_service_execution_according_to_proposal, 'Expect service execution as per proposal').
action_type(expect_service_execution_according_to_standards).
action_label(expect_service_execution_according_to_standards, 'Expect service per standards').
...
action_type(extend_new_guarantee_period).
action_label(extend_new_guarantee_period, 'Extend new guarantee period').
...
action_type(immediately_remove_agents).
action_label(immediately_remove_agents, 'Immediately remove agents').
action_type(inform_intention_not_to_extend).
action_label(inform_intention_not_to_extend, 'Inform intention not to extend').
action_type(inform_violations_to_bndes).
action_label(inform_violations_to_bndes, 'Inform violations to BNDES').
action_type(interpose_appeal).
action_label(interpose_appeal, 'Interpose appeal').
action_type(liable_for_penalties).
action_label(liable_for_penalties, 'Liable for penalties').
...
action_type(meet_transition_requests).
action_label(meet_transition_requests, 'Meet transition requests').
...
action_type(no_right_to_celebrate_additives_bndes).
action_label(no_right_to_celebrate_additives_bndes, 'No right to celebrate additives').
action_type(no_right_to_claim_waiver).
action_label(no_right_to_claim_waiver, 'No right to claim waiver').
action_type(no_right_to_issue_credit_title).
action_label(no_right_to_issue_credit_title, 'No right to issue credit title').
action_type(no_right_to_litigate_outside_rio_de_janeiro).
action_label(no_right_to_litigate_outside_rio_de_janeiro, 'No right to litigate outside Rio.').
...
action_label(not_allocate_family_members, 'Do not allocate family members').
action_type(not_offer_undue_advantages).
action_label(not_offer_undue_advantages, 'Do not offer undue advantages').
action_type(not_pay_without_proper_document).
action_label(not_pay_without_proper_document, 'Right to not pay w/o proper document').
...
action_label(omit_celebration_of_additives, 'Omit celebrating additives').
action_type(omit_celebration_of_additives_bndes).
action_label(omit_celebration_of_additives_bndes, 'Omit celebrating additives').
...
action_type(omit_renunciation).
action_label(omit_renunciation, 'Omit renunciation of rights').
action_type(omit_subcontracting).
action_label(omit_subcontracting, 'Omit subcontracting').
action_type(pay_damages_for_refusal).
action_label(pay_damages_for_refusal, 'Pay damages').
action_type(pay_taxes).
action_label(pay_taxes, 'Pay taxes').
action_type(perform_merger_acquisition_spin_off).
action_label(perform_merger_acquisition_spin_off, 'Perform merger/acquisition/spin-off').
action_type(power_to_negotiate_price_reduction).
action_label(power_to_negotiate_price_reduction, 'Power to negotiate price reduction').
...
action_label(provide_contract_manager_info, 'Provide contract manager information').
action_type(provide_contractual_guarantee).
action_label(provide_contractual_guarantee, 'Provide contractual guarantee').
action_type(provide_ethical_code).
action_label(provide_ethical_code, 'Provide ethical code').
action_type(provide_exclusion_simples_nacional).
action_label(provide_exclusion_simples_nacional, 'Provide exclusion Simples Nacional').
action_type(provide_necessary_info).
action_label(provide_necessary_info, 'Provide necessary information').
action_type(provide_premium_support_service).
action_label(provide_premium_support_service, 'Provide premium support service').
action_type(receive_executed_contract_object).
action_label(receive_executed_contract_object, 'Receive executed contract object').
...
action_type(receive_premium_support_service).
action_label(receive_premium_support_service, 'Receive premium support service').
...
action_label(right_to_economic_financial_equilibrium, 'Right to financial equilibrium').
action_type(right_to_initiate_price_revision).
action_label(right_to_initiate_price_revision, 'Right to initiate price revision').
action_type(right_to_request_price_adjustment).
action_label(right_to_request_price_adjustment, 'Right to request price adjustment').
action_type(right_to_request_price_revision).
action_label(right_to_request_price_revision, 'Right to request price revision').
action_type(send_fiscal_document).
action_label(send_fiscal_document, 'Send fiscal document').
action_type(subjection_to_loss_of_retroactive_effects).
action_label(subjection_to_loss_of_retroactive_effects, 'Subjection to loss of retroactive effects').

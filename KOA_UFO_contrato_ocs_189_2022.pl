% ===== KOA Combined Output | contract_id: contrato_ocs_0189_2022 =====
...
% UFO-only grounding generated from: KOA_Contrato_OCS_189_2022_-_Algar_STFC_Unificado.pl
% contract_id: contrato_ocs_0189_2022

instance_of(contrato_ocs_0189_2022, legal_service_agreement).

instance_of(banco_nacional_de_desenvolvimento_economico_e_social_bndes, agent).
instance_of(algar_telecom_s_a, agent).

plays_role(banco_nacional_de_desenvolvimento_economico_e_social_bndes, service_customer_role, contrato_ocs_0189_2022).
plays_role(algar_telecom_s_a, hired_service_provider_role, contrato_ocs_0189_2022).

clause_of(clausula_primeira_objeto, contrato_ocs_0189_2022).
clause_of(clausula_segunda_vigencia, contrato_ocs_0189_2022).
clause_of(clausula_terceira_local_prazo_condicoes_execucao_objeto, contrato_ocs_0189_2022).
clause_of(clausula_quarta_niveis_servico, contrato_ocs_0189_2022).
clause_of(clausula_quinta_recebimento_objeto, contrato_ocs_0189_2022).
clause_of(clausula_sexta_preco, contrato_ocs_0189_2022).
clause_of(clausula_setima_pagamento, contrato_ocs_0189_2022).
clause_of(clausula_decima_primeira_conduta_etica_do_contratado_e_do_bndes, contrato_ocs_0189_2022).
clause_of(clausula_decima_segunda_sigilo_das_informações, contrato_ocs_0189_2022).
clause_of(clausula_decima_terceira_acesso_e_protecao_de_dados_pessoais, contrato_ocs_0189_2022).
clause_of(clausula_decima_quarta_obrigações_bndes, contrato_ocs_0189_2022).
clause_of(clausula_decima_sexta_cessao_contrato_credito_sucessao_subcontratacao, contrato_ocs_0189_2022).
clause_of(clausula_decima_setima_penalidades, contrato_ocs_0189_2022).
clause_of(clausula_decima_oitava_alteracoes_contratuais, contrato_ocs_0189_2022).
clause_of(clausula_decima_nona_extincao_contrato, contrato_ocs_0189_2022).
clause_of(clausula_vigesima_disposicoes_finais, contrato_ocs_0189_2022).
clause_of(clausula_vigesima_primeira_foro, contrato_ocs_0189_2022).
clause_of(clausula_oitava_equilibrio_economico_financeiro_contrato, contrato_ocs_0189_2022).
clause_of(clausula_nona_matriz_riscos, contrato_ocs_0189_2022).
clause_of(clausula_decima_obrigacoes_contratado, contrato_ocs_0189_2022).

legal_relation_instance(clausula_primeira_objeto, duty_to_act, algar_telecom_s_a, provide_fixed_switched_telephone_service).
legal_relation_instance(clausula_primeira_objeto, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, receive_fixed_switched_telephone_service).
legal_relation_instance(clausula_segunda_vigencia, duty_to_act, algar_telecom_s_a, apresentar_manifestacao_sobre_prorrogacao).
legal_relation_instance(clausula_segunda_vigencia, duty_to_act, algar_telecom_s_a, comunicar_interesse_quanto_a_prorrogacao).
legal_relation_instance(clausula_segunda_vigencia, subjection, algar_telecom_s_a, sujeito_as_penalidades).
legal_relation_instance(clausula_terceira_local_prazo_condicoes_execucao_objeto, duty_to_act, algar_telecom_s_a, execute_contract_object).
...
legal_relation_instance(clausula_quarta_niveis_servico, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, stipulate_service_levels).
...
legal_relation_instance(clausula_sexta_preco, no_right_to_action, algar_telecom_s_a, demand_indemnification_for_non_demand).
legal_relation_instance(clausula_sexta_preco, duty_to_act, algar_telecom_s_a, bear_onus_of_quantification_error).
legal_relation_instance(clausula_sexta_preco, subjection, algar_telecom_s_a, price_reduction_for_partial_execution).
legal_relation_instance(clausula_sexta_preco, duty_to_act, algar_telecom_s_a, execute_contract_object).
legal_relation_instance(clausula_sexta_preco, right_to_action, algar_telecom_s_a, receive_payment_for_execution).
...
legal_relation_instance(clausula_setima_pagamento, duty_to_act, algar_telecom_s_a, include_required_information).
legal_relation_instance(clausula_setima_pagamento, right_to_omission, banco_nacional_de_desenvolvimento_economico_e_social_bndes, omit_payment_if_document_not_presented).
legal_relation_instance(clausula_setima_pagamento, duty_to_act, algar_telecom_s_a, provide_digital_document).
legal_relation_instance(clausula_setima_pagamento, duty_to_act, algar_telecom_s_a, provide_supporting_documents).
...
legal_relation_instance(clausula_setima_pagamento, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, deduct_from_payment).
legal_relation_instance(clausula_decima_primeira_conduta_etica_do_contratado_e_do_bndes, duty_to_act, algar_telecom_s_a, prevent_undue_advantage).
legal_relation_instance(clausula_decima_primeira_conduta_etica_do_contratado_e_do_bndes, duty_to_omit, algar_telecom_s_a, not_offer_undue_advantage).
legal_relation_instance(clausula_decima_primeira_conduta_etica_do_contratado_e_do_bndes, duty_to_act, algar_telecom_s_a, prevent_employee_favored).
legal_relation_instance(clausula_decima_primeira_conduta_etica_do_contratado_e_do_bndes, duty_to_omit, algar_telecom_s_a, not_allow_employee_favored).
legal_relation_instance(clausula_decima_primeira_conduta_etica_do_contratado_e_do_bndes, duty_to_omit, algar_telecom_s_a, not_allocate_family_members).
legal_relation_instance(clausula_decima_primeira_conduta_etica_do_contratado_e_do_bndes, duty_to_act, algar_telecom_s_a, observe_ethics_policies).
legal_relation_instance(clausula_decima_primeira_conduta_etica_do_contratado_e_do_bndes, duty_to_act, algar_telecom_s_a, adopt_sustainable_practices).
legal_relation_instance(clausula_decima_primeira_conduta_etica_do_contratado_e_do_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, maintain_integrity).
legal_relation_instance(clausula_decima_primeira_conduta_etica_do_contratado_e_do_bndes, duty_to_act, algar_telecom_s_a, remove_agents).
legal_relation_instance(clausula_decima_primeira_conduta_etica_do_contratado_e_do_bndes, duty_to_act, algar_telecom_s_a, inform_bndes).
legal_relation_instance(clausula_decima_segunda_sigilo_das_informações, duty_to_act, algar_telecom_s_a, comply_with_information_security_directives).
legal_relation_instance(clausula_decima_segunda_sigilo_das_informações, duty_to_omit, algar_telecom_s_a, not_access_confidential_information_without_authorization).
legal_relation_instance(clausula_decima_segunda_sigilo_das_informações, duty_to_act, algar_telecom_s_a, maintain_confidentiality_of_information).
legal_relation_instance(clausula_decima_segunda_sigilo_das_informações, duty_to_act, algar_telecom_s_a, report_confidentiality_breaches).
legal_relation_instance(clausula_decima_segunda_sigilo_das_informações, duty_to_act, algar_telecom_s_a, return_materials_at_contract_end).
legal_relation_instance(clausula_decima_segunda_sigilo_das_informações, duty_to_omit, algar_telecom_s_a, not_use_confidential_information).
legal_relation_instance(clausula_decima_segunda_sigilo_das_informações, duty_to_act, algar_telecom_s_a, present_confidentiality_agreements).
legal_relation_instance(clausula_decima_segunda_sigilo_das_informações, duty_to_act, algar_telecom_s_a, observe_confidentiality_agreement_of_legal_representative).
legal_relation_instance(clausula_decima_segunda_sigilo_das_informações, duty_to_act, algar_telecom_s_a, limit_access_to_information).
legal_relation_instance(clausula_decima_terceira_acesso_e_protecao_de_dados_pessoais, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, protect_data_privacy_rights).
legal_relation_instance(clausula_decima_terceira_acesso_e_protecao_de_dados_pessoais, duty_to_act, algar_telecom_s_a, follow_bndes_instructions_data_processing).
legal_relation_instance(clausula_decima_terceira_acesso_e_protecao_de_dados_pessoais, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, right_of_recourse_data_breach).
...
legal_relation_instance(clausula_decima_terceira_acesso_e_protecao_de_dados_pessoais, duty_to_act, algar_telecom_s_a, inform_bndes_data_requests).
legal_relation_instance(clausula_decima_terceira_acesso_e_protecao_de_dados_pessoais, duty_to_act, algar_telecom_s_a, maintain_data_processing_records).
legal_relation_instance(clausula_decima_terceira_acesso_e_protecao_de_dados_pessoais, duty_to_act, algar_telecom_s_a, report_data_breach).
legal_relation_instance(clausula_decima_terceira_acesso_e_protecao_de_dados_pessoais, duty_to_act, algar_telecom_s_a, delete_data_after_contract).
legal_relation_instance(clausula_decima_terceira_acesso_e_protecao_de_dados_pessoais, permission_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, process_public_data).
legal_relation_instance(clausula_decima_terceira_acesso_e_protecao_de_dados_pessoais, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, collect_consent).
...
legal_relation_instance(clausula_decima_quarta_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, provide_documents_to_contracted_party).
legal_relation_instance(clausula_decima_quarta_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, make_information_available).
legal_relation_instance(clausula_decima_quarta_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, communicate_instructions_to_contracted_party).
legal_relation_instance(clausula_decima_quarta_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, communicate_opening_administrative_procedure).
legal_relation_instance(clausula_decima_quarta_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, communicate_application_penalty).
legal_relation_instance(clausula_decima_quarta_obrigações_bndes, right_to_action, algar_telecom_s_a, receive_payments_from_bndes).
legal_relation_instance(clausula_decima_quarta_obrigações_bndes, right_to_action, algar_telecom_s_a, request_documents_from_bndes).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_subcontratacao, duty_to_omit, algar_telecom_s_a, omit_contract_assignment).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_subcontratacao, no_right_to_action, algar_telecom_s_a, assign_contract).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_subcontratacao, duty_to_omit, algar_telecom_s_a, omit_credit_assignment).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_subcontratacao, no_right_to_action, algar_telecom_s_a, assign_credit).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_subcontratacao, duty_to_omit, algar_telecom_s_a, omit_issue_credit_title).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_subcontratacao, no_right_to_action, algar_telecom_s_a, issue_credit_title).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_subcontratacao, duty_to_act, algar_telecom_s_a, present_confidentiality_terms).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_subcontratacao, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, analyze_risks_and_prejudices).
legal_relation_instance(clausula_decima_setima_penalidades, subjection, algar_telecom_s_a, subjected_to_penalties).
...
legal_relation_instance(clausula_decima_setima_penalidades, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, deduct_amounts_owed).
legal_relation_instance(clausula_decima_oitava_alteracoes_contratuais, duty_to_omit, banco_nacional_de_desenvolvimento_economico_e_social_bndes, not_change_nature_contract).
legal_relation_instance(clausula_decima_oitava_alteracoes_contratuais, no_right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, change_nature_contract).
...
legal_relation_instance(clausula_decima_oitava_alteracoes_contratuais, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, formalize_contract_change).
...
legal_relation_instance(clausula_decima_oitava_alteracoes_contratuais, right_to_action, unknown, demand_compensation_for_damages).
...
legal_relation_instance(clausula_decima_nona_extincao_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, suspend_contract).
...
legal_relation_instance(clausula_decima_nona_extincao_contrato, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_contract_suspension).
...
legal_relation_instance(clausula_vigesima_disposicoes_finais, permission_to_omit, banco_nacional_de_desenvolvimento_economico_e_social_bndes, omit_enforcement).
...
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, right_to_action, algar_telecom_s_a, request_price_adjustment).
...
legal_relation_instance(clausula_decima_obrigacoes_contratado, duty_to_act, algar_telecom_s_a, communicate_imposition_of_penalty).
legal_relation_instance(clausula_decima_obrigacoes_contratado, duty_to_act, algar_telecom_s_a, repair_correct_remove_reconstruct_or_replace).
legal_relation_instance(clausula_decima_obrigacoes_contratado, duty_to_act, algar_telecom_s_a, repair_all_damages).
legal_relation_instance(clausula_decima_obrigacoes_contratado, duty_to_act, algar_telecom_s_a, pay_all_fees_and_taxes).
legal_relation_instance(clausula_decima_obrigacoes_contratado, duty_to_act, algar_telecom_s_a, assume_full_responsibility_for_any_burdens).
legal_relation_instance(clausula_decima_obrigacoes_contratado, duty_to_act, algar_telecom_s_a, provide_exclusion_from_simples_nacional).
legal_relation_instance(clausula_decima_obrigacoes_contratado, duty_to_act, algar_telecom_s_a, permit_inspections).
...
action_label(access_necessary_information, 'Access info').
...
action_label(be_responsible_for_safety_standards, 'Responsible for safety').
...
action_type(bear_onus_of_quantification_error).
action_label(bear_onus_of_quantification_error, 'Bear onus of quantification error').
action_type(change_nature_contract).
action_label(change_nature_contract, 'No right to change contract nature').
action_type(collect_consent).
action_label(collect_consent, 'Collect Consent').
action_type(communicate_application_penalty).
action_label(communicate_application_penalty, 'Communicate penalty').
...
action_label(communicate_opening_administrative_procedure, 'Communicate procedure opening').
action_type(compensate_damages).
action_label(compensate_damages, 'Compensate damages').
action_type(comply_with_information_security_directives).
action_label(comply_with_information_security_directives, 'Comply with security directives').
action_type(comunicar_interesse_quanto_a_prorrogacao).
action_label(comunicar_interesse_quanto_a_prorrogacao, 'Communicate interest in extension').
action_type(deduct_amounts_owed).
action_label(deduct_amounts_owed, 'Deduct amounts owed').
action_type(deduct_from_payment).
action_label(deduct_from_payment, 'Deduct from payment').
action_type(delete_data_after_contract).
action_label(delete_data_after_contract, 'Delete data after contract').
action_type(demand_compensation_for_damages).
action_label(demand_compensation_for_damages, 'Demand compensation').
action_type(demand_indemnification_for_non_demand).
action_label(demand_indemnification_for_non_demand, 'Demand indemnification for non-demand').
...
action_label(expect_execution_according_specifications, 'Expect execution according to specifications').
...
action_label(follow_bndes_instructions_data_processing, 'Follow BNDES instructions').
...
action_label(make_information_available, 'Make info available').
...
action_label(not_access_confidential_information_without_authorization, 'Do not access confidential info unauthorized').
action_type(not_allocate_family_members).
action_label(not_allocate_family_members, 'Not allocate family members').
action_type(not_allow_employee_favored).
action_label(not_allow_employee_favored, 'Not allow employee favored').
action_type(not_change_nature_contract).
action_label(not_change_nature_contract, 'Not change nature of contract').
...
action_label(not_use_confidential_information, 'Not use confidential info').
action_type(notify_in_case_of_breach).
action_label(notify_in_case_of_breach, 'Notify in case of breach').
action_type(obey_instructions_and_procedures).
action_label(obey_instructions_and_procedures, 'Obey instructions').
action_type(observe_confidentiality_agreement_of_legal_representative).
action_label(observe_confidentiality_agreement_of_legal_representative, 'Observe confidentiality agreement').
action_type(observe_ethics_policies).
action_label(observe_ethics_policies, 'Observe ethics policies').
...
action_type(omit_payment_if_document_not_presented).
action_label(omit_payment_if_document_not_presented, 'Omit payment if document late').
...
action_type(prevent_employee_favored).
action_label(prevent_employee_favored, 'Prevent employee favored').
...
action_label(price_reduction_for_partial_execution, 'Price reduction for partial execution').
action_type(process_public_data).
action_label(process_public_data, 'Process public data').
action_type(protect_data_privacy_rights).
action_label(protect_data_privacy_rights, 'Protect data privacy rights').
action_type(provide_data_access_channel).
action_label(provide_data_access_channel, 'Provide data access channel').
action_type(provide_digital_document).
action_label(provide_digital_document, 'Provide digital document').
...
action_type(provide_fixed_switched_telephone_service).
action_label(provide_fixed_switched_telephone_service, 'Provide fixed switched telephone service').
action_type(provide_supporting_documents).
action_label(provide_supporting_documents, 'Provide supporting documents').
action_type(receive_fixed_switched_telephone_service).
action_label(receive_fixed_switched_telephone_service, 'Receive fixed switched telephone service').
...
action_type(repair_all_damages).
action_label(repair_all_damages, 'Repair all damages').
...
action_label(request_additives_for_allocated_risks, 'No right to request additives for allocated risks').
action_type(request_documents_from_bndes).
action_label(request_documents_from_bndes, 'Request documents').

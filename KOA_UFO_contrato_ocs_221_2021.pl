% ===== KOA Combined Output | contract_id: contrato_ocs_221_2021 =====
...
% UFO-only grounding generated from: KOA_Contrato_OCS_221_2021_-_Intersoft_(Suporte_e_licenças_VMware).pl
% contract_id: contrato_ocs_221_2021

instance_of(contrato_ocs_221_2021, legal_service_agreement).

instance_of(banco_nacional_de_desenvolvimento_economico_e_social_bndes, agent).
instance_of(intersoft_solucoes_em_informatica_eireli, agent).

plays_role(banco_nacional_de_desenvolvimento_economico_e_social_bndes, service_customer_role, contrato_ocs_221_2021).
plays_role(intersoft_solucoes_em_informatica_eireli, hired_service_provider_role, contrato_ocs_221_2021).

clause_of(clausula_primeira_objeto, contrato_ocs_221_2021).
clause_of(clausula_segunda_vigencia, contrato_ocs_221_2021).
clause_of(clausula_terceira_local_prazo_condicoes_execucao_objeto, contrato_ocs_221_2021).
clause_of(clausula_quarta_niveis_servico, contrato_ocs_221_2021).
clause_of(clausula_quinta_recebimento_objeto, contrato_ocs_221_2021).
clause_of(clausula_sexta_preco, contrato_ocs_221_2021).
clause_of(clausula_setima_pagamento, contrato_ocs_221_2021).
clause_of(clausula_oitava_equilibrio_economico_financeiro_contrato, contrato_ocs_221_2021).
clause_of(clausula_decima_garantia_contratual, contrato_ocs_221_2021).
clause_of(clausula_decima_primeira_obrigacoes_contratado, contrato_ocs_221_2021).
clause_of(clausula_decima_segunda_conduta_etica_contratado_bndes, contrato_ocs_221_2021).
clause_of(clausula_decima_terceira_sigilo_informacoes, contrato_ocs_221_2021).
clause_of(clausula_decima_quarta_acesso_protecao_dados_pessoais, contrato_ocs_221_2021).
clause_of(clausula_decima_quinta_obrigações_bndes, contrato_ocs_221_2021).
clause_of(clausula_decima_sexta_cessao_contrato_credito_sucessao_contratual_subcontratacao, contrato_ocs_221_2021).
clause_of(clausula_decima_setima_penalidades, contrato_ocs_221_2021).
clause_of(clausula_decima_oitava_alteracoes_contratuais, contrato_ocs_221_2021).
clause_of(clausula_decima_nona_extincao_do_contrato, contrato_ocs_221_2021).
clause_of(clausula_vigesima_divulgacao_de_dados_pessoais, contrato_ocs_221_2021).
clause_of(clausula_vigesima_primeira_disposicoes_finais, contrato_ocs_221_2021).
clause_of(clausula_vigesima_segunda_foro, contrato_ocs_221_2021).
clause_of(clausula_nona_matriz_riscos, contrato_ocs_221_2021).

legal_relation_instance(clausula_primeira_objeto, duty_to_act, intersoft_solucoes_em_informatica_eireli, provide_vmware_licenses).
legal_relation_instance(clausula_primeira_objeto, duty_to_act, intersoft_solucoes_em_informatica_eireli, provide_tech_support).
legal_relation_instance(clausula_primeira_objeto, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, receive_vmware_licenses).
legal_relation_instance(clausula_primeira_objeto, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, receive_tech_support).
legal_relation_instance(clausula_segunda_vigencia, duty_to_act, intersoft_solucoes_em_informatica_eireli, present_manifestation_about_extension).
legal_relation_instance(clausula_segunda_vigencia, duty_to_act, intersoft_solucoes_em_informatica_eireli, communicate_interest_in_extension).
legal_relation_instance(clausula_segunda_vigencia, subjection, intersoft_solucoes_em_informatica_eireli, be_subject_to_penalties).
legal_relation_instance(clausula_terceira_local_prazo_condicoes_execucao_objeto, duty_to_act, intersoft_solucoes_em_informatica_eireli, execute_object_according_to_specifications).
...
legal_relation_instance(clausula_quarta_niveis_servico, duty_to_act, intersoft_solucoes_em_informatica_eireli, execute_services_according_to_standards).
...
legal_relation_instance(clausula_quarta_niveis_servico, subjection, intersoft_solucoes_em_informatica_eireli, be_subject_to_price_reduction).
...
legal_relation_instance(clausula_quinta_recebimento_objeto, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, receber_objeto).
legal_relation_instance(clausula_sexta_preco, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, pagar_ao_contratado).
legal_relation_instance(clausula_sexta_preco, right_to_action, intersoft_solucoes_em_informatica_eireli, receber_pagamento).
legal_relation_instance(clausula_sexta_preco, duty_to_act, intersoft_solucoes_em_informatica_eireli, arcar_com_equivo_no_dimensionamento).
legal_relation_instance(clausula_sexta_preco, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, parcialmente_executar_e_receber).
...
legal_relation_instance(clausula_setima_pagamento, right_to_action, intersoft_solucoes_em_informatica_eireli, receive_payment).
legal_relation_instance(clausula_setima_pagamento, duty_to_act, intersoft_solucoes_em_informatica_eireli, present_fiscal_document).
...
legal_relation_instance(clausula_setima_pagamento, duty_to_omit, banco_nacional_de_desenvolvimento_economico_e_social_bndes, omit_rejecting_on_time_document).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, intersoft_solucoes_em_informatica_eireli, request_price_adjustment_revision).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, duty_to_act, intersoft_solucoes_em_informatica_eireli, present_requested_information).
...
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, right_to_action, intersoft_solucoes_em_informatica_eireli, request_price_revision).
legal_relation_instance(clausula_oitava_equilibrio_economico_financeiro_contrato, right_to_action, intersoft_solucoes_em_informatica_eireli, request_price_adjustment).
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, intersoft_solucoes_em_informatica_eireli, provide_contractual_guarantee).
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, intersoft_solucoes_em_informatica_eireli, obtain_guarantor_consent).
legal_relation_instance(clausula_decima_garantia_contratual, duty_to_act, intersoft_solucoes_em_informatica_eireli, obtain_new_guarantee).
legal_relation_instance(clausula_decima_garantia_contratual, subjection, intersoft_solucoes_em_informatica_eireli, subject_to_penalty_for_not_providing_guarantee).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, intersoft_solucoes_em_informatica_eireli, maintain_conditions_of_qualification).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, intersoft_solucoes_em_informatica_eireli, communicate_penalty).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, intersoft_solucoes_em_informatica_eireli, repair_correct_remove_reconstruct_replace).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, intersoft_solucoes_em_informatica_eireli, repair_damages_to_bndes_or_third_parties).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, intersoft_solucoes_em_informatica_eireli, pay_taxes).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, intersoft_solucoes_em_informatica_eireli, assume_responsibility_for_charges).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, intersoft_solucoes_em_informatica_eireli, prove_exclusion_from_simples_nacional).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, intersoft_solucoes_em_informatica_eireli, obey_instructions_procedures).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, intersoft_solucoes_em_informatica_eireli, present_dif).
legal_relation_instance(clausula_decima_primeira_obrigacoes_contratado, duty_to_act, intersoft_solucoes_em_informatica_eireli, inform_toll_free_number).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, intersoft_solucoes_em_informatica_eireli, not_offer_undue_advantage).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, intersoft_solucoes_em_informatica_eireli, prevent_employee_favortism).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, intersoft_solucoes_em_informatica_eireli, prevent_family_allocation).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, intersoft_solucoes_em_informatica_eireli, observe_bndes_policies).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, intersoft_solucoes_em_informatica_eireli, adopt_sustainable_practices).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, intersoft_solucoes_em_informatica_eireli, remove_agents).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, intersoft_solucoes_em_informatica_eireli, communicate_facts_bndes).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, maintain_integrity).
legal_relation_instance(clausula_decima_segunda_conduta_etica_contratado_bndes, duty_to_act, intersoft_solucoes_em_informatica_eireli, maintain_integrity_contracted_party).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, intersoft_solucoes_em_informatica_eireli, comply_with_bndes_security_policy).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_omit, intersoft_solucoes_em_informatica_eireli, not_access_confidential_info).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, intersoft_solucoes_em_informatica_eireli, maintain_information_secrecy).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, intersoft_solucoes_em_informatica_eireli, inform_bndes_of_violation).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, intersoft_solucoes_em_informatica_eireli, deliver_materials_to_bndes).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_omit, intersoft_solucoes_em_informatica_eireli, not_use_confidential_info).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, intersoft_solucoes_em_informatica_eireli, limit_access_to_information).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, intersoft_solucoes_em_informatica_eireli, present_confidentiality_terms).
legal_relation_instance(clausula_decima_terceira_sigilo_informacoes, duty_to_act, intersoft_solucoes_em_informatica_eireli, observe_confidentiality_term).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, protect_privacy_rights).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, intersoft_solucoes_em_informatica_eireli, follow_bndes_instructions).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, intersoft_solucoes_em_informatica_eireli, maintain_confidentiality).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, intersoft_solucoes_em_informatica_eireli, store_data_securely).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, intersoft_solucoes_em_informatica_eireli, inform_employees_data_provisions).
...
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, intersoft_solucoes_em_informatica_eireli, provide_data_access_channel).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, intersoft_solucoes_em_informatica_eireli, inform_bndes_of_requests).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, intersoft_solucoes_em_informatica_eireli, maintain_records_of_data_processing).
legal_relation_instance(clausula_decima_quarta_acesso_protecao_dados_pessoais, duty_to_act, intersoft_solucoes_em_informatica_eireli, communicate_data_breaches).
legal_relation_instance(clausula_decima_quinta_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, make_payments_to_contractor).
legal_relation_instance(clausula_decima_quinta_obrigações_bndes, right_to_action, intersoft_solucoes_em_informatica_eireli, receive_payments).
...
legal_relation_instance(clausula_decima_quinta_obrigações_bndes, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, provide_ethics_documents).
...
legal_relation_instance(clausula_decima_quinta_obrigações_bndes, right_to_action, intersoft_solucoes_em_informatica_eireli, receive_necessary_information).
...
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_contratual_subcontratacao, duty_to_omit, intersoft_solucoes_em_informatica_eireli, omit_contract_assignment).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_contratual_subcontratacao, no_right_to_action, intersoft_solucoes_em_informatica_eireli, assign_contract).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_contratual_subcontratacao, duty_to_omit, intersoft_solucoes_em_informatica_eireli, omit_credit_assignment).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_contratual_subcontratacao, no_right_to_action, intersoft_solucoes_em_informatica_eireli, assign_credit).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_contratual_subcontratacao, duty_to_omit, intersoft_solucoes_em_informatica_eireli, omit_issue_credit_title).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_contratual_subcontratacao, no_right_to_action, intersoft_solucoes_em_informatica_eireli, issue_credit_title).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_contratual_subcontratacao, duty_to_omit, intersoft_solucoes_em_informatica_eireli, omit_subcontracting).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_contratual_subcontratacao, no_right_to_action, intersoft_solucoes_em_informatica_eireli, subcontract).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_contratual_subcontratacao, duty_to_act, intersoft_solucoes_em_informatica_eireli, maintain_contract_conditions).
legal_relation_instance(clausula_decima_sexta_cessao_contrato_credito_sucessao_contratual_subcontratacao, permission_to_act, intersoft_solucoes_em_informatica_eireli, perform_corporate_operation).
legal_relation_instance(clausula_decima_setima_penalidades, subjection, intersoft_solucoes_em_informatica_eireli, be_subject_to_penalties).
...
legal_relation_instance(clausula_decima_setima_penalidades, duty_to_act, intersoft_solucoes_em_informatica_eireli, request_reconsideration_or_appeal).
legal_relation_instance(clausula_decima_setima_penalidades, right_to_action, intersoft_solucoes_em_informatica_eireli, request_reconsideration_or_appeal).
...
legal_relation_instance(clausula_decima_nona_extincao_do_contrato, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, notify_contracted_party).
legal_relation_instance(clausula_decima_nona_extincao_do_contrato, right_to_action, intersoft_solucoes_em_informatica_eireli, defense).
legal_relation_instance(clausula_decima_nona_extincao_do_contrato, duty_to_act, banco_nacional_de_desenvolvimento_economico_e_social_bndes, give_opportunity_of_defense).
legal_relation_instance(clausula_decima_nona_extincao_do_contrato, power, banco_nacional_de_desenvolvimento_economico_e_social_bndes, terminate_contract).
legal_relation_instance(clausula_vigesima_divulgacao_de_dados_pessoais, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, treat_personal_data).
legal_relation_instance(clausula_vigesima_divulgacao_de_dados_pessoais, duty_to_act, intersoft_solucoes_em_informatica_eireli, collect_consent).
legal_relation_instance(clausula_vigesima_divulgacao_de_dados_pessoais, duty_to_act, intersoft_solucoes_em_informatica_eireli, inform_data_holders).
legal_relation_instance(clausula_vigesima_divulgacao_de_dados_pessoais, permission_to_act, intersoft_solucoes_em_informatica_eireli, allow_data_public_disclosure).
legal_relation_instance(clausula_vigesima_primeira_disposicoes_finais, no_right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, waive_contractual_rights).
...
legal_relation_instance(clausula_nona_matriz_riscos, duty_to_omit, intersoft_solucoes_em_informatica_eireli, not_present_additives).
legal_relation_instance(clausula_nona_matriz_riscos, no_right_to_action, intersoft_solucoes_em_informatica_eireli, present_additives).
legal_relation_instance(clausula_nona_matriz_riscos, duty_to_act, intersoft_solucoes_em_informatica_eireli, respect_economic_financial_equilibrium).
legal_relation_instance(clausula_nona_matriz_riscos, right_to_action, banco_nacional_de_desenvolvimento_economico_e_social_bndes, demand_economic_financial_equilibrium_respect).
...
action_type(allow_data_public_disclosure).
action_label(allow_data_public_disclosure, 'Allow data disclosure').
...
action_label(apply_price_reduction_for_non_compliance, 'Apply price reduction for non-compliance').
action_type(arcar_com_equivo_no_dimensionamento).
action_label(arcar_com_equivo_no_dimensionamento, 'Bear costs of quantity errors').
...
action_label(assume_technical_administrative_responsibility, 'Assume technical/admin responsibility').
action_type(be_informed_of_penalty).
action_label(be_informed_of_penalty, 'Be informed of penalty').
action_type(be_informed_of_procedure).
action_label(be_informed_of_procedure, 'Be informed of procedure').
...
action_label(be_subject_to_penalties, 'Be subject to penalties for refusing extension').
...
action_type(communicate_facts_bndes).
action_label(communicate_facts_bndes, 'Communicate facts BNDES').
...
action_type(defense).
action_label(defense, 'Opportunity of defense').
action_type(delete_data_upon_contract_end).
action_label(delete_data_upon_contract_end, 'Delete data upon contract end').
action_type(deliver_materials_to_bndes).
action_label(deliver_materials_to_bndes, 'Deliver materials to BNDES').
action_type(demand_economic_financial_equilibrium_respect).
action_label(demand_economic_financial_equilibrium_respect, 'Demand respect for economic equilibrium').
...
action_label(designate_contract_inspector, 'Designate inspector').
action_type(designate_contract_manager).
action_label(designate_contract_manager, 'Designate manager').
action_type(designate_receiving_committee).
action_label(designate_receiving_committee, 'Designate committee').
action_type(designate_substitute_contract_manager).
action_label(designate_substitute_contract_manager, 'Designate substitute').
...
action_type(ensure_security_rules_compliance).
action_label(ensure_security_rules_compliance, 'Ensure security rules compliance').
...
action_label(formalize_alteration, 'Formalize alteration').
action_type(give_opportunity_of_defense).
action_label(give_opportunity_of_defense, 'Give opportunity of defense').
action_type(guarantee_no_infringement).
action_label(guarantee_no_infringement, 'Guarantee no infringement').
action_type(indicate_representative).
action_label(indicate_representative, 'Indicate representative').
...
action_type(inform_employees_data_provisions).
action_label(inform_employees_data_provisions, 'Inform employees data provisions').
...
action_type(maintain_integrity_contracted_party).
action_label(maintain_integrity_contracted_party, 'Maintain integrity').
...
action_type(not_present_additives).
action_label(not_present_additives, 'Do not present additives').
action_type(not_share_data_without_approval).
action_label(not_share_data_without_approval, 'Not share data without approval').
action_type(not_use_confidential_info).
action_label(not_use_confidential_info, 'Do not use confidential info').
action_type(notify_contracted_party).
action_label(notify_contracted_party, 'Notify the contracted party').
action_type(obey_instructions_procedures).
action_label(obey_instructions_procedures, 'Obey instructions/procedures').
...
action_type(omit_rejecting_on_time_document).
action_label(omit_rejecting_on_time_document, 'Omit rejecting on-time document').
action_type(omit_subcontracting).
action_label(omit_subcontracting, 'Omit subcontracting').
action_type(pagar_ao_contratado).
action_label(pagar_ao_contratado, 'Pay the contracted party').
action_type(parcialmente_executar_e_receber).
action_label(parcialmente_executar_e_receber, 'Partially execute and receive').
action_type(pay_interest).
action_label(pay_interest, 'Pay interest').
action_type(pay_taxes).
action_label(pay_taxes, 'Pay taxes').
action_type(perform_corporate_operation).
action_label(perform_corporate_operation, 'Perform corporate operation').
action_type(present_additives).
action_label(present_additives, 'No right to present additives').
...
action_label(prevent_employee_favortism, 'Prevent employee favorism').
...
action_type(provide_ethics_documents).
action_label(provide_ethics_documents, 'Provide ethics docs').
action_type(provide_necessary_information).
action_label(provide_necessary_information, 'Provide information').
action_type(provide_tech_support).
action_label(provide_tech_support, 'Provide tech support').
action_type(provide_vmware_licenses).
action_label(provide_vmware_licenses, 'Provide VMware licenses').
action_type(receber_objeto).
action_label(receber_objeto, 'Receive object').
action_type(receber_pagamento).
action_label(receber_pagamento, 'Receive payment').
action_type(receive_ethics_documents).
action_label(receive_ethics_documents, 'Receive ethics docs').
...
action_label(receive_necessary_information, 'Receive information').
...
action_type(receive_tech_support).
action_label(receive_tech_support, 'Receive tech support').
action_type(receive_vmware_licenses).
action_label(receive_vmware_licenses, 'Receive VMware licenses').
...
action_label(repair_correct_remove_reconstruct_replace, 'Repair/Correct/Remove/Reconstruct/Replace').
...
action_type(return_resources_revoke_profiles_delete_mailboxes).
action_label(return_resources_revoke_profiles_delete_mailboxes, 'Return resources, revoke profiles').
...
action_type(subject_to_penalty_for_not_providing_guarantee).
action_label(subject_to_penalty_for_not_providing_guarantee, 'Subject to penalty').
